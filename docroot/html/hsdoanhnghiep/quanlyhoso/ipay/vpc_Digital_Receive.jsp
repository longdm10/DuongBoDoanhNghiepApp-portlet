...
<%@page import="vn.dtt.yte.dao.doanhnghiep.service.TthcXacNhanThanhToanLocalServiceUtil"%>
...
<%
	...
	doanhNghiepId = doanhNghiepUser.getNguoiLamThuTucId();
        ...
        if(thanhToanKeyPayReq!=null){
        	 KeyPayUtils.addThanhToanKeyPay(doanhNghiepId, merchTxnRef, ConvertUtil.convertToLong(trans_id), merchantCode, bankCode, Long.parseLong(ship_fee), currency_code, xmlDescription, ConvertUtil.convertToLong(amount), orderInfo, txnResponseCode, thanhToanKeyPayReq.getThongTinHoSo(), Constants.KEYPAY_RESPONSE, Constants.KEYPAY_NORMAL_RECEIVER);
