...
<aui:form action="" name="fm1" method="POST">
	...
	<div class="row">
		...
		<div class="box66">
			...
			<div class="box90">
				<input type="text" readonly="readonly" name="<%= NguoiLamThuTucTerm.CD_EMAIL %>" id="<%= NguoiLamThuTucTerm.CD_EMAIL %>" value="<%= cdEmail %>">
			</div>
		</div>
	</div>
	<div class="row">
	...
	<div class="row row-bt">
		<input type="button" class="btn btn-primary btn-sm" onclick="summitForm('<%=updateCongDanURL.toString()%>')" value="Cập nhật"/>
	</div>
</aui:form>
