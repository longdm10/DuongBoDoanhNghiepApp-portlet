...
KeyPayUtils.addThanhToanKeyPay(doanhNghiepId, merchantTransId,
	0l, merchantCode, "", GetterUtil.getLong(shipFee),
	currencyCode, xmlDescription, GetterUtil.getLong(net_cost), request.getParameter("good_code"),
	"", thongTinHoSo, GetterUtil.getInteger(Constants.KEYPAY_REQUEST), 0);
%>
