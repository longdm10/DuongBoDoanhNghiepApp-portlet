...
<%
DonDTTPHS160 donOnline = (DonDTTPHS160) DuongThuyUtil.getDonOnline(noiDungHoSoId, noiDungXML);

if(donOnline == null) {
	donOnline = new DonDTTPHS160();
}
...
mapDonValue.put(DonOnline.THONG_SO_CO_BAN, GetterUtil.getString(donOnline.getThongSoCoBan()));
...
mapDonRequired.put(DonOnline.SO_DANG_KY, "ctrl-required");
mapDonRequired.put(DonOnline.DIEN_THOAI, "ctrl-required");
...
mapDonRequired.put(DonOnline.NGAY_CAP_PHUONG_TIEN, "ctrl-required");
...
mapDonRequired.put(DonOnline.LY_DO_CAP_LAI, "ctrl-required");
mapDonRequired.put(DonOnline.THONG_SO_CO_BAN, "ctrl-required");
mapDonRequired.put(DonOnline.TEN_CO_QUAN_DANG_KY_TRUOC_DAY, "ctrl-required");
...
<aui:form action="<%= actionXemTruocNoiDung %>" name="fm" method="post" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "saveDon();" %>'>
	<div class="P10 col-xs-12">
		<div class="BGT noidung">
			<div class="col-xs-12">
				<h3 class="tle text-center">ĐƠN ĐỀ NGHỊ ĐĂNG KÝ LẠI<br/>PHƯƠNG TIỆN THỦY NỘI ĐỊA<br/><span style="font-size:16px"><i>(Dùng cho phương tiện thay đổi tên, tính năng kỹ thuật)</i></span></h3>
			</div>
			<div class="col-xs-12">
				...
				<div class="col-xs-6 PA0">
					<label class="textlabel col-xs-4" for="sel1">Nơi đóng: <span class="red">*</span></label>
					<p class="col-xs-8">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="clear"></div>
				<label class="textlabel col-xs-4" for="sel1">Các thông số cơ bản của phương tiện xin đăng ký lại:</label>
				<p class="col-xs-8">
					<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.THONG_SO_CO_BAN, "form-control", mapDonValue, mapDonRequired) %>
				</p>
				<div class="clear"></div>
