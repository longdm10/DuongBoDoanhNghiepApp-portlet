...
<%
DonDTTPHS170 donOnline = (DonDTTPHS170) DuongThuyUtil.getDonOnline(noiDungHoSoId, noiDungXML);

if(donOnline == null) {
	donOnline = new DonDTTPHS170();
}
...
mapDonValue.put(DonOnline.NGAY_CAP_PHUONG_TIEN, GetterUtil.getString(donOnline.getNhapNgay()));
mapDonValue.put(DonOnline.SO_DANG_KY, GetterUtil.getString(donOnline.getSoDangKy()));
...
mapDonValue.put(DonOnline.TEN_CO_QUAN_DANG_KY_TRUOC_DAY, GetterUtil.getString(donOnline.getTenCoQuanDangKiTruocday()));
mapDonValue.put(DonOnline.LY_DO_CAP_LAI, GetterUtil.getString(donOnline.getLyDoCapLai()));
mapDonValue.put(DonOnline.MUA_LAI_HOAC_DIEU_CHUYEN, GetterUtil.getString(donOnline.getPhuongTienNayDuocMuaLaiHayChuyenNhuong()));
mapDonValue.put(DonOnline.MUA_LAI_HOAC_DIEU_CHUYEN_TU_DON_VI, GetterUtil.getString(donOnline.getNguoiMuaLai()));
mapDonValue.put(DonOnline.MUA_LAI_HOAC_DIEU_CHUYEN_DIA_CHI, GetterUtil.getString(donOnline.getDiaChiNguoiMua()));
mapDonValue.put(DonOnline.TINH_THANH_PHO, GetterUtil.getString(donOnline.getChonThanhPho()));
//bo sung dia chi dang ly trc day + ngay
mapDonValue.put(DonOnline.DIA_CHI_DANG_KY_TRUOC_DAY, GetterUtil.getString(donOnline.getDiaChiDangKyTruocDay()));
mapDonValue.put(DonOnline.NGAY_DANG_KY_TRUOC_DAY, GetterUtil.getString(donOnline.getNgayDangKyTruocday()));
...
mapDonRequired.put(DonOnline.MUA_LAI_HOAC_DIEU_CHUYEN_DIA_CHI, "ctrl-required");
mapDonRequired.put(DonOnline.MUA_LAI_HOAC_DIEU_CHUYEN_TU_DON_VI, "ctrl-required");
mapDonRequired.put(DonOnline.DIA_CHI_DANG_KY_TRUOC_DAY, "ctrl-required");
%>
...
<aui:form action="<%= actionXemTruocNoiDung %>" name="fm" method="post" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "saveDon();" %>'>
	<div class="P10 col-xs-12">
		<div class="BGT noidung">
			<div class="col-xs-12">
				<h3 class="tle text-center">ĐƠN ĐỀ NGHỊ ĐĂNG KÝ LẠI<br/>PHƯƠNG TIỆN THỦY NỘI ĐỊA<br/><span style="font-size:16px"><i>(Dùng cho phương tiện chuyển quyền sở hữu)</i></span></h3>
			</div>
			<div class="col-xs-12">
				...
				<label class="textlabel col-xs-10 col-xs-offset-2" style="font-size:14px; margin-bottom:15px">Hiện đang là chủ sở hữu phương tiện có đặc điểm cơ bản như sau:</label>
				<div class="col-xs-6 PA0">
				...
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4 textlabel">Số đăng ký: <span class="red">*</span></label>
					<div class="col-xs-8">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.SO_DANG_KY, "form-control", mapDonValue, mapDonRequired) %>
					</div>
				</div>
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4 textlabel">Do: <span class="red">*</span></label>
					<div class="col-xs-8">
						<%= DuongThuyUtil.renderDonViThucHienCombobox(renderResponse.getNamespace(), DonOnline.TEN_CO_QUAN_DANG_KY_TRUOC_DAY, "form-control", 
								"", "--- Lựa chọn ---", thuTucHanhChinhId, mapDonValue, mapDonRequired) %>
					</div>
				</div>
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4">Cấp ngày: <span class="red">*</span></label>
					<div class="col-xs-6">
						<div class="input-group">
							<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
									DonOnline.NGAY_CAP_PHUONG_TIEN, "form-control ctrl-input-calendar", mapDonValue, mapDonRequired) %>
				...
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4">Năm đóng: <span class="red">*</span></label>
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-6 PA0">
					<label class="textlabel col-xs-4" for="sel1">Số đăng kiểm: </label>
					<p class="col-xs-8">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-6 PA0 MB10">
					...
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.CHIEU_DAI_THIET_KE, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
					...
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.CHIEU_DAI_LON_NHAT, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
						<span class="pull-right textlabel">m</span>
					</div>
				</div>
				<div class="col-xs-6 PA0 MB10">
					...
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.CHIEU_CAO_MAN, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
						<span class="pull-right textlabel">m</span>
					</div>
					<label class="col-xs-3 col-xs-offset-1 textlabel" for="sel1">Chiều chìm: <span class="red">*</span></label>
					<div class="col-xs-2 col-xs-offset-1">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.CHIEU_CHIM, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
						<span class="pull-right textlabel">m</span>
					</div>
				</div>
				<div class="col-xs-6 PA0 MB10">
					...
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.CHIEU_RONG_THIET_KE, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
						<span class="pull-right textlabel">m</span>
					</div>
					<label class="col-xs-3 col-xs-offset-1 PAl0 textlabel" for="sel1">Chiều rộng lớn nhất:<span class="red">*</span></label>
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.CHIEU_RONG_LON_NHAT, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
						<span class="pull-right textlabel">m</span>
					</div>
				</div>
				<div class="col-xs-6 PA0 MB10">
					...
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.MAN_KHO, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
						<span class="pull-right textlabel">m</span>
					</div>
					...
					<div class="col-xs-2 col-xs-offset-1 PAr0">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.TRONG_TAI_TOAN_PHAN, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
				...
				<div class="col-xs-6 PA0 MB10">
					...
					<div class="col-xs-2 PAr0" style="width:134px">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.SO_NGUOI_DUOC_PHEP_CHO, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
					...
					<div class="col-xs-2 PAr0">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.SUC_KEO_DAY, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
						<span class="pull-left textlabel">tấn</span>
					</div>
				</div>
				<div class="clear"></div>
				<div class="col-xs-6 PA0 MB10">
					...
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.SO_LUONG_MAY_CHINH, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
					</div>
				...
				<div class="col-xs-6 PA0 MB10">
					...
					<div class="col-xs-3">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.CONG_SUAT_MAY_CHINH, "form-control ipt-w90", mapDonValue, mapDonRequired) %>
				...
				<div class="col-xs-6 PA0 MB10">
					...
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.SO_LUONG_MAY_PHU, "form-control ipt-w80", mapDonValue, mapDonRequired) %>
					</div>
				...
				<div class="col-xs-6 PA0 MB10">
					...
					<div class="col-xs-3">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.CONG_SUAT_MAY_PHU, "form-control ipt-w90", mapDonValue, mapDonRequired) %>
						<span class="pull-left textlabel">CV</span>
					</div>
				...
				<div class="clear"></div>
				<label class="textlabel col-xs-4" for="sel1">Nay đề nghị cơ quan đăng ký lại phương tiện trên với lý do:</label>
				<p class="col-xs-8">
					<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.LY_DO_CAP_LAI, "form-control", mapDonValue, mapDonRequired) %>
				</p>
				<div class="clear"></div>
				<label class="textlabel col-xs-4" for="sel1">Phương tiện này được (Mua lại hoặc điều chuyển ...): <span class="red">*</span></label>
				<p class="col-xs-2">
					<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.MUA_LAI_HOAC_DIEU_CHUYEN, "form-control", mapDonValue, mapDonRequired) %>
				</p>
				<label class="textlabel col-xs-3" for="sel1">từ (ông, bà hoặc cơ quan đơn vị): <span class="red">*</span></label>
				<p class="col-xs-3">
					<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.MUA_LAI_HOAC_DIEU_CHUYEN_TU_DON_VI, "form-control", mapDonValue, mapDonRequired) %>
				</p>
				<div class="clear"></div>
				<label class="textlabel col-xs-2" for="sel1">Địa chỉ: <span class="red">*</span></label>
				<p class="col-xs-10">
					<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.MUA_LAI_HOAC_DIEU_CHUYEN_DIA_CHI, "form-control", mapDonValue, mapDonRequired) %>
				</p>
				<div class="clear"></div>
				
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4 textlabel">Đã Đăng ký tại: <span class="red">*</span></label>
					<div class="col-xs-8">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
							DonOnline.DIA_CHI_DANG_KY_TRUOC_DAY, "form-control", mapDonValue, mapDonRequired) %>
					</div>
				</div>
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4">Cấp ngày: <span class="red">*</span></label>
					<div class="col-xs-6">
						<div class="input-group">
							<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
									DonOnline.NGAY_DANG_KY_TRUOC_DAY, "form-control ctrl-input-calendar", mapDonValue, mapDonRequired) %>
							<span class="input-group-addon ctrl-input-calendar"><i class="fa fa-calendar"></i></span>
						</div>
					</div>
				</div>
				...
				<div class="col-xs-12">
					...
					<p class="col-xs-9">
						<%= DuongThuyUtil.renderDonViThucHienCombobox(renderResponse.getNamespace(), 
								DonOnline.KINH_GUI, "form-control", "", "--- Lựa chọn ---", thuTucHanhChinhId, mapDonValue, mapDonRequired) %> đăng ký phương tiện trên.
					</p>
				</div>
				<div class="clear"></div>
				
				<p class="col-xs-12">Tôi xin chịu hoàn toàn trách nhiệm trước pháp luật về việc sở hữu phương tiện và chấp hành nghiêm chỉnh quy định của pháp luật về quản lý và sử dụng phương tiện.</p>
