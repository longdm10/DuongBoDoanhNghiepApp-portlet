...
<%
DonDTTPHS90 donOnline = (DonDTTPHS90) DuongThuyUtil.getDonOnline(noiDungHoSoId, noiDungXML);

List<Map<String, String>> listQuaTrinhLamViec = new ArrayList<Map<String, String>>();

if(donOnline == null) {
	donOnline = new DonDTTPHS90();
}

// Khoi tao List QuaTrinhLamViec cho don
if(donOnline.getQuaTrinhLamViecPTTND() == null || donOnline.getQuaTrinhLamViecPTTND().size() == 0) {
	donOnline.getQuaTrinhLamViecPTTND().add(new DonDTTPHS90.QuaTrinhLamViecPTTND());
}

for(int i = 0; i < donOnline.getQuaTrinhLamViecPTTND().size(); i++) {
	DonDTTPHS90.QuaTrinhLamViecPTTND quaTrinhLamViec = donOnline.getQuaTrinhLamViecPTTND().get(i);
