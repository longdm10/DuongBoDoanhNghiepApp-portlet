...
<%
DonDTTPHS209 donOnline = (DonDTTPHS209) DuongThuyUtil.getDonOnline(noiDungHoSoId, noiDungXML);

if(donOnline == null) {
	donOnline = new DonDTTPHS209();
}
...
mapDonValue.put(DonOnline.LY_DO_XOA_PHUONG_TIEN,GetterUtil.getString(donOnline.getLyDoXoaPhuongTien()));
...
mapDonRequired.put(DonOnline.LY_DO_XOA_PHUONG_TIEN, "ctrl-required");
		...
		<div class="BGT noidung">
			<div class="col-xs-12">
				<h3 class="tle text-center">
					ĐƠN ĐỀ NGHỊ XÓA ĐĂNG KÝ<br />PHƯƠNG TIỆN THỦY NỘI ĐỊA
				</h3>
			</div>
			<div class="col-xs-12">
				<div class="col-xs-6 PA0">
					<label class="textlabel col-xs-4" for="sel1">Kính gửi: <span
				...
				<div class="clear"></div>
				<div class="col-xs-6 PA0">
					<label class="textlabel col-xs-4" for="sel1">Tổ chức, cá
						nhân đăng ký: <span class="red">*</span>
					</label>
					<p class="col-xs-8">
				...
				<div class="col-xs-6 PA0">
					<label class="col-xs-4" for="sel1">Đại diện cho các đồng sở
						hữu:</label>
					<p class="col-xs-8">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-12 PA0">
					<label class="textlabel col-xs-2" for="sel1">Trụ sở chính:
						<span class="red">*</span>
					</label>
					<p class="col-xs-10">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-6 PA0">
					<label class="textlabel col-xs-4" for="sel1">Điện thoại: <span
						class="red">*</span></label>
					<p class="col-xs-6">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<label class="textlabel col-xs-10 col-xs-offset-2"
					style="font-size: 14px; margin-bottom: 15px">Đề nghị cơ
					quan xóa đăng ký phương tiện thủy nội địa với đặc điểm cơ bản như
					sau:</label>
				<div class="col-xs-6 PA0">
					<label class="textlabel col-xs-4" for="sel1">Tên phương
						tiện:
					</label>
						<p class="col-xs-8">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4 textlabel">Số đăng ký: <span
						class="red">*</span></label>
					<p class="col-xs-8">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4 textlabel">Công dụng: <span
						class="red">*</span></label>
					<div class="col-xs-6">
				...
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4">Số đăng kiểm: </label>
					<div class="col-xs-6">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-6 PA0">
					<label class="textlabel col-xs-4" for="sel1">Nơi đóng: <span
						class="red">*</span></label>
					<p class="col-xs-8">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="clear"></div>
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4" for="sel1">Cấp tàu: <span
						class="red">*</span></label>
					<div class="col-xs-6">	
				...
				<div class="col-xs-6 MB10 PA0">
					<label class="col-xs-4 textlabel" for="sel1">Vật liệu vỏ: <span
						class="red">*</span></label>
					<div class="col-xs-8">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-4 textlabel" for="sel1">Chiều dài
						thiết kế: <span class="red">*</span>
					</label>
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
					...
					<label class="col-xs-3 col-xs-offset-1 PAl0 textlabel" for="sel1">Chiều
						dài lớn nhất: <span class="red">*</span>
					</label>
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-6 PA0 MB10">
					<label class="col-xs-3 textlabel" for="sel1">Chiều cao mạn:
						<span class="red">*</span>
					</label>
					<div class="col-xs-2">
						<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
				...
				<div class="col-xs-12">
					...
					<p class="col-xs-9">
						<%= DuongThuyUtil.renderDonViThucHienCombobox(mapDonValue.get(DonOnline.KINH_GUI), 
			"", "--- Lựa chọn ---", 
			renderResponse.getNamespace() + DonOnline.KINH_GUI, 
			renderResponse.getNamespace() + DonOnline.KINH_GUI, 
			"form-control " + GetterUtil.getString(mapDonRequired.get(DonOnline.KINH_GUI)), thuTucHanhChinhId) %> đăng ký phương tiện trên.
					</p>
				</div>
				<div class="col-xs-6 PA0">
					<label class="textlabel col-xs-4" for="sel1">Lý do xóa đăng
						ký:</label>
					<div class="col-xs-3 PAl0">
						<%= DuongThuyUtil.renderDanhMucCombobox(renderResponse.getNamespace(), DonOnline.LY_DO_XOA_PHUONG_TIEN, "form-control", 
								"", "--- Lựa chọn ---", DTConstants.DANH_MUC.DM_LYDO_XOADK, mapDonValue, mapDonRequired) %>
					</div>
				</div>
				<div class="clear"></div>
				<p class="col-xs-12" for="sel1">Tôi xin chịu hoàn toàn trách
					nhiệm trước pháp luật về việc sở hữu phương tiện trên và chấp hành
					nghiêm chỉnh quy định của pháp luật về quản lý và sử dụng phương
					tiện.</p>
				<div class="clear"></div>
