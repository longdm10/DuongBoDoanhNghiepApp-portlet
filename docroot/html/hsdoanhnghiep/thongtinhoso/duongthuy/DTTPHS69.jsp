...
<%
DonDTTPHS69 donOnline = (DonDTTPHS69) DuongThuyUtil.getDonOnline(noiDungHoSoId, noiDungXML);

List<Map<String, String>> listQuaTrinhLamViec = new ArrayList<Map<String, String>>();

if(donOnline == null) {
	donOnline = new DonDTTPHS69();
}

// Khoi tao List QuaTrinhLamViec cho don
if(donOnline.getQuaTrinhLamViecPTTND() == null || donOnline.getQuaTrinhLamViecPTTND().size() == 0) {
	donOnline.getQuaTrinhLamViecPTTND().add(new DonDTTPHS69.QuaTrinhLamViecPTTND());
}

for(int i = 0; i < donOnline.getQuaTrinhLamViecPTTND().size(); i++) {
	DonDTTPHS69.QuaTrinhLamViecPTTND quaTrinhLamViec = donOnline.getQuaTrinhLamViecPTTND().get(i);
