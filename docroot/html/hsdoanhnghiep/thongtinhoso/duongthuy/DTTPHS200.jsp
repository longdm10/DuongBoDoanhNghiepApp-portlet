...
<%
DonDTTPHS200 donOnline = (DonDTTPHS200) DuongThuyUtil.getDonOnline(noiDungHoSoId, noiDungXML);

if(donOnline == null) {
	donOnline = new DonDTTPHS200();
}
...
mapDonValue.put(DonOnline.LY_DO_CAP_LAI, GetterUtil.getString(donOnline.getLyDoCapLaiGCN()));
...
<aui:form action="<%= actionXemTruocNoiDung %>" name="fm" method="post" onSubmit='<%= "event.preventDefault(); " + renderResponse.getNamespace() + "saveDon();" %>'>
	<div class="P10 col-xs-12">
		<div class="BGT noidung">
			<div class="col-xs-12">
				<h3 class="tle text-center">ĐƠN ĐỀ NGHỊ CẤP LẠI GIẤY CHỨNG NHẬN ĐĂNG KÝ<br/>PHƯƠNG TIỆN THỦY NỘI ĐỊA</h3>
			</div>
			<div class="col-xs-12">
