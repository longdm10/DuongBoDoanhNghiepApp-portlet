...
<%
DonDTTPHS181 donOnline = (DonDTTPHS181) DuongThuyUtil.getDonOnline(noiDungHoSoId, noiDungXML);

if(donOnline == null) {
	donOnline = new DonDTTPHS181();
}
...
mapDonValue.put(DonOnline.NGAY_CAP_BANG, GetterUtil.getString(donOnline.getNhapNgay()));
	...
	<div class="P10 col-xs-12">
		<div class="BGT noidung">
			...
			<div class="col-xs-12">
				...
				<label class="textlabel col-xs-3" for="sel1">từ (ông, bà hoạc cơ quan đơn vị): <span class="red">*</span></label>
				<p class="col-xs-3">
					<%= DuongThuyUtil.renderInput(renderResponse.getNamespace(), 
