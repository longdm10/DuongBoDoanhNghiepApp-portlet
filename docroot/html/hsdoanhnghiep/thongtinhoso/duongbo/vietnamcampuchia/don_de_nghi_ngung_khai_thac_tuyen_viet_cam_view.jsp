...
<%
	LogFactoryUtil.getLog(DoanhNghiepAction.class).info("------/don_de_nghi_ngung_khai_thac_tuyen_viet_cam_view.jsp---------");
	...
	LogFactoryUtil.getLog(DoanhNghiepAction.class).info("------/don_de_nghi_ngung_khai_thac_tuyen_viet_cam_view.jsp---------"+ngayNgungKhaiThac);
	

	
	//---------------------Ten modal export
	NgungKhaiThacTuyenVTHKCDBangOtoVietCam mauDon = new NgungKhaiThacTuyenVTHKCDBangOtoVietCam();
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamcampuchia/don_de_nghi_ngung_khai_thac_tuyen_viet_cam.jsp");
