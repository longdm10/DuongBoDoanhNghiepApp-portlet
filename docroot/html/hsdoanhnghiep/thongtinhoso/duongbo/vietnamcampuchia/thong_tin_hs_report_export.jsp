...
<%
	...
	System.out.println("---/vietnamcampuchia/thong_tin_hs_report_export.jsp-------realPath-----------"+realPath);
	System.out.println("---/vietnamcampuchia/thong_tin_hs_report_export.jsp-------mauDon-----------"+mauDon);
	System.out.println("---/vietnamcampuchia/thong_tin_hs_report_export.jsp-------hoSoThuTucId-----------"+hoSoThuTucId);
	System.out.println("---/vietnamcampuchia/thong_tin_hs_report_export.jsp-------thanhPhanHoSoId-----------"+thanhPhanHoSoId);
