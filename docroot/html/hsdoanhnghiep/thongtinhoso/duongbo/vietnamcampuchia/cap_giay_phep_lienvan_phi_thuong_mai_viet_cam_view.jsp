...
<%
	...
	//Ten modal export
	DonXinCapGPLienVanVietCam mauDon = new DonXinCapGPLienVanVietCam();
	...
	_log.info("------/cap_giay_phep_lienvan_phi_thuong_mai_viet_camp_view.jsp--lstStringObjctPhuongTien.size---" + lstStringObjctPhuongTien.length);
	
	List<DonXinCapGPLienVanVietCam.DanhSachXe> codeDanhSachXes = new ArrayList<DonXinCapGPLienVanVietCam.DanhSachXe>();
	...
	for (String s: lstStringObjctPhuongTien) {
		...
		if (properties != null && properties.length > 0) {
			...
			DonXinCapGPLienVanVietCam.DanhSachXe xe = new DonXinCapGPLienVanVietCam.DanhSachXe();
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamcampuchia/cap_giay_phep_lienvan_phi_thuong_mai_viet_cam.jsp");
