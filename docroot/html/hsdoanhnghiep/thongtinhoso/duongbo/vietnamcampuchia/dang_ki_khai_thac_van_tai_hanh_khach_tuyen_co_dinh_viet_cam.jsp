...
<%
	_log.info("/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamcampuchia/dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_cam.jsp");
	...
	if (hoSoThuTucId > 0) {
		...
		if (Validator.isNotNull(noidungHoSo) && Validator.isNotNull(noidungHoSo.getNoiDungXml())) {
			...
			_log.info("dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_cam.jsp--noidungHoSo--" + noidungHoSo.getId());
	...
	if (donLienVan == null) { donLienVan = new DKKTVTTuyenCoDinhBangOtoVietCam(); }
...
xemTruocNoiDung.setParameter(Constants.PATH_MAUDON_VIEW_PDF, "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamcampuchia/dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_cam_views.jsp");
%>
...
<!-- 							<option value="">-- Lựa chọn Tỉnh --</option> -->
				...
				<div class="col-sm-12">
					...
					<p>
						...
						<span class="pull-left w250 text-center"><b>Số Fax</b></span>: <%=doanhNghiep.getFax()%>
					</p>
				<label class="pull-left">4. Giấy phép vận tải đường bộ quốc tế Việt Nam - Campuchia do Tổng cục Đường bộ Việt Nam cấp:</label>
					...
					<div style="padding: 0 15px; margin-bottom: 15px">
						<div class="col-xs-6">
							...
							<input type="text" class="form-control" id="SoGPVT" name="SoGPVT" value="<%=donLienVan.getSoGiayPhepVanTai() != null ? donLienVan.getSoGiayPhepVanTai():""%>"> 
						</div>
						<div class="col-xs-6">
							<label class="pull-left w265">Ngày cấp <span class="red">*</span></label>
							<div class="col-xs-12 PA0">
								<div class="input-group">
									<input type="text" class="form-control" id="ngayCapGiayPhep" name="ngayCapGiayPhep" onclick="gtCalendar('ngayCapGiayPhep')" value="<%=(donLienVan.getNgayCapGiayPhepVantai() != null) ? donLienVan.getNgayCapGiayPhepVantai() : ""%>"> <span
					...
					<div class="row M0">
						<div class="col-xs-3 form-group">
							...
							<div class="col-xs-10 PAl0">
								<input type="text" class="form-control pull-left" id="cuLy" name="cuLy" value="<%=(donLienVan.getCuLy() != null) ? donLienVan.getCuLy() : ""%>" >
							</div>
							<span class="pull-left textlabel">km</span>
						</div>
						<div class="col-xs-9 form-group">
							<label for="sel1">Hành trình chạy xe <span class="red">*</span>:
							</label> <input type="text" class="form-control" id="hanhTrinh" name="hanhTrinh" value="<%=(donLienVan.getHanhTrinh() != null) ? donLienVan.getHanhTrinh() : ""%>">
						</div>
					</div>
