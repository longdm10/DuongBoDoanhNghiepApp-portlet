	...
	for (String s: lstStringObjctPhuongTien) {
		...
		if (properties != null && properties.length > 0) {
			DKKTVTTuyenCoDinhBangOtoVietCam.DanhSachXe xe = new DKKTVTTuyenCoDinhBangOtoVietCam.DanhSachXe();
				...
				xe.setLoaiXe(properties[3]); 
	 			xe.setSoGhe(properties[4]);
	 			xe.setNamSx(properties[5]);
				xe.setCuaKhau(properties[6]); 
	 			//_log.info("------/dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao_views.jsp--dsXe---" + xe.getBienKiemSoat() + "--" + xe.getSoGhe());
