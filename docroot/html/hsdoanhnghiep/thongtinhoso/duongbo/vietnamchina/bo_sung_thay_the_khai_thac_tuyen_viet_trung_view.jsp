...
<%
	_log.info("------/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/bo_sung_thay_the_khai_thac_tuyen_viet_trung_view.jsp---------");
	...
	_log.info("-------doanhNghiep--CoQuanCapGpkdVanTaiBangOto--" + doanhNghiep.getCoQuanCapGpkdVanTaiBangOto());
	_log.info("-------listDiemDungNghi --- " + listDiemDungNghi);
...
/* 	PortletURL actionKySo = renderResponse.createActionURL();
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/bo_sung_thay_the_khai_thac_tuyen_viet_trung.jsp");
