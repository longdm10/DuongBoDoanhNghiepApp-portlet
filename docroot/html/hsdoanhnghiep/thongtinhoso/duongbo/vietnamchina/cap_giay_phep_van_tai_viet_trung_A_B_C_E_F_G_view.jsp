...
<%
	_log.info("------/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/cap_giay_phep_van_tai_viet_trung_A_B_C_E_F_G_view.jsp---------");
	...
	String soGiayKdvt = ParamUtil.getString(request, "soGiayKdvt");
	String ngayCapKdvt = ParamUtil.getString(request, "ngayCapKdvt");
	String coQuanCapKdvt = ParamUtil.getString(request, "coQuanCapKdvt");
	...
	_log.info("==cQuanCapKdvt--" + ParamUtil.getString(request, "coQuanCapKdvt"));
	...
	_log.info("------/cap_giay_phep_van_tai_cho_xe_cong_vu_viet_trung_view.jsp--lstStringObjctPhuongTien.size---" + lstStringObjctPhuongTien.length);
	...
	mauDon.setNgayCapGiayPhepVanTai(FormatData.parseDateToTringDDMMYYY(doanhNghiep.getNgayCapGpkdVanTaiBangOto()));
	...
	_log.info("==cQuanCapKdvt--" + mauDon.getNoiCapGiayPhepVanTai());
...
/* 	PortletURL actionKySo = renderResponse.createActionURL();
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/cap_giay_phep_van_tai_viet_trung_A_B_C_E_F_G.jsp");
