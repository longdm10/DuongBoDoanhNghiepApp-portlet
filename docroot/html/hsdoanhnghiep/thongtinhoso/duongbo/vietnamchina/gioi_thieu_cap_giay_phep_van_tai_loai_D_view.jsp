...
<%
	...
	String diaChiNguoiLienHeTrakq = ParamUtil.getString(request, "diaChiNguoiLienHeTrakq");
	...
	List<DeNghiGioiThieuXinCapGPVTLoaiDVietNam.DanhSachXe> codeDanhSachXes = new ArrayList<DeNghiGioiThieuXinCapGPVTLoaiDVietNam.DanhSachXe>();
	...
	for (String s: lstStringObjctPhuongTien) {
		...
		if (properties != null && properties.length > 0) {
			...
			DeNghiGioiThieuXinCapGPVTLoaiDVietNam.DanhSachXe xe = new DeNghiGioiThieuXinCapGPVTLoaiDVietNam.DanhSachXe();
			...
			xe.setThoiGianCapPhepFrom(properties[9]);
			xe.setThoiGianCapPhepTo(properties[10]);
			...
			//_log.info("------xe.hanhTrinhDeNghi---" + xe.getHanhTrinhDeNghi() + "-------------: " + properties[19]);
	...
	DeNghiGioiThieuXinCapGPVTLoaiDVietNam mauDon = new DeNghiGioiThieuXinCapGPVTLoaiDVietNam();
	...
	mauDon.setSoGiayPhepVC(soGiayPhepVCVN);
	mauDon.setNgayCapGiayPhepVC(ngayCapGiayPhepVCVN);
	mauDon.setNoiCapGiayPhepVC(noiCapGiayPhepVCVN);
	mauDon.setDiaChiNguoiLienHeTraKqCapPhep(diaChiNguoiLienHeTrakq);
...
/* 	PortletURL actionKySo = renderResponse.createActionURL();
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/gioi_thieu_cap_giay_phep_van_tai_loai_D.jsp");
