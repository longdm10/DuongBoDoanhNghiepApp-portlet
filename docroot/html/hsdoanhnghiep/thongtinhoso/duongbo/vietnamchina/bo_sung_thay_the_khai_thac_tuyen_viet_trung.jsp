...
<%
	_log.info("/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/bo_sung_thay_the_khai_thac_tuyen_viet_trung.jsp");
	...
	xemTruocNoiDung.setParameter(Constants.PATH_MAUDON_VIEW_PDF, "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/bo_sung_thay_the_khai_thac_tuyen_viet_trung_view.jsp");
	
	List<DmDataItem> lstTinhThanh = DanhMucConstants.getTinhThanhVN();
	List<DmDataItem> lstTinhThanhTQ = DanhMucConstants.getTinhThanhTQ();
...
<div class="P10 col-xs-12">
	<div class="BGT noidung">
		<div class="box1000">
			...
			<h3 class="tle text-center">GIẤY ĐĂNG KÝ KHAI THÁC VẬN TẢI HÀNH KHÁCH<br>ĐỊNH KỲ GIỮA VIỆT NAM VÀ TRUNG QUỐC</h3>
			<div class="col-sm-12">
				...
				<div style="padding:0 15px">
					...
					<label class="pull-left w265">Ngày cấp <span class="red">*</span></label><p>: <%=(Validator.isNull(doanhNghiep.getNgayCapDkKd()) ? "" : FormatData.parseDateToTringDDMMYYY(doanhNghiep.getNgayCapDkKd()))%></p>
				...
				<div class="row M0">
					...
					<div class="col-xs-3 form-group">
						...
						<option value="">-- Chọn Tỉnh --</option>
							<%for (DmDataItem item : lstTinhThanhTQ) {
								%>
