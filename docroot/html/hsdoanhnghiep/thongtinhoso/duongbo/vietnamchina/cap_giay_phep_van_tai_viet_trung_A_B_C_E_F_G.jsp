...
<%
	_log.info("/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/cap_giay_phep_van_tai_viet_trung_A_B_C_E_F_G.jsp");
	...
	_log.info("-----------idNoiDungHoS-----------" + idNoiDungHoSo);
	...
	if (donLienVan == null) { donLienVan = new DeNghiCapGiayPhepVanTaiDuongBoVietTrung(); }
	...
	xemTruocNoiDung.setParameter(Constants.PATH_MAUDON_VIEW_PDF, "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/cap_giay_phep_van_tai_viet_trung_A_B_C_E_F_G_view.jsp");
	
%>

<!-- /html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/cap_giay_phep_van_tai_viet_trung_A_B_C_E_F_G.jsp -->
<!-- BMDB51 -->
	...
	<div class="BGT noidung">
		<div class="box1000">
			...
			<div class="text-center col-xs-12 MB20">
				...
				<div style="padding:0 15px">
					<label class="pull-left w265">Số <span class="red">*</span></label><p>: <%=(doanhNghiep.getSoGpkdVanTaiBangOto() == null) ? "" : doanhNghiep.getSoGpkdVanTaiBangOto()%></p>
					...
					<label class="pull-left w265">Cơ quan cấp <span class="red">*</span></label><p>: <%=(doanhNghiep.getCoQuanCapGpkdVanTaiBangOto() == null) ? "" : doanhNghiep.getCoQuanCapGpkdVanTaiBangOto()%></p>
					
<!-- 					<div class="col-xs-12 form-group"> -->
<!-- 						<label class="col-xs-2 textlabel" for="soGiayKdvt">Số<span class="red">*</span>:</label> -->
<!-- 						<p class="col-xs-10"> -->
<%-- 							<input type="text" name="soGiayKdvt" id="soGiayKdvt" class="form-control" value="<%=(doanhNghiep.getSoGpkdVanTaiBangOto() == null) ? "" : doanhNghiep.getSoGpkdVanTaiBangOto()%>"> --%>
<!-- 						</p> -->
<!-- 					</div> -->
					
<!-- 					<div class="col-xs-12 form-group"> -->
<!-- 						<label class="col-xs-2 textlabel" for="ngayCapKdvt">Ngày cấp<span class="red">*</span>:</label> -->
<!-- 						<div class="col-xs-10"> -->
<!-- 							<div class="input-group"> -->
<%-- 								<input type="text" id="ngayCapKdvt" name="ngayCapKdvt" value="<%=DateUtils.dateToString("dd/MM/yyyy", doanhNghiep.getNgayCapGpkdVanTaiBangOto())%>" onclick="gtCalendar('ngayCapKdvt')" class="form-control" > --%>
<!-- 								<span class="input-group-addon" onclick="gtCalendar('ngayCapKdvt')"> -->
...
<!-- 					<div class="col-xs-12 form-group"> -->
<!-- 						<label class="col-xs-2 textlabel" for="coQuanCapKdvt">Cơ quan cấp<span class="red">*</span>:</label> -->
<!-- 						<p class="col-xs-10"> -->
<%-- 							<input type="text" name="coQuanCapKdvt" id="coQuanCapKdvt" class="form-control" value="<%=(doanhNghiep.getCoQuanCapDkKd() == null) ? "" : doanhNghiep.getCoQuanCapDkKd()%>"> --%>
<!-- 						</p> -->
<!-- 					</div> -->
				</div>
				...
				<br/>
				<label class="pull-left">7. Người liên hệ để trả kết quả cấp phép:</label>
				<div class="clear"></div>
				<div class="row M0">
					<div class="col-xs-12 form-group">
...
<script type="text/javascript">
	...
	function summitForm(url) {
		...
		var ngayCapGiayCndkkd = document.getElementById("ngayCapGiayChungNhanDkkd").value;;
		...
		if ($('#soGiayChungNhanDkkd').val() === "") {
			alert("Nhập số giấy chứng nhận đăng ký kinh doanh");
			return false;
		}

		if ($('#ngayCapGiayChungNhanDkkd').val() === "") {
			alert("Nhập ngày cấp giấy chứng nhận đăng ký kinh doanh");
			return false;
		}

		 if(isDate(ngayCapGiayCndkkd) == false){
				alert(" ngày cấp giấy chứng nhận đăng ký kinh doanh không đúng định dạng");
				return false;
			}
		if ($('#coQuanCapGiayChungNhanDkkd').val() === "") {
			alert("Nhập cơ quan cấp giấy chứng nhận đăng ký kinh doanh");
			return false;
		}
