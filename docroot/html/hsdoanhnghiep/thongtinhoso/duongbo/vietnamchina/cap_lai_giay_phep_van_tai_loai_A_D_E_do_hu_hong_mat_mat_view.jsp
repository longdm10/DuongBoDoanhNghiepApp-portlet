...
<%
	_log.info("------/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/cap_lai_giay_phep_van_tai_loai_A_D_E_do_hu_hong_mat_mat_view.jsp---------");
	...
	List<DeNghiCapLaiGPVTVietTrungDoHongMat.DanhSachXe> codeDanhSachXes = new ArrayList<DeNghiCapLaiGPVTVietTrungDoHongMat.DanhSachXe>();
	...
	for (String s: lstStringObjctPhuongTien) {
		...
		if (properties != null && properties.length > 0) {
			DeNghiCapLaiGPVTVietTrungDoHongMat.DanhSachXe xe = new DeNghiCapLaiGPVTVietTrungDoHongMat.DanhSachXe();
			xe.setBienKiemSoat(properties[1]);
			xe.setNhanHieu(properties[2]);
			xe.setTrongTai(properties[3]);
			xe.setSoGiayPhepVTMat(properties[20]);
	...
	DeNghiCapLaiGPVTVietTrungDoHongMat mauDon = new DeNghiCapLaiGPVTVietTrungDoHongMat();
	mauDon.setTenCongTy(doanhNghiep.getTenDoanhNghiep());
	//mauDon.setTenTiengAnh((doanhNghiep.getTenTiengAnh() != null) ? doanhNghiep.getTenTiengAnh() : "");
...
/* 	PortletURL actionKySo = renderResponse.createActionURL();
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamchina/cap_lai_giay_phep_van_tai_loai_A_D_E_do_hu_hong_mat_mat.jsp");
