...
<%
	_log.info("/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao.jsp");
	...
	if (hoSoThuTucId > 0) {
		...
		if (Validator.isNotNull(noidungHoSo) && Validator.isNotNull(noidungHoSo.getNoiDungXml())) {
			...
			_log.info("dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao.jsp--noidungHoSo--" + noidungHoSo.getId());
...
xemTruocNoiDung.setParameter(Constants.PATH_MAUDON_VIEW_PDF, "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao_views.jsp");
%>
