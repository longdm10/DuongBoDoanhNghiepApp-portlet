...
<%
	...
	_log.info("------/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/bo_sung_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao_views.jsp-----");
	...
	_log.info("------/bo_sung_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao_view.jsp.--lstStringObjctPhuongTien.size---" + lstStringObjctPhuongTien.length);
	...
	if (properties != null && properties.length > 0) {
		DKKTVTTuyenCoDinhBangOtoVietLao.DanhSachXe xe = new DKKTVTTuyenCoDinhBangOtoVietLao.DanhSachXe();
			...
			xe.setCuaKhau(properties[6]); 
 			...
 			_log.info("------/bo_sung_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao_views.jsp--dsXe---" + xe.getNamSx() + "--" + xe.getSoGhe());
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/bo_sung_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao.jsp");
