...
<%
	LogFactoryUtil.getLog(DoanhNghiepAction.class).info("---duongbo/vietnamlaos/view_thong_tin_mau_don.jsp");
	...
	LogFactoryUtil.getLog(DoanhNghiepAction.class).info("---duongbo/vietnamlaos/view_thong_tin_mau_don.jsp-------backUrl: " + backUrl);
	LogFactoryUtil.getLog(DoanhNghiepAction.class).info("---duongbo/vietnamlaos/view_thong_tin_mau_don.jsp-------hoSoThuTucId: " + hoSoThuTucId);
	LogFactoryUtil.getLog(DoanhNghiepAction.class).info("----duongbo/vietnamlaos/view_thong_tin_mau_don.jsp------idNoiDungHoSo: " + idNoiDungHoSo);
	...
	if(tthcNoidungHoSo != null){
		if(tthcNoidungHoSo.getTaiLieuDinhKem() > 0){
			...
			LogFactoryUtil.getLog(DoanhNghiepAction.class).info("---duongbo/vietnamlaos/view_thong_tin_mau_don.jsp-------idFileView: " + tthcNoidungHoSo.getTaiLieuDinhKem());
			
			if(tthcNoidungHoSo.getTaiLieuDinhKem() > 0){
				urlFile = DocumentUtils.getLinkDownloadFromNoiLuuTruTaiLieuId(tthcNoidungHoSo.getTaiLieuDinhKem());
			}
			
			LogFactoryUtil.getLog(DoanhNghiepAction.class).info("---duongbo/vietnamlaos/view_thong_tin_mau_don.jsp-------urlFile: " + urlFile);
			
		} else {
			if(tthcNoidungHoSo.getNoiDungXml() != null && tthcNoidungHoSo.getNoiDungXml().trim().length() > 0){
				LogFactoryUtil.getLog(DoanhNghiepAction.class).info("---duongbo/vietnamlaos/view_thong_tin_mau_don.jsp-------getNoiDungXml ton tai");
				...
				if(allMauDon != null && allMauDon.size()>0){
					...
					LogFactoryUtil.getLog(DoanhNghiepAction.class).info("---duongbo/vietnamlaos/view_thong_tin_mau_don.jsp==report_export.jsp======tenFileExport===" + tenFileExport);
					//
		...
		LogFactoryUtil.getLog(DoanhNghiepAction.class).info("UrlFile====" + urlFile);
	...
	if (tthcNoidungHoSo != null) {
	%>
	<!-- /thongtinhoso/duongbo/vietnamlaos/view_thong_tin_mau_don.jsp -->
