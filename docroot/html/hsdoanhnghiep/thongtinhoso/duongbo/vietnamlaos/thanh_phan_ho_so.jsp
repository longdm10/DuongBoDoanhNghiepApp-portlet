...
<%
_log.info("/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/thanh_phan_ho_so.jsp");
...
%>
<!-- /html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/thanh_phan_ho_so.jsp -->
				...
				<tbody>
					...
					if (allThanhPhanHoSo != null && allThanhPhanHoSo.size() > 0) {
						...
						for (int i = 0; i < allThanhPhanHoSo.size(); i++) {
							...
							nhapDuLieuTrucTuyen.setParameter(Constants.LOAI_THU_TUC_HANH_CHINH, Constants.LVTT_VIET_NAM_LAO);
							%>
							<tr>
