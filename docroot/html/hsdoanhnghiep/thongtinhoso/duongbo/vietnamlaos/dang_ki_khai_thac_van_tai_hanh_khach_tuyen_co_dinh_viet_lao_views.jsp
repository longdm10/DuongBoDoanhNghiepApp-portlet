...
<%
	...
	_log.info("------/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao_views.jsp-----");
	...
	//Ten modal export
	DKKTVTTuyenCoDinhBangOtoVietLao mauDon = new DKKTVTTuyenCoDinhBangOtoVietLao();
	...
	if (doanhNghiep!=null) {
		try {
			...
			LogFactoryUtil.getLog(DoanhNghiepAction.class).info("--loi format exception------");
		}
	}
	...
	List<DKKTVTTuyenCoDinhBangOtoVietLao.DanhSachXe> codeDanhSachXes = new ArrayList<DKKTVTTuyenCoDinhBangOtoVietLao.DanhSachXe>();
	String[] lstStringObjctPhuongTien = ParamUtil.getParameterValues(request, "objectPhuongTien", new String[]{});
 	LogFactoryUtil.getLog(DoanhNghiepAction.class).info("------/dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao_views.jsp.--lstStringObjctPhuongTien.size---" + lstStringObjctPhuongTien.length);

 	for (String s: lstStringObjctPhuongTien) {
		String[] properties = s.split(";");
		if (properties != null && properties.length > 0) {
			DKKTVTTuyenCoDinhBangOtoVietLao.DanhSachXe xe = new DKKTVTTuyenCoDinhBangOtoVietLao.DanhSachXe();
			...
			//_log.info("------/dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao_views.jsp--dsXe---" + xe.getNamSx() + "--" + xe.getSoGhe());
 			//_log.info("setTenDangKy--" + properties[22]);
 			//_log.info("setTenDangKy--" + properties[23]);
			codeDanhSachXes.add(xe);
		}
 	}
	if (codeDanhSachXes != null && codeDanhSachXes.size() > 0) { mauDon.setDanhSachXes(codeDanhSachXes); }
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/dang_ki_khai_thac_van_tai_hanh_khach_tuyen_co_dinh_viet_lao.jsp");
