...
<%
	_log.info("------/thong_bao_dieu_chinh_tan_suat_tuyen_viet_lao_view..jsp-----");
	...
	//Ten modal export
	TBaoDieuChinhTanSuatXeChayTuyenCDVietLao mauDon = new TBaoDieuChinhTanSuatXeChayTuyenCDVietLao();
	...
	List<TBaoDieuChinhTanSuatXeChayTuyenCDVietLao.DanhSachXe> codeDanhSachXes = new ArrayList<TBaoDieuChinhTanSuatXeChayTuyenCDVietLao.DanhSachXe>();
	...
	for (String s: lstStringObjctPhuongTien) {
		...
		if (properties != null && properties.length > 0) {
			TBaoDieuChinhTanSuatXeChayTuyenCDVietLao.DanhSachXe xe = new TBaoDieuChinhTanSuatXeChayTuyenCDVietLao.DanhSachXe();
			...
			_log.info("------/thong_bao_dieu_chinh_tan_suat_tuyen_viet_lao_view.jsp--dsXe---" + xe.getBienSoXe() + "--" + xe.getNhanHieu()+"-xe.setTenDK-"+xe.getTenDK());
		}
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/thong_bao_dieu_chinh_tan_suat_tuyen_viet_laos.jsp");
