...
<%
	...
	_log.info("/html/hsdoanhnghiep/thongtinhoso/duongbo/vantaitrongnuoc/vantaioto/thanh_phan_ho_so.jsp");
...
<script type="text/javascript">
	...
	function summitPopupForm(url, thanhPhanHoSoId, bieuMauCount) {
		...
		console.log('fileUpl', fileUpl, 'fileInput', fileInput, 'tenTaiLieu', tenTaiLieu);
