...
<%
	_log.info("/html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/de_nghi_cap_gpkd_van_tai_oto.jsp");
...
<!-- /html/hsdoanhnghiep/thongtinhoso/duongbo/vietnamlaos/de_nghi_cap_gpkd_van_tai_oto.jsp -->
...
<portlet:actionURL var="xemTruocNoiDung" name="xemTruocNoiDung">
	...
	<portlet:param name="<%=Constants.PATH_MAUDON_VIEW_PDF%>" value="/html/hsdoanhnghiep/thongtinhoso/duongbo/vantaitrongnuoc/vantaioto/de_nghi_cap_gpkd_van_tai_oto_view.jsp"/>
</portlet:actionURL>
		...
		<div class="BGT noidung">
			<div class="box1000">
				...
				<div class="col-sm-12">
					...
					<p><span class="">: <%=doanhNghiep.getDienThoai()%></span></p>
