...
<%
	_log.info("/html/hsdoanhnghiep/thongtinhoso/duongbo/vantaitrongnuoc/bienhieu/thanh_phan_ho_so.jsp");
	...
	*/
	...
	thanhPhanHoSoUrl.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vantaitrongnuoc/bienhieu/thanh_phan_ho_so.jsp");
								...
								if (thanhPhanHoSo.getMauTrucTuyen() != null && thanhPhanHoSo.getMauTrucTuyen().trim().length() > 0) {
									...
									<td class="sp" style="word-wrap: break-word;">
										...
										if (allNoiDungHoSo != null && allNoiDungHoSo.size() > 0) {
											...
											xemNoidungFileDinhKem.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vantaitrongnuoc/bienhieu/view_thong_tin_mau_don.jsp");
											xemNoidungFileDinhKem.setParameter("backUrl", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vantaitrongnuoc/bienhieu/thanh_phan_ho_so.jsp");
