								...
								if (thanhPhanHoSo.getMauTrucTuyen() != null && thanhPhanHoSo.getMauTrucTuyen().trim().length() > 0) {
									...
									<td class="sp" style="word-wrap: break-word;">
										...
										if (allNoiDungHoSo != null && allNoiDungHoSo.size() > 0) {
											...
											xemNoidungFileDinhKem.setParameter("backUrl", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vantaitrongnuoc/bienhieu/thanh_phan_ho_so_view.jsp");
									...
									<td class="sp"><%=thanhPhanHoSo.getGhiChu() %></td>
								<%
								} else {
									if (allNoiDungHoSo != null && allNoiDungHoSo.size() > 0) {
									...
									<td class="sp" style="word-wrap: break-word;"><%=thanhPhanHoSo.getGhiChu() %></td>
									<%	
									} else {
									%>
