...
<%
	System.out.println("-------in hsdoanhnghiep/thongtinhoso/view_thong_tin_mau_don.jsp");
	...
	System.out.println("-------xacNhanThanhToanId: " + xacNhanThanhToanId);
	...
	if(xacNhanThanhToan != null){
		...
		System.out.println("-------idFileView: " + xacNhanThanhToan.getTaiLieuDinhKem());
