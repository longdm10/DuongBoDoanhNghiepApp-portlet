...
<%@page import="vn.dtt.yte.maudon.model.XuLyHoSo"%>
<%@page import="vn.dtt.yte.report.ReportBusinessUtils"%>
<%@page import="vn.dtt.yte.report.ReportUtils"%>
<%@page import="vn.dtt.yte.utils.document.DocumentUtils"%>
<%@page import="vn.dtt.yte.dao.common.service.TthcNoidungHoSoLocalServiceUtil"%>
<%@page import="vn.dtt.yte.portlet.YTeAction"%>
<%@page import="vn.dtt.yte.dao.common.model.TthcNoidungHoSo"%>
...
<%System.out.println("-------in thong_tin_file_export.jsp----------");
	...
	backUrl.setParameter("jspPage", "/html/hsdoanhnghiep/quanlyfile/giaytorieng/quan_ly_file_search_content.jsp");
