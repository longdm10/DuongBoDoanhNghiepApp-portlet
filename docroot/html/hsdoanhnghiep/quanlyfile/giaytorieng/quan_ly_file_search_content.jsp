...
<section class="right" style="height: auto;float: left;  width: 100%;">
	...
	<div class="box" style="height: auto;float: left;width: 95%;margin-bottom:40px;">
		<%@ include file="/html/hsdoanhnghiep/quanlyfile/giaytorieng/quan_ly_file_search_content_find.jsp"%>
		<%@ include file="/html/hsdoanhnghiep/quanlyfile/giaytorieng/quan_ly_file_search_content_result.jsp"%>
	</div>
</section>