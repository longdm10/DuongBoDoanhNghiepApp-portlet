...
<%
	LogFactoryUtil.getLog(DoanhNghiepAction.class).info("-------in thong_tin_file_export.jsp----------");
	...
	backUrl.setParameter("jspPage", "/html/hsdoanhnghiep/quanlyfile/quan_ly_file_search_content.jsp");
