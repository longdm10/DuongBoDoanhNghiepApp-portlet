...
<aui:form action="<%=actionUrlTimKiemFile.toString()%>" name="myForm" id="myForm" method="POST">
	...
	<!-- Start Input -->
				<div style="margin-bottom:10px">
					<p style="width:17%; float:left; margin-right:2%; line-height:25px">Tên giấy tờ/Số giấy tờ:</p>
					<input style="width:79.5%; float:left; height:21px" type="text" id="tenGiayTo" name="tenGiayTo" placeholder="Nhập tên giấy tờ/số giấy tờ....">
