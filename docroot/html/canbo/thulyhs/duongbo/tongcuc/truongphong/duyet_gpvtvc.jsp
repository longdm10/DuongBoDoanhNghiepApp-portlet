...
PortletURL quocTe_vietCam_CD = renderResponse.createActionURL();
quocTe_vietCam_CD.setParameter(ActionRequest.ACTION_NAME, "quocTe_vietCam_CD");
quocTe_vietCam_CD.setParameter(Constants.ID_HO_SO_THU_TUC, hoSoThuTucId);
quocTe_vietCam_CD.setParameter(Constants.ID_PHIEU_XU_LY, phieuXuLyId);
quocTe_vietCam_CD.setParameter(Constants.THANH_PHAN_XU_LY, Constants.XU_LY_TLHS);
quocTe_vietCam_CD.setParameter(Constants.ID_QUY_TRINH_THU_TUC, quyTrinhThuTucId);
quocTe_vietCam_CD.setParameter(Constants.ID_THU_TUC_HANH_CHINH, idThuTucHanhChinh);
...
<aui:input type="hidden" name="actionURL" value="<%=quocTe_vietCam_CD.toString() %>"></aui:input>
