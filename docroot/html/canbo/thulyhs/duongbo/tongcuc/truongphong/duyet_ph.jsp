...
PortletURL phuHieu_oTo_CD = renderResponse.createActionURL();
phuHieu_oTo_CD.setParameter(ActionRequest.ACTION_NAME, "phuHieu_oTo_CD");
phuHieu_oTo_CD.setParameter(Constants.ID_HO_SO_THU_TUC, hoSoThuTucId);
phuHieu_oTo_CD.setParameter(Constants.ID_PHIEU_XU_LY, phieuXuLyId);
phuHieu_oTo_CD.setParameter(Constants.THANH_PHAN_XU_LY, Constants.XU_LY_TLHS);
phuHieu_oTo_CD.setParameter(Constants.ID_QUY_TRINH_THU_TUC, quyTrinhThuTucId);
phuHieu_oTo_CD.setParameter(Constants.ID_THU_TUC_HANH_CHINH, idThuTucHanhChinh);
...
<aui:input type="hidden" name="actionURL" value="<%=phuHieu_oTo_CD.toString() %>"></aui:input>
