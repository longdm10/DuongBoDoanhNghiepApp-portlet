...
PortletURL quocTe_vietCam_CDDYCBS = renderResponse.createActionURL();
quocTe_vietCam_CDDYCBS.setParameter(ActionRequest.ACTION_NAME, "quocTe_vietCam_CDDYCBS");
quocTe_vietCam_CDDYCBS.setParameter(Constants.ID_HO_SO_THU_TUC, hoSoThuTucId);
quocTe_vietCam_CDDYCBS.setParameter(Constants.ID_PHIEU_XU_LY, phieuXuLyId);
quocTe_vietCam_CDDYCBS.setParameter(Constants.THANH_PHAN_XU_LY, Constants.XU_LY_TLHS);
quocTe_vietCam_CDDYCBS.setParameter(Constants.ID_QUY_TRINH_THU_TUC, quyTrinhThuTucId);
quocTe_vietCam_CDDYCBS.setParameter(Constants.ID_THU_TUC_HANH_CHINH, idThuTucHanhChinh);
%>
...
<div class="TabbedPanelsContent">
	...
	<div style = "margin-top: 20px;">
		...
		<aui:input type="hidden" name="actionURL" value="<%=quocTe_vietCam_CDDYCBS.toString() %>"></aui:input>
