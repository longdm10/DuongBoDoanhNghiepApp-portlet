...
PortletURL quocTe_vietLao_HTHS = renderResponse.createActionURL();
quocTe_vietLao_HTHS.setParameter(ActionRequest.ACTION_NAME, "quocTe_vietLao_HTHS");
quocTe_vietLao_HTHS.setParameter(Constants.ID_HO_SO_THU_TUC, hoSoThuTucId);
quocTe_vietLao_HTHS.setParameter(Constants.ID_PHIEU_XU_LY, phieuXuLyId);
quocTe_vietLao_HTHS.setParameter(Constants.THANH_PHAN_XU_LY, Constants.XU_LY_TLHS);
quocTe_vietLao_HTHS.setParameter(Constants.ID_QUY_TRINH_THU_TUC, quyTrinhThuTucId);
quocTe_vietLao_HTHS.setParameter(Constants.ID_THU_TUC_HANH_CHINH, idThuTucHanhChinh);
...
<div class="TabbedPanelsContent">
	...
	<aui:row>
		<aui:col width="50">
			<aui:field-wrapper label="Họ tên người nhận kết quả:" inlineField="<%=true %>" >
				<aui:input type="text" name="<%=QLVTQuocTeTerm.NGUOI_NHAN_KET_QUA %>" value="<%=ettThongTinHoSo.getNguoiLienHeTraKetQua() %>" label="">
				</aui:input> 
			</aui:field-wrapper>
		</aui:col>
		<aui:col width="50">
	...
	<div style = "margin-top: 20px;">
		...
		<aui:input type="hidden" name="actionURL" value="<%=quocTe_vietLao_HTHS.toString() %>"></aui:input>
