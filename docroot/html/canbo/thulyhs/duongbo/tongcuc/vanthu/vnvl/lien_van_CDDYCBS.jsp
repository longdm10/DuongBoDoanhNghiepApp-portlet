...
PortletURL lienVan_vietLao_CDDYCBS = renderResponse.createActionURL();
lienVan_vietLao_CDDYCBS.setParameter(ActionRequest.ACTION_NAME, "lienVan_vietLao_CDDYCBS");
lienVan_vietLao_CDDYCBS.setParameter(Constants.ID_HO_SO_THU_TUC, hoSoThuTucId);
lienVan_vietLao_CDDYCBS.setParameter(Constants.ID_PHIEU_XU_LY, phieuXuLyId);
lienVan_vietLao_CDDYCBS.setParameter(Constants.THANH_PHAN_XU_LY, Constants.XU_LY_TLHS);
lienVan_vietLao_CDDYCBS.setParameter(Constants.ID_QUY_TRINH_THU_TUC, quyTrinhThuTucId);
lienVan_vietLao_CDDYCBS.setParameter(Constants.ID_THU_TUC_HANH_CHINH, idThuTucHanhChinh);
...
<div class="TabbedPanelsContent">
	...
	<div style = "margin-top: 20px;">
		...
		<aui:input type="hidden" name="actionURL" value="<%=lienVan_vietLao_CDDYCBS.toString() %>"></aui:input>
