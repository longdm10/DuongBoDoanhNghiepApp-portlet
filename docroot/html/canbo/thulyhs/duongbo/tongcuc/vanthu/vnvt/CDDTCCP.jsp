...
PortletURL lienVan_vietTrung_CDDTCCP = renderResponse.createActionURL();
lienVan_vietTrung_CDDTCCP.setParameter(ActionRequest.ACTION_NAME, "lienVan_vietTrung_CDDTCCP");
lienVan_vietTrung_CDDTCCP.setParameter(Constants.ID_HO_SO_THU_TUC, hoSoThuTucId);
lienVan_vietTrung_CDDTCCP.setParameter(Constants.ID_PHIEU_XU_LY, phieuXuLyId);
lienVan_vietTrung_CDDTCCP.setParameter(Constants.THANH_PHAN_XU_LY, Constants.XU_LY_TLHS);
lienVan_vietTrung_CDDTCCP.setParameter(Constants.ID_QUY_TRINH_THU_TUC, quyTrinhThuTucId);
lienVan_vietTrung_CDDTCCP.setParameter(Constants.ID_THU_TUC_HANH_CHINH, idThuTucHanhChinh);
...
<%
	...
	<div style = "margin-top: 20px;">
		...
		<aui:input type="hidden" name="actionURL" value="<%=lienVan_vietTrung_CDDTCCP.toString() %>"></aui:input>
