...
<%
	...
	if(Validator.isNotNull(workingUnitId)){
		listEmployee = OEPUserMgtEmployeeLocalServiceUtil.findByworkingUnitId(Long.valueOf(workingUnitId));
	}
	String requiredLabel = "";
	requiredLabel = "(*)";
	String dotLabel = ":";
%>
<select required="required" class="form-control" id="empId" name="empId">
	<%
