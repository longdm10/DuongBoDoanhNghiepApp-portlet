...
PortletURL noiDia_oTo_CDDYCBS = renderResponse.createActionURL();
noiDia_oTo_CDDYCBS.setParameter(ActionRequest.ACTION_NAME, "noiDia_oTo_CDDYCBS");
noiDia_oTo_CDDYCBS.setParameter(Constants.ID_HO_SO_THU_TUC, hoSoThuTucId);
noiDia_oTo_CDDYCBS.setParameter(Constants.ID_PHIEU_XU_LY, phieuXuLyId);
noiDia_oTo_CDDYCBS.setParameter(Constants.THANH_PHAN_XU_LY, Constants.XU_LY_TLHS);
noiDia_oTo_CDDYCBS.setParameter(Constants.ID_QUY_TRINH_THU_TUC, quyTrinhThuTucId);
noiDia_oTo_CDDYCBS.setParameter(Constants.ID_THU_TUC_HANH_CHINH, idThuTucHanhChinh);
%>
...
<div class="TabbedPanelsContent">
	...
	<div style = "margin-top: 20px;">
		...
		<aui:input type="hidden" name="actionURL" value="<%=noiDia_oTo_CDDYCBS.toString() %>"></aui:input>
