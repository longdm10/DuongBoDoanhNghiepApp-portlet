...
PortletURL bienHieu_oTo_CDDTCCP = renderResponse.createActionURL();
bienHieu_oTo_CDDTCCP.setParameter(ActionRequest.ACTION_NAME, "bienHieu_oTo_CDDTCCP");
bienHieu_oTo_CDDTCCP.setParameter(Constants.ID_HO_SO_THU_TUC, hoSoThuTucId);
bienHieu_oTo_CDDTCCP.setParameter(Constants.ID_PHIEU_XU_LY, phieuXuLyId);
bienHieu_oTo_CDDTCCP.setParameter(Constants.THANH_PHAN_XU_LY, Constants.XU_LY_TLHS);
bienHieu_oTo_CDDTCCP.setParameter(Constants.ID_QUY_TRINH_THU_TUC, quyTrinhThuTucId);
bienHieu_oTo_CDDTCCP.setParameter(Constants.ID_THU_TUC_HANH_CHINH, idThuTucHanhChinh);
...
<%
	...
	<div style = "margin-top: 20px;">
		...
		<aui:input type="hidden" name="actionURL" value="<%=bienHieu_oTo_CDDTCCP.toString() %>"></aui:input>
