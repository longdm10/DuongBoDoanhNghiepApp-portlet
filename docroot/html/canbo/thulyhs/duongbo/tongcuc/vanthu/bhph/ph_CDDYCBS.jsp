...
PortletURL phuHieu_oTo_CDDYCBS = renderResponse.createActionURL();
phuHieu_oTo_CDDYCBS.setParameter(ActionRequest.ACTION_NAME, "phuHieu_oTo_CDDYCBS");
phuHieu_oTo_CDDYCBS.setParameter(Constants.ID_HO_SO_THU_TUC, hoSoThuTucId);
phuHieu_oTo_CDDYCBS.setParameter(Constants.ID_PHIEU_XU_LY, phieuXuLyId);
phuHieu_oTo_CDDYCBS.setParameter(Constants.THANH_PHAN_XU_LY, Constants.XU_LY_TLHS);
phuHieu_oTo_CDDYCBS.setParameter(Constants.ID_QUY_TRINH_THU_TUC, quyTrinhThuTucId);
phuHieu_oTo_CDDYCBS.setParameter(Constants.ID_THU_TUC_HANH_CHINH, idThuTucHanhChinh);
...
<%
	...
	<div style = "margin-top: 20px;">
		...
		<aui:input type="hidden" name="actionURL" value="<%=phuHieu_oTo_CDDYCBS.toString() %>"></aui:input>
