...
<%
	...
	if (xacNhanThanhToanId > 0) {
		TthcXacNhanThanhToan tXacNhanThanhToan = TthcXacNhanThanhToanLocalServiceUtil.fetchTthcXacNhanThanhToan(xacNhanThanhToanId);
		...
		motCuaPhieuXuLy = MotCuaPhieuXuLyLocalServiceUtil.fetchMotCuaPhieuXuLy(phieuXuLyId);
	}
	...
	try {
		if (motCuaPhieuXuLy != null) {
			...
			if (motCuaTrangThaiHoSo != null) {
				if (CommonUtils.checkRole1(themeDisplay, motCuaTrangThaiHoSo)) {
