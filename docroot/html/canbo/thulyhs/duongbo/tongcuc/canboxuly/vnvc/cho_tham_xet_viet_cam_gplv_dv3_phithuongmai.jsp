...
// 	QlvtXuLyGpLienVanTuyen ettLienVanTuyen = QlvtXuLyGpLienVanTuyenLocalServiceUtil.fetchQlvtXuLyGpLienVanTuyen(ettGpLienVan.getId());
...
<portlet:renderURL var="dv1Page" windowState="<%=LiferayWindowState.EXCLUSIVE.toString()%>">
	...
	<liferay-util:param name="tq2" value="phithuongmai" />
