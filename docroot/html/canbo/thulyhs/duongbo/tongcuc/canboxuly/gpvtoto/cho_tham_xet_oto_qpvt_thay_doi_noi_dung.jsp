	...
	<aui:column columnWidth="50">
		<aui:row>
			<aui:col width="100">
				...
				<aui:field-wrapper  cssClass="pad15" label="<span class='hidden'>5. </span>Loại hình kinh doanh:" inlineField="<%=true %>" inlineLabel="true">
					<%
				...
				<aui:field-wrapper label="6. Người đại diện hợp pháp của Doanh nghiệp:" inlineField="<%=true %>" inlineLabel="true">
				</aui:field-wrapper>
				<aui:field-wrapper  cssClass="pad15" label="<span class='hidden'>6. </span>Họ và tên:" inlineField="<%=true %>" inlineLabel="true">
					<%=HtmlUtil.escape(ettThongTinHoSo.getNguoiLienHeTraKetQua()) %>
				</aui:field-wrapper>
				<aui:field-wrapper  cssClass="pad15" label="<span class='hidden'>6. </span>Số CMND (hoặc Hộ chiếu):" inlineField="<%=true %>" inlineLabel="true">
				</aui:field-wrapper>
				<aui:field-wrapper  cssClass="pad15" label="<span class='hidden'>6. </span>Ngày cấp:" inlineField="<%=true %>" inlineLabel="true">
				</aui:field-wrapper>
				<aui:field-wrapper  cssClass="pad15" label="<span class='hidden'>6. </span>Nơi cấp:" inlineField="<%=true %>" inlineLabel="true">
				</aui:field-wrapper>
			</aui:col>
		</aui:row>
	</aui:column>
	<aui:column columnWidth="50" cssClass="borderLeft">
		<aui:row>
			<aui:col width="100">
				...
				<aui:field-wrapper cssClass="pad15" label="6. Người đại diện hợp pháp của Doanh nghiệp:" inlineField="<%=true %>" inlineLabel="true">
				</aui:field-wrapper>
				<aui:field-wrapper  cssClass="pad15 padTop9" label="" inlineField="<%=true %>" inlineLabel="true">
					<aui:input placeholder="Họ và tên" label="" name="<%=QLVTNoiDiaTerm.NGUOI_DAI_DIEN_DN %>"></aui:input>
				</aui:field-wrapper>
				<aui:field-wrapper  cssClass="pad15" label="" inlineField="<%=true %>" inlineLabel="true">
					<aui:input placeholder="Số CMND (hoặc Hộ chiếu)" name=""></aui:input>
				</aui:field-wrapper>
				<aui:field-wrapper  cssClass="pad15" label="" inlineField="<%=true %>" inlineLabel="true">
					<aui:input placeholder="Ngày cấp" name=""></aui:input>
				</aui:field-wrapper>
				<aui:field-wrapper  cssClass="pad15" label="" inlineField="<%=true %>" inlineLabel="true">
					<aui:input placeholder="Nơi cấp" name=""></aui:input>
				</aui:field-wrapper>
			</aui:col>
		</aui:row>
	</aui:column>
