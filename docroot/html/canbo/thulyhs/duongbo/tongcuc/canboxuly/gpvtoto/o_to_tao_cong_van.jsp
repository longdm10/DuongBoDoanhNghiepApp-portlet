...
<%
	...
	xemTruocNoiDung.setParameter("jspPageSuccess", "/html/canbo/thulyhs/duongbo/tongcuc/canboxuly/gpvtoto/o_to_tao_cong_van_view.jsp");
	...
	<aui:form name="fm" action="#">
		...
		<div class="box1000">
			...
			<div style="margin-top: 20px;">
				<input style="width: 10%;" class="btn btn-primary" type="submit" value="Xem kết quả"
