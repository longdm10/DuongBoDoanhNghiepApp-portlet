...
<aui:row>
	<aui:col width="50">
		<aui:field-wrapper label="Loại xe:" inlineField="<%=true %>" >
	...
	<aui:col width="50">
		<aui:field-wrapper label="Năm sản xuất:" inlineField="<%=true %>" >
			<aui:select name="<%=QLVTKhaiTacTuyen.NAM_SX %>" label=" " id="<%=QLVTKhaiTacTuyen.NAM_SX %>" class="form-control">
...
<aui:row>
	<aui:col width="50">
		...
		<aui:field-wrapper label="Trọng tải:" inlineField="<%=true %>" >
			<aui:input type="text" name="<%=QLVTKhaiTacTuyen.TRONG_TAI %>" value="<%=qlvtXuLyKTTQuocTePhuongTien.getTrongTai() %>" label="">
			</aui:input>
		</aui:field-wrapper>
	</aui:col>
</aui:row>
...
<aui:row>
	<aui:col width="100">
		<aui:field-wrapper label="Xe thuê/ sở hữu:" inlineField="<%=true %>" >
			<select name="<%=QLVTKhaiTacTuyen.HINH_THUC_SO_HUU %>" label="" id="<%=QLVTKhaiTacTuyen.HINH_THUC_SO_HUU%>">
				<%
...
<aui:row>
	...
	<aui:col width="50">
		<aui:field-wrapper label="Hợp đồng sau cùng" inlineField="<%=true %>" >
			<aui:select name="<%=QLVTKhaiTacTuyen.HOP_DONG_SAU_CUNG %>" label="" id="<%=QLVTKhaiTacTuyen.HOP_DONG_SAU_CUNG %>">
				<%
	...
	<aui:row>
		<aui:col width="100">
			<aui:field-wrapper label="Lý do" inlineField="<%=true %>" >
				<aui:input label="" type="textarea" name="<%=QLVTKhaiTacTuyen.LY_DO_KHONG_DAT %>" value="<%=qlvtXuLyKTTQuocTePhuongTien.getLyDoKhongDat()%>" cssClass="myTextArea">
				</aui:input>
			</aui:field-wrapper>
		</aui:col>
	</aui:row>
