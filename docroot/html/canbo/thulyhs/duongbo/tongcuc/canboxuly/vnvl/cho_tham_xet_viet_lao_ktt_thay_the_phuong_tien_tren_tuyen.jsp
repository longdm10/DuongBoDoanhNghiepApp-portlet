...
<div id="dv1">
	...
	<aui:row>
		<aui:col width="100">
			<aui:field-wrapper label="3. Đăng ký khai thác tuyến vận tải hành khách tuyến cố định bằng xe ô tô giữa Việt Nam và Lào:" cssClass="textBold" inlineField="<%=true %>" >
			</aui:field-wrapper>
		</aui:col>
	</aui:row>
