	...
	<aui:row>
		<aui:col width="100">
			<aui:field-wrapper label="Có giá trị đến:" inlineField="<%=true %>" >
				<aui:input prefix="date" type="text" name="<%=QlvtLienVanTerm.NGAY_HET_HAN_GPVT %>" value="<%=qlvtXuLyGpLienVanPhuongTien.getXinGiaHanDenNgay()%>" label="">
	...
	<aui:row>
		<aui:col width="100">
			<aui:field-wrapper label="Lý do" inlineField="<%=true %>" >
				<aui:input type="textarea" name="<%=QlvtLienVanTerm.LY_DO_KHONG_DAT %>" value="<%=qlvtXuLyGpLienVanPhuongTien.getLyDoKhongDat()%>" label="">
				</aui:input>
			</aui:field-wrapper>
		</aui:col>
	</aui:row>
