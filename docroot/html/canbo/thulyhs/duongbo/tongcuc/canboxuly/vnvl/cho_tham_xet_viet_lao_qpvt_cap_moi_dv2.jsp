...
<%
showMyForm.setParameter("mvcPath", "/html/canbo/thulyhs/duongbo/tongcuc/canboxuly/vnvl/cho_tham_xet_viet_lao_qpvt_cap_moi_dv3_"+ett.getCol2()+".jsp");
showMyForm.setParameter("col1", ett.getCol1());
showMyForm.setParameter("col2", ett.getCol2());
%>
	<a style="cursor:help" onclick="javascript:loadMyPageDv3('<%=showMyForm%>');"><%= DmDataItemLocalServiceUtil.findByGroupIdAndCode(Constants.GROUP_ID_LOAI_HINH_HOAT_DONG, ett.getCol2()).getName() %></a>
