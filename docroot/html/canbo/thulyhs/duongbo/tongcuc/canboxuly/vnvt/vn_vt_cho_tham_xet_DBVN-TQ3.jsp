...
<div id="dv1">
	...
	<aui:row>
		<aui:col width="100">
			<strong>2. Người liên hệ trả kết quả:</strong>
		</aui:col>
	</aui:row>
	<aui:row>
		<aui:col width="50">
			<aui:field-wrapper label="Địa chỉ:" inlineField="<%=true %>" >
				<aui:input disabled="true" type="text" name="" value="<%=ettThongTinHoSo.getDiaChiNguoiLienHeTraKetQua() %>" label="">
				</aui:input>
				<aui:input type="hidden" name="<%=QlvtLienVanTerm.DIA_CHI_NGUOI_TRA_KET_QUA %>" value="<%=ettThongTinHoSo.getDiaChiNguoiLienHeTraKetQua() %>" label="">
				</aui:input>
			</aui:field-wrapper>
		</aui:col>
		<aui:col width="50">
...
<div style="width: 350px; float: left;">
	<liferay-util:include page="/html/canbo/thulyhs/duongbo/tongcuc/canboxuly/vnvt/vn_vt_cho_tham_xet_dv2.jsp" servletContext="<%=this.getServletContext() %>">
		...
		<liferay-util:param name="tq2" value="3" />
