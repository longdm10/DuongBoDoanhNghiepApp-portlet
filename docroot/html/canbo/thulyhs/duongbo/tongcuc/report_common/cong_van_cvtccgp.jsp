...
<h4 class="tle text-center">CÔNG VĂN TỪ CHỐI CẤP<br><%=tenHoSoThuTuc%></h4>
<div class="col-sm-12">
	...
	<p>
		...
		<%=tenDoanhNghiep%>
		cần bổ sung vì lý do:
	</p>
	<p>
		<textarea style="width: 860px; height: 45px;" rows="" cols="" required="required"name="lyDoBoSung" id="lyDoBoSung"></textarea>
	</p>
