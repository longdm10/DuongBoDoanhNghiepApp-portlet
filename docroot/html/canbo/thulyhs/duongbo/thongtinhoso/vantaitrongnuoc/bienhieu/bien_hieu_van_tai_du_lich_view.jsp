...
<%@page import="vn.dtt.duongbo.maudon.model.PhuHieuLienVanVietLaos"%>
...
<%
	_log.info("------/html/canbo/thulyhs/duongbo/thongtinhoso/vantaitrongnuoc/bienhieu/bien_hieu_van_tai_du_lich_view.jsp---------");
...
// 	String tenQuocTe= ParamUtil.getString(request, "tenQuocTe");
	...
	actionBack.setParameter("jspPage", "/html/hsdoanhnghiep/thongtinhoso/duongbo/vantaitrongnuoc/bienhieu/bien_hieu_van_tai_du_lich.jsp");
...
<div class="P10 col-xs-12">
	<div class="BGT noidung">
		<div class="col-xs-12">
			...
			<!-- noi dung file PDF-->
			<div>
				<%@ include file="/html/canbo/thulyhs/duongbo/thongtinhoso/vantaitrongnuoc/bienhieu/thong_tin_hs_report_export.jsp"%>
			</div>
