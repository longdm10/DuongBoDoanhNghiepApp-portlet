...
if (hoSoThuTucXuLy.getTrangThaiHoSo().trim().equals(Constants.DOANH_NGHIEP_TRANG_THAI_HO_SO_DANG_XU_LY)) {
	%>
	<jsp:include page="/html/canbo/thulyhs/duongbo/thongtinhoso/vantaitrongnuoc/bienhieu/thanh_phan_ho_so_view.jsp"></jsp:include>
	<%
} else {
	%>
	<jsp:include page="/html/canbo/thulyhs/duongbo/thongtinhoso/vantaitrongnuoc/bienhieu/thanh_phan_ho_so.jsp"></jsp:include>
	<%
}
%>
