...
function RenderCssCal(bNewCal) {
	...
	if (Cal.ShowTime === true) {
		...
		vCalTime += "<tbody>";
		//TODO datetimepicker an dong chon gio, phut, giay ?
		vCalTime += "<tr>";
	...
	if (!winCal) {
		...
		if (isChrome === true) {
			span.style.top = (offsetElement.top - 175) + 'px';
		...
		//TODO minhnd max zIndex luon luon hien thi in N layout
		...
		if (bNewCal === true) {
			...
			if (isChrome === true) {
				winCal.style.top = (offsetElement.top - 175) + 'px';
			} else if (isFirefox === true) {
