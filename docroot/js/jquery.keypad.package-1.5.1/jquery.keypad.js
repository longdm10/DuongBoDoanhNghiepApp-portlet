...
function Keypad() {
	...
	this.regional[''] = { // Default regional settings
		...
		buttonStatus: 'Mở keypad', // Status text for trigger button
		closeText: 'Close', // Display text for close link
		closeStatus: 'Đóng keypad', // Status text for close link
		clearText: 'Clear', // Display text for clear link
		clearStatus: 'Erase all the text', // Status text for clear link
		backText: 'Back', // Display text for back link
		backStatus: 'Xóa ký tự trước', // Status text for back link
		...
		shiftStatus: 'Chuyển đổi các ký tự chữ hoa/chữ thường', // Status text for shift link
