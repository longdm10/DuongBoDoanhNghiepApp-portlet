...
import vn.dtt.duongthuy.maudon.model.DonDTTPHS170;


public class DTTPHS170 extends DonOnline {
	
	public DTTPHS170(PortletRequest request) {
		super(request);
	}
	
	public DTTPHS170(HttpServletRequest request) {
		super(request);
	}
	
	public String getNoiDungXML() throws IOException {
		
		DonDTTPHS170 donOnline = new DonDTTPHS170();
