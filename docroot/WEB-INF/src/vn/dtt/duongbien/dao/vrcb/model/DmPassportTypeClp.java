...
public class DmPassportTypeClp extends BaseModelImpl<DmPassportType>
	...
	public void setId(int id) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				Class<?> clazz = _dmPassportTypeRemoteModel.getClass();

				Method method = clazz.getMethod("setId", int.class);

				method.invoke(_dmPassportTypeRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setPassportTypeCode(String passportTypeCode) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmPassportTypeRemoteModel, passportTypeCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPassportType(String passportType) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmPassportTypeRemoteModel, passportType);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPassportTypeName(String passportTypeName) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmPassportTypeRemoteModel, passportTypeName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPassportTypeNameVN(String passportTypeNameVN) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmPassportTypeRemoteModel, passportTypeNameVN);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsDelete(int isDelete) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmPassportTypeRemoteModel, isDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMarkedAsDelete(int markedAsDelete) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmPassportTypeRemoteModel, markedAsDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmPassportTypeRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setRequestedDate(Date requestedDate) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmPassportTypeRemoteModel, requestedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSyncVersion(String syncVersion) {
		...
		if (_dmPassportTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmPassportTypeRemoteModel, syncVersion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDmPassportTypeRemoteModel() {
		return _dmPassportTypeRemoteModel;
	}

	public void setDmPassportTypeRemoteModel(
		BaseModel<?> dmPassportTypeRemoteModel) {
		_dmPassportTypeRemoteModel = dmPassportTypeRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _dmPassportTypeRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_dmPassportTypeRemoteModel,
	...
	public DmPassportType toEscapedModel() {
		return (DmPassportType)ProxyUtil.newProxyInstance(DmPassportType.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DmPassportTypeClp)) {
			return false;
		}

		DmPassportTypeClp dmPassportType = (DmPassportTypeClp)obj;
