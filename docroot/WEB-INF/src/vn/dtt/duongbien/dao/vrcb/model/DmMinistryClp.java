...
public class DmMinistryClp extends BaseModelImpl<DmMinistry>
	...
	public void setId(long id) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				Class<?> clazz = _dmMinistryRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_dmMinistryRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setMinistryCode(String ministryCode) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				...
				method.invoke(_dmMinistryRemoteModel, ministryCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMinistryName(String ministryName) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				...
				method.invoke(_dmMinistryRemoteModel, ministryName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMinistryNameVN(String ministryNameVN) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				...
				method.invoke(_dmMinistryRemoteModel, ministryNameVN);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMinistryOrder(int ministryOrder) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				...
				method.invoke(_dmMinistryRemoteModel, ministryOrder);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsDelete(int isDelete) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				...
				method.invoke(_dmMinistryRemoteModel, isDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMarkedAsDelete(int markedAsDelete) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				...
				method.invoke(_dmMinistryRemoteModel, markedAsDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				...
				method.invoke(_dmMinistryRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setRequestedDate(Date requestedDate) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				...
				method.invoke(_dmMinistryRemoteModel, requestedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSyncVersion(String syncVersion) {
		...
		if (_dmMinistryRemoteModel != null) {
			try {
				...
				method.invoke(_dmMinistryRemoteModel, syncVersion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDmMinistryRemoteModel() {
		return _dmMinistryRemoteModel;
	}

	public void setDmMinistryRemoteModel(BaseModel<?> dmMinistryRemoteModel) {
		_dmMinistryRemoteModel = dmMinistryRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _dmMinistryRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_dmMinistryRemoteModel,
	...
	public DmMinistry toEscapedModel() {
		return (DmMinistry)ProxyUtil.newProxyInstance(DmMinistry.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DmMinistryClp)) {
			return false;
		}

		DmMinistryClp dmMinistry = (DmMinistryClp)obj;
