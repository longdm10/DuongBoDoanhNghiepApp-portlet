...
public class DmGoodsTypeLocalServiceClp implements DmGoodsTypeLocalService {
	public DmGoodsTypeLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.DmGoodsType addDmGoodsType(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dmGoodsType) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.DmGoodsType)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmGoodsType> getDmGoodsTypes(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmGoodsType>)ClpSerializer.translateOutput(returnObj);
	}
