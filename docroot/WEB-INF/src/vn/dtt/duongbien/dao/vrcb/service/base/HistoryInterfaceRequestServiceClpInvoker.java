 ...
 * @generated
 */
public class HistoryInterfaceRequestServiceClpInvoker {
	public HistoryInterfaceRequestServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return HistoryInterfaceRequestServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			HistoryInterfaceRequestServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
