...
public class RmdcShipWrapper implements RmdcShip, ModelWrapper<RmdcShip> {
	...
	*/
	...
	public void setExpandoBridgeAttributes(
		...
		_rmdcShip.setExpandoBridgeAttributes(baseModel);
	}

	@Override
	public void setExpandoBridgeAttributes(
		com.liferay.portlet.expando.model.ExpandoBridge expandoBridge) {
		_rmdcShip.setExpandoBridgeAttributes(expandoBridge);
	}
	...
	@Override
	public int compareTo(vn.dtt.duongbien.dao.vrcb.model.RmdcShip rmdcShip) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<vn.dtt.duongbien.dao.vrcb.model.RmdcShip> toCacheModel() {
		return _rmdcShip.toCacheModel();
	}

	@Override
	public vn.dtt.duongbien.dao.vrcb.model.RmdcShip toEscapedModel() {
		return new RmdcShipWrapper(_rmdcShip.toEscapedModel());
	}

	@Override
	public vn.dtt.duongbien.dao.vrcb.model.RmdcShip toUnescapedModel() {
		return new RmdcShipWrapper(_rmdcShip.toUnescapedModel());
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RmdcShipWrapper)) {
			return false;
		}

		RmdcShipWrapper rmdcShipWrapper = (RmdcShipWrapper)obj;

		if (Validator.equals(_rmdcShip, rmdcShipWrapper._rmdcShip)) {
			return true;
		}
