...
public class DmStateClp extends BaseModelImpl<DmState> implements DmState {
	...
	public void setId(int id) {
		...
		if (_dmStateRemoteModel != null) {
			try {
				Class<?> clazz = _dmStateRemoteModel.getClass();

				Method method = clazz.getMethod("setId", int.class);

				method.invoke(_dmStateRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setStateCode(String stateCode) {
		...
		if (_dmStateRemoteModel != null) {
			try {
				...
				method.invoke(_dmStateRemoteModel, stateCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStateName(String stateName) {
		...
		if (_dmStateRemoteModel != null) {
			try {
				...
				method.invoke(_dmStateRemoteModel, stateName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDescription(String description) {
		...
		if (_dmStateRemoteModel != null) {
			try {
				...
				method.invoke(_dmStateRemoteModel, description);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsDelete(int isDelete) {
		...
		if (_dmStateRemoteModel != null) {
			try {
				...
				method.invoke(_dmStateRemoteModel, isDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMarkedAsDelete(int markedAsDelete) {
		...
		if (_dmStateRemoteModel != null) {
			try {
				...
				method.invoke(_dmStateRemoteModel, markedAsDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_dmStateRemoteModel != null) {
			try {
				...
				method.invoke(_dmStateRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setRequestedDate(Date requestedDate) {
		...
		if (_dmStateRemoteModel != null) {
			try {
				...
				method.invoke(_dmStateRemoteModel, requestedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSyncVersion(String syncVersion) {
		...
		if (_dmStateRemoteModel != null) {
			try {
				...
				method.invoke(_dmStateRemoteModel, syncVersion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDmStateRemoteModel() {
		return _dmStateRemoteModel;
	}

	public void setDmStateRemoteModel(BaseModel<?> dmStateRemoteModel) {
		_dmStateRemoteModel = dmStateRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _dmStateRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_dmStateRemoteModel,
	...
	public DmState toEscapedModel() {
		return (DmState)ProxyUtil.newProxyInstance(DmState.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DmStateClp)) {
			return false;
		}

		DmStateClp dmState = (DmStateClp)obj;
