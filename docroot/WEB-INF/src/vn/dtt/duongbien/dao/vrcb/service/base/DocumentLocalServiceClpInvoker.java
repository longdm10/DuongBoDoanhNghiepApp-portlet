...
public class DocumentLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return DocumentLocalServiceUtil.addDocument((vn.dtt.duongbien.dao.vrcb.model.Document)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return DocumentLocalServiceUtil.deleteDocument((vn.dtt.duongbien.dao.vrcb.model.Document)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return DocumentLocalServiceUtil.updateDocument((vn.dtt.duongbien.dao.vrcb.model.Document)arguments[0]);
		}
