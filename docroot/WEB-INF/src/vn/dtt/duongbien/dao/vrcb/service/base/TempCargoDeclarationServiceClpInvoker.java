 ...
 * @generated
 */
public class TempCargoDeclarationServiceClpInvoker {
	public TempCargoDeclarationServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempCargoDeclarationServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempCargoDeclarationServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
