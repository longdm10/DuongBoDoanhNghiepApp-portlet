 ...
 * @generated
 */
public class TempShipStoresDeclarationServiceClpInvoker {
	public TempShipStoresDeclarationServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempShipStoresDeclarationServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempShipStoresDeclarationServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
