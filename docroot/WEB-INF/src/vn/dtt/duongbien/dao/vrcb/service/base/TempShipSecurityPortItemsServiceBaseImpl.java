...
import vn.dtt.duongbien.dao.vrcb.service.TempShipSecurityPortItemsService;
...
/**
 * Provides the base implementation for the temp ship security port items remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempShipSecurityPortItemsServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempShipSecurityPortItemsServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.TempShipSecurityPortItemsServiceUtil
 * @generated
 */
public abstract class TempShipSecurityPortItemsServiceBaseImpl
	extends BaseServiceImpl implements TempShipSecurityPortItemsService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempShipSecurityPortItemsServiceUtil} to access the temp ship security port items remote service.
	 */
	...
	private TempShipSecurityPortItemsServiceClpInvoker _clpInvoker = new TempShipSecurityPortItemsServiceClpInvoker();
}