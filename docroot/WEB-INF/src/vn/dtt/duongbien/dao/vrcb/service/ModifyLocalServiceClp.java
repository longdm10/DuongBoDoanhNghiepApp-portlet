...
public class ModifyLocalServiceClp implements ModifyLocalService {
	public ModifyLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public vn.dtt.duongbien.dao.vrcb.model.Modify addModify(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(modify) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.Modify)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.Modify> getModifies(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.Modify>)ClpSerializer.translateOutput(returnObj);
	}
