...
import vn.dtt.duongbien.dao.vrcb.model.DmShipTypeModel;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.dtt.duongbien.dao.vrcb.model.DmShipTypeModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DmShipTypeImpl}.
 * </p>
 *
 * @author longdm
 * @see DmShipTypeImpl
 * @see vn.dtt.duongbien.dao.vrcb.model.DmShipType
 * @see vn.dtt.duongbien.dao.vrcb.model.DmShipTypeModel
 * @generated
 */
public class DmShipTypeModelImpl extends BaseModelImpl<DmShipType>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm ship type model instance should use the {@link vn.dtt.duongbien.dao.vrcb.model.DmShipType} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.dtt.duongbien.dao.vrcb.model.DmShipType"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.dtt.duongbien.dao.vrcb.model.DmShipType"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.vn.dtt.duongbien.dao.vrcb.model.DmShipType"),
			true);
	public static long SHIPTYPECODE_COLUMN_BITMASK = 1L;
	public static long ID_COLUMN_BITMASK = 2L;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.dtt.duongbien.dao.vrcb.model.DmShipType"));
	...
	public DmShipType toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (DmShipType)ProxyUtil.newProxyInstance(_classLoader,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DmShipType)) {
			return false;
		}

		DmShipType dmShipType = (DmShipType)obj;
	...
	private DmShipType _escapedModel;
}