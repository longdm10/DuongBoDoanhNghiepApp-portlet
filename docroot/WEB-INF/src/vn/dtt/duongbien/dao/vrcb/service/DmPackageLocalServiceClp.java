...
public class DmPackageLocalServiceClp implements DmPackageLocalService {
	public DmPackageLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public vn.dtt.duongbien.dao.vrcb.model.DmPackage addDmPackage(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dmPackage) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.DmPackage)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmPackage> getDmPackages(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmPackage>)ClpSerializer.translateOutput(returnObj);
	}
