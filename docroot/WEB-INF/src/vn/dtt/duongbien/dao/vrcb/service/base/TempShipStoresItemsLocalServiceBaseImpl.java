...
import vn.dtt.duongbien.dao.vrcb.service.TempShipStoresItemsLocalService;
...
/**
 * Provides the base implementation for the temp ship stores items local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempShipStoresItemsLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempShipStoresItemsLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.TempShipStoresItemsLocalServiceUtil
 * @generated
 */
public abstract class TempShipStoresItemsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempShipStoresItemsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempShipStoresItemsLocalServiceUtil} to access the temp ship stores items local service.
	 */
	...
	public TempShipStoresItems addTempShipStoresItems(
		...
		return tempShipStoresItemsPersistence.update(tempShipStoresItems);
	}
	...
	@Override
	public TempShipStoresItems deleteTempShipStoresItems(long id)
		throws PortalException, SystemException {
		return tempShipStoresItemsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempShipStoresItems deleteTempShipStoresItems(
		TempShipStoresItems tempShipStoresItems) throws SystemException {
		return tempShipStoresItemsPersistence.remove(tempShipStoresItems);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempShipStoresItems.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempShipStoresItems",
	...
	private TempShipStoresItemsLocalServiceClpInvoker _clpInvoker = new TempShipStoresItemsLocalServiceClpInvoker();
}