 ...
 * @generated
 */
public class TempCrewEffectsItemsServiceClpInvoker {
	public TempCrewEffectsItemsServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempCrewEffectsItemsServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempCrewEffectsItemsServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
