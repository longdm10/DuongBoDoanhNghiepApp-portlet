...
import vn.dtt.duongbien.dao.vrcb.service.HistoryInterfaceRequestLocalService;
...
/**
 * Provides the base implementation for the history interface request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.HistoryInterfaceRequestLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.HistoryInterfaceRequestLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.HistoryInterfaceRequestLocalServiceUtil
 * @generated
 */
public abstract class HistoryInterfaceRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements HistoryInterfaceRequestLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.HistoryInterfaceRequestLocalServiceUtil} to access the history interface request local service.
	 */
	...
	public HistoryInterfaceRequest addHistoryInterfaceRequest(
		...
		return historyInterfaceRequestPersistence.update(historyInterfaceRequest);
	}
	...
	@Override
	public HistoryInterfaceRequest deleteHistoryInterfaceRequest(long id)
		throws PortalException, SystemException {
		return historyInterfaceRequestPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public HistoryInterfaceRequest deleteHistoryInterfaceRequest(
		HistoryInterfaceRequest historyInterfaceRequest)
		throws SystemException {
		return historyInterfaceRequestPersistence.remove(historyInterfaceRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(HistoryInterfaceRequest.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.HistoryInterfaceRequest",
	...
	private HistoryInterfaceRequestLocalServiceClpInvoker _clpInvoker = new HistoryInterfaceRequestLocalServiceClpInvoker();
}