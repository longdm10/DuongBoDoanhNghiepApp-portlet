 ...
 * @generated
 */
public class TempAttachmentDeclarationHealthServiceClpInvoker {
	public TempAttachmentDeclarationHealthServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempAttachmentDeclarationHealthServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempAttachmentDeclarationHealthServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
