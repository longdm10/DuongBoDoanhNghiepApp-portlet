 ...
 * @generated
 */
public class ModifyCacheModel implements CacheModel<Modify>, Externalizable {
	@Override
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		if (modifyCode == null) {
			...
			objectOutput.writeUTF(modifyCode);
		}
		...
		if (modifyDesc == null) {
			...
			objectOutput.writeUTF(modifyDesc);
		}
		...
		objectOutput.writeLong(documentYear);
	}
