...
/**
 * Provides the local service utility for HistoryRmdcShip. This utility wraps
 * {@link vn.dtt.duongbien.dao.vrcb.service.impl.HistoryRmdcShipLocalServiceImpl} and is the
 ...
 * @see vn.dtt.duongbien.dao.vrcb.service.base.HistoryRmdcShipLocalServiceBaseImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.HistoryRmdcShipLocalServiceImpl
 * @generated
 */
public class HistoryRmdcShipLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.duongbien.dao.vrcb.service.impl.HistoryRmdcShipLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip addHistoryRmdcShip(
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip createHistoryRmdcShip(
		long id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip deleteHistoryRmdcShip(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteHistoryRmdcShip(id);
	}
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip deleteHistoryRmdcShip(
		vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip historyRmdcShip)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteHistoryRmdcShip(historyRmdcShip);
	}
	...
	*/
	...
	public static vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip fetchHistoryRmdcShip(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip getHistoryRmdcShip(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip> getHistoryRmdcShips(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip updateHistoryRmdcShip(
		vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip historyRmdcShip)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static HistoryRmdcShipLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof HistoryRmdcShipLocalService) {
				_service = (HistoryRmdcShipLocalService)invokableLocalService;
			}
			else {
				_service = new HistoryRmdcShipLocalServiceClp(invokableLocalService);
			}
