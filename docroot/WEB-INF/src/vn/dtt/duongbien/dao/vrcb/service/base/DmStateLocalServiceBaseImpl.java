...
import vn.dtt.duongbien.dao.vrcb.service.DmStateLocalService;
...
/**
 * Provides the base implementation for the dm state local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.DmStateLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.DmStateLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.DmStateLocalServiceUtil
 * @generated
 */
public abstract class DmStateLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DmStateLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.DmStateLocalServiceUtil} to access the dm state local service.
	 */
	...
	public DmState addDmState(DmState dmState) throws SystemException {
		...
		return dmStatePersistence.update(dmState);
	}
	...
	@Override
	public DmState deleteDmState(int id)
		throws PortalException, SystemException {
		return dmStatePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DmState deleteDmState(DmState dmState) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DmState.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return dmStatePersistence.countWithDynamicQuery(dynamicQuery, projection);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.DmState",
			dmStateLocalService);
	}
	...
	private DmStateLocalServiceClpInvoker _clpInvoker = new DmStateLocalServiceClpInvoker();
}