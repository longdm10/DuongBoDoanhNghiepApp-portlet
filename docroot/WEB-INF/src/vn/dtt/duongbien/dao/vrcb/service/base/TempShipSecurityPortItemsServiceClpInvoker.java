 ...
 * @generated
 */
public class TempShipSecurityPortItemsServiceClpInvoker {
	public TempShipSecurityPortItemsServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempShipSecurityPortItemsServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempShipSecurityPortItemsServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
