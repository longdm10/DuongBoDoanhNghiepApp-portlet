...
public class DmHistoryGoodsLocalServiceClp implements DmHistoryGoodsLocalService {
	public DmHistoryGoodsLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.DmHistoryGoods addDmHistoryGoods(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dmHistoryGoods) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.DmHistoryGoods)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmHistoryGoods> getDmHistoryGoodses(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmHistoryGoods>)ClpSerializer.translateOutput(returnObj);
	}
