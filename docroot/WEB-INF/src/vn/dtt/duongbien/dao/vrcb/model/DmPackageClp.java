...
public class DmPackageClp extends BaseModelImpl<DmPackage> implements DmPackage {
	...
	public void setId(int id) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				Class<?> clazz = _dmPackageRemoteModel.getClass();

				Method method = clazz.getMethod("setId", int.class);

				method.invoke(_dmPackageRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setPackageCode(String packageCode) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				...
				method.invoke(_dmPackageRemoteModel, packageCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPackageName(String packageName) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				...
				method.invoke(_dmPackageRemoteModel, packageName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPackageNameVN(String packageNameVN) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				...
				method.invoke(_dmPackageRemoteModel, packageNameVN);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPackageOrder(int packageOrder) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				...
				method.invoke(_dmPackageRemoteModel, packageOrder);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsDelete(int isDelete) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				...
				method.invoke(_dmPackageRemoteModel, isDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMarkedAsDelete(int markedAsDelete) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				...
				method.invoke(_dmPackageRemoteModel, markedAsDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				...
				method.invoke(_dmPackageRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setRequestedDate(Date requestedDate) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				...
				method.invoke(_dmPackageRemoteModel, requestedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSyncVersion(String syncVersion) {
		...
		if (_dmPackageRemoteModel != null) {
			try {
				...
				method.invoke(_dmPackageRemoteModel, syncVersion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDmPackageRemoteModel() {
		return _dmPackageRemoteModel;
	}

	public void setDmPackageRemoteModel(BaseModel<?> dmPackageRemoteModel) {
		_dmPackageRemoteModel = dmPackageRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _dmPackageRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_dmPackageRemoteModel,
	...
	public DmPackage toEscapedModel() {
		return (DmPackage)ProxyUtil.newProxyInstance(DmPackage.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DmPackageClp)) {
			return false;
		}

		DmPackageClp dmPackage = (DmPackageClp)obj;
