...
import vn.dtt.duongbien.dao.vrcb.service.InterfaceRequestLocalService;
...
/**
 * Provides the base implementation for the interface request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.InterfaceRequestLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.InterfaceRequestLocalServiceImpl
...
public abstract class InterfaceRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InterfaceRequestLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.InterfaceRequestLocalServiceUtil} to access the interface request local service.
	 */
	...
	public InterfaceRequest addInterfaceRequest(
		...
		return interfaceRequestPersistence.update(interfaceRequest);
	}
	...
	@Override
	public InterfaceRequest deleteInterfaceRequest(long id)
		throws PortalException, SystemException {
		return interfaceRequestPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public InterfaceRequest deleteInterfaceRequest(
		InterfaceRequest interfaceRequest) throws SystemException {
		return interfaceRequestPersistence.remove(interfaceRequest);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(InterfaceRequest.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.InterfaceRequest",
	...
	private InterfaceRequestLocalServiceClpInvoker _clpInvoker = new InterfaceRequestLocalServiceClpInvoker();
}