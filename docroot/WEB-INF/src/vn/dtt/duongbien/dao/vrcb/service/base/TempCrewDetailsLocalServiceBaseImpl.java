...
import vn.dtt.duongbien.dao.vrcb.service.TempCrewDetailsLocalService;
...
/**
 * Provides the base implementation for the temp crew details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempCrewDetailsLocalServiceImpl}.
 * </p>
 *
 * @author longdm
...
public abstract class TempCrewDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempCrewDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempCrewDetailsLocalServiceUtil} to access the temp crew details local service.
	 */
	...
	public TempCrewDetails addTempCrewDetails(TempCrewDetails tempCrewDetails)
		...
		return tempCrewDetailsPersistence.update(tempCrewDetails);
	}
	...
	@Override
	public TempCrewDetails deleteTempCrewDetails(long id)
		throws PortalException, SystemException {
		return tempCrewDetailsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempCrewDetails deleteTempCrewDetails(
		TempCrewDetails tempCrewDetails) throws SystemException {
		return tempCrewDetailsPersistence.remove(tempCrewDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempCrewDetails.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempCrewDetails",
	...
	private TempCrewDetailsLocalServiceClpInvoker _clpInvoker = new TempCrewDetailsLocalServiceClpInvoker();
}