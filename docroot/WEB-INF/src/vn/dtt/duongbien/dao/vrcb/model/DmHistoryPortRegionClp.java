...
public class DmHistoryPortRegionClp extends BaseModelImpl<DmHistoryPortRegion>
	...
	public void setId(int id) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				Class<?> clazz = _dmHistoryPortRegionRemoteModel.getClass();

				Method method = clazz.getMethod("setId", int.class);

				method.invoke(_dmHistoryPortRegionRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setPortRegionCode(String portRegionCode) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, portRegionCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPortRegionName(String portRegionName) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, portRegionName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPortRegionNameVN(String portRegionNameVN) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, portRegionNameVN);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPortRegionRef(String portRegionRef) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, portRegionRef);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setPortCode(String portCode) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, portCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsDelete(int isDelete) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, isDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMarkedAsDelete(int markedAsDelete) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, markedAsDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setRequestedDate(Date requestedDate) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, requestedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSyncVersion(String syncVersion) {
		...
		if (_dmHistoryPortRegionRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryPortRegionRemoteModel, syncVersion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDmHistoryPortRegionRemoteModel() {
		return _dmHistoryPortRegionRemoteModel;
	}

	public void setDmHistoryPortRegionRemoteModel(
		BaseModel<?> dmHistoryPortRegionRemoteModel) {
		_dmHistoryPortRegionRemoteModel = dmHistoryPortRegionRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _dmHistoryPortRegionRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_dmHistoryPortRegionRemoteModel,
	...
	public DmHistoryPortRegion toEscapedModel() {
		return (DmHistoryPortRegion)ProxyUtil.newProxyInstance(DmHistoryPortRegion.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DmHistoryPortRegionClp)) {
			return false;
		}

		DmHistoryPortRegionClp dmHistoryPortRegion = (DmHistoryPortRegionClp)obj;
	...
	private BaseModel<?> _dmHistoryPortRegionRemoteModel;
