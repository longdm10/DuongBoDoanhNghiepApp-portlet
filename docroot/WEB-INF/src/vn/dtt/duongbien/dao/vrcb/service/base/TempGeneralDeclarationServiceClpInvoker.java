 ...
 * @generated
 */
public class TempGeneralDeclarationServiceClpInvoker {
	public TempGeneralDeclarationServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempGeneralDeclarationServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempGeneralDeclarationServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
