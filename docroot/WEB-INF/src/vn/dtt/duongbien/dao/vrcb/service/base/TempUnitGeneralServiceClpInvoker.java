 ...
 * @generated
 */
public class TempUnitGeneralServiceClpInvoker {
	public TempUnitGeneralServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempUnitGeneralServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempUnitGeneralServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
