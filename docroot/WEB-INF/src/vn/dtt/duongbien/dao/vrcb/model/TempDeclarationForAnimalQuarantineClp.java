...
public class TempDeclarationForAnimalQuarantineClp extends BaseModelImpl<TempDeclarationForAnimalQuarantine>
	...
	public void setId(long id) {
		...
		if (_tempDeclarationForAnimalQuarantineRemoteModel != null) {
			try {
				Class<?> clazz = _tempDeclarationForAnimalQuarantineRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_tempDeclarationForAnimalQuarantineRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setRequestCode(String requestCode) {
		...
		if (_tempDeclarationForAnimalQuarantineRemoteModel != null) {
			try {
				...
				method.invoke(_tempDeclarationForAnimalQuarantineRemoteModel,
					requestCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
	...
	public BaseModel<?> getTempDeclarationForAnimalQuarantineRemoteModel() {
		return _tempDeclarationForAnimalQuarantineRemoteModel;
	}

	public void setTempDeclarationForAnimalQuarantineRemoteModel(
		BaseModel<?> tempDeclarationForAnimalQuarantineRemoteModel) {
		_tempDeclarationForAnimalQuarantineRemoteModel = tempDeclarationForAnimalQuarantineRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _tempDeclarationForAnimalQuarantineRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_tempDeclarationForAnimalQuarantineRemoteModel,
	...
	public TempDeclarationForAnimalQuarantine toEscapedModel() {
		return (TempDeclarationForAnimalQuarantine)ProxyUtil.newProxyInstance(TempDeclarationForAnimalQuarantine.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TempDeclarationForAnimalQuarantineClp)) {
			return false;
		}

		TempDeclarationForAnimalQuarantineClp tempDeclarationForAnimalQuarantine =
			(TempDeclarationForAnimalQuarantineClp)obj;
