...
import vn.dtt.duongbien.dao.vrcb.service.DmPortLocalService;
...
/**
 * Provides the base implementation for the dm port local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.DmPortLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 ...
 * @generated
 */
public abstract class DmPortLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DmPortLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.DmPortLocalServiceUtil} to access the dm port local service.
	 */
	...
	public DmPort addDmPort(DmPort dmPort) throws SystemException {
		...
		return dmPortPersistence.update(dmPort);
	}
	...
	@Override
	public DmPort deleteDmPort(int id) throws PortalException, SystemException {
		return dmPortPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DmPort deleteDmPort(DmPort dmPort) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DmPort.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return dmPortPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.DmPort",
			dmPortLocalService);
	}
	...
	private DmPortLocalServiceClpInvoker _clpInvoker = new DmPortLocalServiceClpInvoker();
}