...
public class TempDeclarationForPlantQuarantineClp extends BaseModelImpl<TempDeclarationForPlantQuarantine>
	...
	public void setId(long id) {
		...
		if (_tempDeclarationForPlantQuarantineRemoteModel != null) {
			try {
				Class<?> clazz = _tempDeclarationForPlantQuarantineRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_tempDeclarationForPlantQuarantineRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setRequestCode(String requestCode) {
		...
		if (_tempDeclarationForPlantQuarantineRemoteModel != null) {
			try {
				...
				method.invoke(_tempDeclarationForPlantQuarantineRemoteModel,
					requestCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
	...
	public BaseModel<?> getTempDeclarationForPlantQuarantineRemoteModel() {
		return _tempDeclarationForPlantQuarantineRemoteModel;
	}

	public void setTempDeclarationForPlantQuarantineRemoteModel(
		BaseModel<?> tempDeclarationForPlantQuarantineRemoteModel) {
		_tempDeclarationForPlantQuarantineRemoteModel = tempDeclarationForPlantQuarantineRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _tempDeclarationForPlantQuarantineRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_tempDeclarationForPlantQuarantineRemoteModel,
	...
	public TempDeclarationForPlantQuarantine toEscapedModel() {
		return (TempDeclarationForPlantQuarantine)ProxyUtil.newProxyInstance(TempDeclarationForPlantQuarantine.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TempDeclarationForPlantQuarantineClp)) {
			return false;
		}

		TempDeclarationForPlantQuarantineClp tempDeclarationForPlantQuarantine = (TempDeclarationForPlantQuarantineClp)obj;
