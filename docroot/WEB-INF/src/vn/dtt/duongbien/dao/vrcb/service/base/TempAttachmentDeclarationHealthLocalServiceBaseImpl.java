...
import vn.dtt.duongbien.dao.vrcb.service.TempAttachmentDeclarationHealthLocalService;
...
/**
 * Provides the base implementation for the temp attachment declaration health local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempAttachmentDeclarationHealthLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempAttachmentDeclarationHealthLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.TempAttachmentDeclarationHealthLocalServiceUtil
 * @generated
 */
public abstract class TempAttachmentDeclarationHealthLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempAttachmentDeclarationHealthLocalServiceUtil} to access the temp attachment declaration health local service.
	 */
	...
	public TempAttachmentDeclarationHealth addTempAttachmentDeclarationHealth(
		...
		return tempAttachmentDeclarationHealthPersistence.update(tempAttachmentDeclarationHealth);
	}
	...
	@Override
	public TempAttachmentDeclarationHealth deleteTempAttachmentDeclarationHealth(
		long id) throws PortalException, SystemException {
		return tempAttachmentDeclarationHealthPersistence.remove(id);
	}
	...
	public TempAttachmentDeclarationHealth deleteTempAttachmentDeclarationHealth(
		TempAttachmentDeclarationHealth tempAttachmentDeclarationHealth)
		throws SystemException {
		return tempAttachmentDeclarationHealthPersistence.remove(tempAttachmentDeclarationHealth);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempAttachmentDeclarationHealth.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempAttachmentDeclarationHealth",
	...
	private TempAttachmentDeclarationHealthLocalServiceClpInvoker _clpInvoker = new TempAttachmentDeclarationHealthLocalServiceClpInvoker();
}