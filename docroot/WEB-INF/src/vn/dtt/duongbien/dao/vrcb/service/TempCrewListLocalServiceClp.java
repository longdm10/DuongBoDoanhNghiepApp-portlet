...
public class TempCrewListLocalServiceClp implements TempCrewListLocalService {
	public TempCrewListLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.TempCrewList addTempCrewList(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(tempCrewList) });
		}
		catch (Throwable t) {
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.TempCrewList> getTempCrewLists(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.TempCrewList>)ClpSerializer.translateOutput(returnObj);
	}
