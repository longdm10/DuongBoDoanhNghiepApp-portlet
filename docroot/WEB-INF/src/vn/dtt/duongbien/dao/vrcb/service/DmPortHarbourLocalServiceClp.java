...
public class DmPortHarbourLocalServiceClp implements DmPortHarbourLocalService {
	public DmPortHarbourLocalServiceClp(
		...
		_methodName19 = "getDmPortHarbour";

		_methodParameterTypes19 = new String[] {  };

		_methodName20 = "findByPortHarbourCode";
	...
	public vn.dtt.duongbien.dao.vrcb.model.DmPortHarbour addDmPortHarbour(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dmPortHarbour) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.DmPortHarbour)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmPortHarbour> getDmPortHarbours(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmPortHarbour>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List findByPortHarbourCode(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					new Object[] { ClpSerializer.translateInput(portHarbourCode) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
