...
public class DmGoodsLocalServiceClp implements DmGoodsLocalService {
	public DmGoodsLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public vn.dtt.duongbien.dao.vrcb.model.DmGoods addDmGoods(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dmGoods) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.DmGoods)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmGoods> getDmGoodses(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmGoods>)ClpSerializer.translateOutput(returnObj);
	}
