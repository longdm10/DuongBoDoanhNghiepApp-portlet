...
import vn.dtt.duongbien.dao.vrcb.service.TempDeclarationForPlantQuarantineLocalService;
...
/**
 * Provides the base implementation for the temp declaration for plant quarantine local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempDeclarationForPlantQuarantineLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempDeclarationForPlantQuarantineLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.TempDeclarationForPlantQuarantineLocalServiceUtil
 * @generated
 */
public abstract class TempDeclarationForPlantQuarantineLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempDeclarationForPlantQuarantineLocalServiceUtil} to access the temp declaration for plant quarantine local service.
	 */
	...
	public TempDeclarationForPlantQuarantine addTempDeclarationForPlantQuarantine(
		...
		return tempDeclarationForPlantQuarantinePersistence.update(tempDeclarationForPlantQuarantine);
	}
	...
	@Override
	public TempDeclarationForPlantQuarantine deleteTempDeclarationForPlantQuarantine(
		long id) throws PortalException, SystemException {
		return tempDeclarationForPlantQuarantinePersistence.remove(id);
	}
	...
	public TempDeclarationForPlantQuarantine deleteTempDeclarationForPlantQuarantine(
		TempDeclarationForPlantQuarantine tempDeclarationForPlantQuarantine)
		throws SystemException {
		return tempDeclarationForPlantQuarantinePersistence.remove(tempDeclarationForPlantQuarantine);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempDeclarationForPlantQuarantine.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempDeclarationForPlantQuarantine",
	...
	private TempDeclarationForPlantQuarantineLocalServiceClpInvoker _clpInvoker = new TempDeclarationForPlantQuarantineLocalServiceClpInvoker();
}