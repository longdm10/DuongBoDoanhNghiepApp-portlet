...
import vn.dtt.duongbien.dao.vrcb.model.ResultDeclarationModel;
import vn.dtt.duongbien.dao.vrcb.model.ResultDeclarationSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.dtt.duongbien.dao.vrcb.model.ResultDeclarationModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ResultDeclarationImpl}.
 * </p>
 *
 * @author longdm
 * @see ResultDeclarationImpl
 * @see vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration
 * @see vn.dtt.duongbien.dao.vrcb.model.ResultDeclarationModel
 * @generated
 */
@JSON(strict = true)
public class ResultDeclarationModelImpl extends BaseModelImpl<ResultDeclaration>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a result declaration model instance should use the {@link vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration"));
	...
	public ResultDeclaration toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (ResultDeclaration)ProxyUtil.newProxyInstance(_classLoader,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ResultDeclaration)) {
			return false;
		}

		ResultDeclaration resultDeclaration = (ResultDeclaration)obj;
	...
	private ResultDeclaration _escapedModel;
}