 ...
 * @generated
 */
public class IssuePermissionForTransitServiceClpInvoker {
	public IssuePermissionForTransitServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return IssuePermissionForTransitServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			IssuePermissionForTransitServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
