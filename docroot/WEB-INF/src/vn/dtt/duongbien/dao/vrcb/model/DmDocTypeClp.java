...
public class DmDocTypeClp extends BaseModelImpl<DmDocType> implements DmDocType {
	...
	public void setId(int id) {
		...
		if (_dmDocTypeRemoteModel != null) {
			try {
				Class<?> clazz = _dmDocTypeRemoteModel.getClass();

				Method method = clazz.getMethod("setId", int.class);

				method.invoke(_dmDocTypeRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setDocumentTypeCode(String documentTypeCode) {
		...
		if (_dmDocTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmDocTypeRemoteModel, documentTypeCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDocumentType(String documentType) {
		...
		if (_dmDocTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmDocTypeRemoteModel, documentType);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDocumentTypeName(String documentTypeName) {
		...
		if (_dmDocTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmDocTypeRemoteModel, documentTypeName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsDelete(int isDelete) {
		...
		if (_dmDocTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmDocTypeRemoteModel, isDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMarkedAsDelete(int markedAsDelete) {
		...
		if (_dmDocTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmDocTypeRemoteModel, markedAsDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_dmDocTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmDocTypeRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setRequestedDate(Date requestedDate) {
		...
		if (_dmDocTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmDocTypeRemoteModel, requestedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSyncVersion(String syncVersion) {
		...
		if (_dmDocTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmDocTypeRemoteModel, syncVersion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDmDocTypeRemoteModel() {
		return _dmDocTypeRemoteModel;
	}

	public void setDmDocTypeRemoteModel(BaseModel<?> dmDocTypeRemoteModel) {
		_dmDocTypeRemoteModel = dmDocTypeRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _dmDocTypeRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_dmDocTypeRemoteModel,
	...
	public DmDocType toEscapedModel() {
		return (DmDocType)ProxyUtil.newProxyInstance(DmDocType.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DmDocTypeClp)) {
			return false;
		}

		DmDocTypeClp dmDocType = (DmDocTypeClp)obj;
	...
	public String toXmlString() {
		...
		sb.append("vn.dtt.duongbien.dao.vrcb.model.DmDocType");
