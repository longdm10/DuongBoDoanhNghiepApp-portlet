...
public class ResponseBoLocalServiceClp implements ResponseBoLocalService {
	public ResponseBoLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.ResponseBo addResponseBo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(responseBo) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.ResponseBo)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.ResponseBo> getResponseBos(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.ResponseBo>)ClpSerializer.translateOutput(returnObj);
	}
