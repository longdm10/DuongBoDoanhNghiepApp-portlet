...
import vn.dtt.duongbien.dao.vrcb.service.TempPlantQuarantineLocalService;
...
/**
 * Provides the base implementation for the temp plant quarantine local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempPlantQuarantineLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempPlantQuarantineLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.TempPlantQuarantineLocalServiceUtil
 * @generated
 */
public abstract class TempPlantQuarantineLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempPlantQuarantineLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempPlantQuarantineLocalServiceUtil} to access the temp plant quarantine local service.
	 */
	...
	public TempPlantQuarantine addTempPlantQuarantine(
		...
		return tempPlantQuarantinePersistence.update(tempPlantQuarantine);
	}
	...
	@Override
	public TempPlantQuarantine deleteTempPlantQuarantine(long id)
		throws PortalException, SystemException {
		return tempPlantQuarantinePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempPlantQuarantine deleteTempPlantQuarantine(
		TempPlantQuarantine tempPlantQuarantine) throws SystemException {
		return tempPlantQuarantinePersistence.remove(tempPlantQuarantine);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempPlantQuarantine.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempPlantQuarantine",
	...
	private TempPlantQuarantineLocalServiceClpInvoker _clpInvoker = new TempPlantQuarantineLocalServiceClpInvoker();
}