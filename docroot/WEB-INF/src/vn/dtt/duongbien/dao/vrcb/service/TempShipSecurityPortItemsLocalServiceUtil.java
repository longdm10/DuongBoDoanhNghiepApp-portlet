...
/**
 * Provides the local service utility for TempShipSecurityPortItems. This utility wraps
 * {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempShipSecurityPortItemsLocalServiceImpl} and is the
 ...
 * @see vn.dtt.duongbien.dao.vrcb.service.base.TempShipSecurityPortItemsLocalServiceBaseImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempShipSecurityPortItemsLocalServiceImpl
 * @generated
 */
public class TempShipSecurityPortItemsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempShipSecurityPortItemsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems addTempShipSecurityPortItems(
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems createTempShipSecurityPortItems(
		long id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems deleteTempShipSecurityPortItems(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTempShipSecurityPortItems(id);
	}
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems deleteTempShipSecurityPortItems(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .deleteTempShipSecurityPortItems(tempShipSecurityPortItems);
	}
	...
	*/
	...
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems fetchTempShipSecurityPortItems(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems getTempShipSecurityPortItems(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems> getTempShipSecurityPortItemses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems updateTempShipSecurityPortItems(
		vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems tempShipSecurityPortItems)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
	...
	*/
	...
	public static TempShipSecurityPortItemsLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof TempShipSecurityPortItemsLocalService) {
				_service = (TempShipSecurityPortItemsLocalService)invokableLocalService;
			}
			else {
				_service = new TempShipSecurityPortItemsLocalServiceClp(invokableLocalService);
			}
