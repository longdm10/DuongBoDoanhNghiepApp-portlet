 ...
 * @generated
 */
public class TempShipStoresItemsServiceClpInvoker {
	public TempShipStoresItemsServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempShipStoresItemsServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempShipStoresItemsServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
