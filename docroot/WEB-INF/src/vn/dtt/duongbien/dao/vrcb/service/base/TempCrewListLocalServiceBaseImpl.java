...
import vn.dtt.duongbien.dao.vrcb.service.TempCrewListLocalService;
...
/**
 * Provides the base implementation for the temp crew list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempCrewListLocalServiceImpl}.
 * </p>
 *
 * @author longdm
...
public abstract class TempCrewListLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempCrewListLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempCrewListLocalServiceUtil} to access the temp crew list local service.
	 */
	...
	public TempCrewList addTempCrewList(TempCrewList tempCrewList)
		...
		return tempCrewListPersistence.update(tempCrewList);
	}
	...
	@Override
	public TempCrewList deleteTempCrewList(long id)
		throws PortalException, SystemException {
		return tempCrewListPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempCrewList deleteTempCrewList(TempCrewList tempCrewList)
		throws SystemException {
		return tempCrewListPersistence.remove(tempCrewList);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempCrewList.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempCrewList",
	...
	private TempCrewListLocalServiceClpInvoker _clpInvoker = new TempCrewListLocalServiceClpInvoker();
}