...
public class ResultMinistryLocalServiceClp implements ResultMinistryLocalService {
	public ResultMinistryLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.ResultMinistry addResultMinistry(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(resultMinistry) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.ResultMinistry)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.ResultMinistry> getResultMinistries(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.ResultMinistry>)ClpSerializer.translateOutput(returnObj);
	}
