...
/**
 * Provides the local service utility for DmHistoryDocType. This utility wraps
 * {@link vn.dtt.duongbien.dao.vrcb.service.impl.DmHistoryDocTypeLocalServiceImpl} and is the
 ...
 * @see vn.dtt.duongbien.dao.vrcb.service.base.DmHistoryDocTypeLocalServiceBaseImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.DmHistoryDocTypeLocalServiceImpl
 * @generated
 */
public class DmHistoryDocTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.duongbien.dao.vrcb.service.impl.DmHistoryDocTypeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType addDmHistoryDocType(
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType createDmHistoryDocType(
		int id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType deleteDmHistoryDocType(
		int id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteDmHistoryDocType(id);
	}
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType deleteDmHistoryDocType(
		vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType dmHistoryDocType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteDmHistoryDocType(dmHistoryDocType);
	}
	...
	*/
	...
	public static vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType fetchDmHistoryDocType(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType getDmHistoryDocType(
		int id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType> getDmHistoryDocTypes(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType updateDmHistoryDocType(
		vn.dtt.duongbien.dao.vrcb.model.DmHistoryDocType dmHistoryDocType)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static DmHistoryDocTypeLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof DmHistoryDocTypeLocalService) {
				_service = (DmHistoryDocTypeLocalService)invokableLocalService;
			}
			else {
				_service = new DmHistoryDocTypeLocalServiceClp(invokableLocalService);
			}
