...
public class DmHistoryStateLocalServiceClp implements DmHistoryStateLocalService {
	public DmHistoryStateLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.DmHistoryState addDmHistoryState(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dmHistoryState) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.DmHistoryState)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmHistoryState> getDmHistoryStates(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmHistoryState>)ClpSerializer.translateOutput(returnObj);
	}
