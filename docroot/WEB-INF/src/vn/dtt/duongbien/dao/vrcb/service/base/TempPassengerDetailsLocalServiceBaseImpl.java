...
import vn.dtt.duongbien.dao.vrcb.service.TempPassengerDetailsLocalService;
...
/**
 * Provides the base implementation for the temp passenger details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempPassengerDetailsLocalServiceImpl}.
 * </p>
 *
 * @author longdm
...
public abstract class TempPassengerDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempPassengerDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempPassengerDetailsLocalServiceUtil} to access the temp passenger details local service.
	 */
	...
	public TempPassengerDetails addTempPassengerDetails(
		...
		return tempPassengerDetailsPersistence.update(tempPassengerDetails);
	}
	...
	@Override
	public TempPassengerDetails deleteTempPassengerDetails(long id)
		throws PortalException, SystemException {
		return tempPassengerDetailsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempPassengerDetails deleteTempPassengerDetails(
		TempPassengerDetails tempPassengerDetails) throws SystemException {
		return tempPassengerDetailsPersistence.remove(tempPassengerDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempPassengerDetails.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempPassengerDetails",
	...
	private TempPassengerDetailsLocalServiceClpInvoker _clpInvoker = new TempPassengerDetailsLocalServiceClpInvoker();
}