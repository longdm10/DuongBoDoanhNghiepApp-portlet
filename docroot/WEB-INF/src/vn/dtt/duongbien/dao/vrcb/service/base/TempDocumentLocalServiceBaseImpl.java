...
import vn.dtt.duongbien.dao.vrcb.service.TempDocumentLocalService;
...
/**
 * Provides the base implementation for the temp document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempDocumentLocalServiceImpl}.
 * </p>
 *
 * @author longdm
...
public abstract class TempDocumentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempDocumentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempDocumentLocalServiceUtil} to access the temp document local service.
	 */
	...
	public TempDocument addTempDocument(TempDocument tempDocument)
		...
		return tempDocumentPersistence.update(tempDocument);
	}
	...
	@Override
	public TempDocument deleteTempDocument(long id)
		throws PortalException, SystemException {
		return tempDocumentPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempDocument deleteTempDocument(TempDocument tempDocument)
		throws SystemException {
		return tempDocumentPersistence.remove(tempDocument);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempDocument.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempDocument",
	...
	private TempDocumentLocalServiceClpInvoker _clpInvoker = new TempDocumentLocalServiceClpInvoker();
}