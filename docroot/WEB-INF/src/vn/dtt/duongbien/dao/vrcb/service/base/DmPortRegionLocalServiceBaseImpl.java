...
import vn.dtt.duongbien.dao.vrcb.service.DmPortRegionLocalService;
...
/**
 * Provides the base implementation for the dm port region local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.DmPortRegionLocalServiceImpl}.
 * </p>
 *
 * @author longdm
...
public abstract class DmPortRegionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DmPortRegionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.DmPortRegionLocalServiceUtil} to access the dm port region local service.
	 */
	...
	public DmPortRegion addDmPortRegion(DmPortRegion dmPortRegion)
		...
		return dmPortRegionPersistence.update(dmPortRegion);
	}
	...
	@Override
	public DmPortRegion deleteDmPortRegion(int id)
		throws PortalException, SystemException {
		return dmPortRegionPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DmPortRegion deleteDmPortRegion(DmPortRegion dmPortRegion)
		throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DmPortRegion.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.DmPortRegion",
	...
	private DmPortRegionLocalServiceClpInvoker _clpInvoker = new DmPortRegionLocalServiceClpInvoker();
}