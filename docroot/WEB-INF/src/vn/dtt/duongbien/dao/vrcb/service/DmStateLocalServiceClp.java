...
public class DmStateLocalServiceClp implements DmStateLocalService {
	public DmStateLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public vn.dtt.duongbien.dao.vrcb.model.DmState addDmState(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dmState) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.DmState)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmState> getDmStates(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmState>)ClpSerializer.translateOutput(returnObj);
	}
