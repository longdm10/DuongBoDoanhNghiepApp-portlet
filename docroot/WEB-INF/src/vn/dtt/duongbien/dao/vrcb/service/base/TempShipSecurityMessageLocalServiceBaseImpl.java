...
import vn.dtt.duongbien.dao.vrcb.service.TempShipSecurityMessageLocalService;
...
/**
 * Provides the base implementation for the temp ship security message local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempShipSecurityMessageLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempShipSecurityMessageLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.TempShipSecurityMessageLocalServiceUtil
 * @generated
 */
public abstract class TempShipSecurityMessageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempShipSecurityMessageLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempShipSecurityMessageLocalServiceUtil} to access the temp ship security message local service.
	 */
	...
	public TempShipSecurityMessage addTempShipSecurityMessage(
		...
		return tempShipSecurityMessagePersistence.update(tempShipSecurityMessage);
	}
	...
	@Override
	public TempShipSecurityMessage deleteTempShipSecurityMessage(long id)
		throws PortalException, SystemException {
		return tempShipSecurityMessagePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempShipSecurityMessage deleteTempShipSecurityMessage(
		TempShipSecurityMessage tempShipSecurityMessage)
		throws SystemException {
		return tempShipSecurityMessagePersistence.remove(tempShipSecurityMessage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempShipSecurityMessage.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityMessage",
	...
	private TempShipSecurityMessageLocalServiceClpInvoker _clpInvoker = new TempShipSecurityMessageLocalServiceClpInvoker();
}