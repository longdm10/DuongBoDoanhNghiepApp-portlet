...
/**
 * Provides the local service utility for TempCrewEffectsItems. This utility wraps
 * {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempCrewEffectsItemsLocalServiceImpl} and is the
 ...
 * @see vn.dtt.duongbien.dao.vrcb.service.base.TempCrewEffectsItemsLocalServiceBaseImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempCrewEffectsItemsLocalServiceImpl
 * @generated
 */
public class TempCrewEffectsItemsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempCrewEffectsItemsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems addTempCrewEffectsItems(
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems createTempCrewEffectsItems(
		long id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems deleteTempCrewEffectsItems(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTempCrewEffectsItems(id);
	}
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems deleteTempCrewEffectsItems(
		vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems tempCrewEffectsItems)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTempCrewEffectsItems(tempCrewEffectsItems);
	}
	...
	*/
	...
	public static vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems fetchTempCrewEffectsItems(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems getTempCrewEffectsItems(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems> getTempCrewEffectsItemses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems updateTempCrewEffectsItems(
		vn.dtt.duongbien.dao.vrcb.model.TempCrewEffectsItems tempCrewEffectsItems)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static TempCrewEffectsItemsLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof TempCrewEffectsItemsLocalService) {
				_service = (TempCrewEffectsItemsLocalService)invokableLocalService;
			}
			else {
				_service = new TempCrewEffectsItemsLocalServiceClp(invokableLocalService);
			}
