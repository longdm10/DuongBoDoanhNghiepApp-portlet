...
public class UserPortLocalServiceClp implements UserPortLocalService {
	public UserPortLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public vn.dtt.duongbien.dao.vrcb.model.UserPort addUserPort(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(userPort) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.UserPort)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.UserPort> getUserPorts(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.UserPort>)ClpSerializer.translateOutput(returnObj);
	}
