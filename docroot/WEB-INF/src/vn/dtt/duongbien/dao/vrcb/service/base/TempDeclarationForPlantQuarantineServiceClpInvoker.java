 ...
 * @generated
 */
public class TempDeclarationForPlantQuarantineServiceClpInvoker {
	public TempDeclarationForPlantQuarantineServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempDeclarationForPlantQuarantineServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempDeclarationForPlantQuarantineServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
