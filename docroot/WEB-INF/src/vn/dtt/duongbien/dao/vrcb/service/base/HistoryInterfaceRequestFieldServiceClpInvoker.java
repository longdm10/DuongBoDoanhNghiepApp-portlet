 ...
 * @generated
 */
public class HistoryInterfaceRequestFieldServiceClpInvoker {
	public HistoryInterfaceRequestFieldServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return HistoryInterfaceRequestFieldServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			HistoryInterfaceRequestFieldServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
