...
/**
 * Provides the local service utility for TempHealthQuestion. This utility wraps
 * {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempHealthQuestionLocalServiceImpl} and is the
 ...
 * @see vn.dtt.duongbien.dao.vrcb.service.base.TempHealthQuestionLocalServiceBaseImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempHealthQuestionLocalServiceImpl
 * @generated
 */
public class TempHealthQuestionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempHealthQuestionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion addTempHealthQuestion(
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion createTempHealthQuestion(
		long id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion deleteTempHealthQuestion(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTempHealthQuestion(id);
	}
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion deleteTempHealthQuestion(
		vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion tempHealthQuestion)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTempHealthQuestion(tempHealthQuestion);
	}
	...
	*/
	...
	public static vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion fetchTempHealthQuestion(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion getTempHealthQuestion(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion> getTempHealthQuestions(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion updateTempHealthQuestion(
		vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion tempHealthQuestion)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static TempHealthQuestionLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof TempHealthQuestionLocalService) {
				_service = (TempHealthQuestionLocalService)invokableLocalService;
			}
			else {
				_service = new TempHealthQuestionLocalServiceClp(invokableLocalService);
			}
