...
public class PassengerListLocalServiceClp implements PassengerListLocalService {
	public PassengerListLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.PassengerList addPassengerList(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(passengerList) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.PassengerList)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.PassengerList> getPassengerLists(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.PassengerList>)ClpSerializer.translateOutput(returnObj);
	}
