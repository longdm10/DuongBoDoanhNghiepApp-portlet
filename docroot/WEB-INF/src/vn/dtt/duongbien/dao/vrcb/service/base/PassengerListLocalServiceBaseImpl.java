...
import vn.dtt.duongbien.dao.vrcb.service.PassengerListLocalService;
...
/**
 * Provides the base implementation for the passenger list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.PassengerListLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.PassengerListLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.PassengerListLocalServiceUtil
 * @generated
 */
public abstract class PassengerListLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PassengerListLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.PassengerListLocalServiceUtil} to access the passenger list local service.
	 */
	...
	public PassengerList addPassengerList(PassengerList passengerList)
		...
		return passengerListPersistence.update(passengerList);
	}
	...
	@Override
	public PassengerList deletePassengerList(long id)
		throws PortalException, SystemException {
		return passengerListPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PassengerList deletePassengerList(PassengerList passengerList)
		throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PassengerList.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.PassengerList",
	...
	private PassengerListLocalServiceClpInvoker _clpInvoker = new PassengerListLocalServiceClpInvoker();
}