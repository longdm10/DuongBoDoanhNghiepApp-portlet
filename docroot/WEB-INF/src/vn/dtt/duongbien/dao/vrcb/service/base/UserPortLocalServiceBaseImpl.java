...
import vn.dtt.duongbien.dao.vrcb.service.UserPortLocalService;
...
/**
 * Provides the base implementation for the user port local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.UserPortLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.UserPortLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.UserPortLocalServiceUtil
 * @generated
 */
public abstract class UserPortLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UserPortLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.UserPortLocalServiceUtil} to access the user port local service.
	 */
	...
	public UserPort addUserPort(UserPort userPort) throws SystemException {
		...
		return userPortPersistence.update(userPort);
	}
	...
	@Override
	public UserPort deleteUserPort(long id)
		throws PortalException, SystemException {
		return userPortPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserPort deleteUserPort(UserPort userPort) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserPort.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.UserPort",
	...
	private UserPortLocalServiceClpInvoker _clpInvoker = new UserPortLocalServiceClpInvoker();
}