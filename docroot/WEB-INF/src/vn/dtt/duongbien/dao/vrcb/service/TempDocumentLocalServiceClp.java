...
public class TempDocumentLocalServiceClp implements TempDocumentLocalService {
	public TempDocumentLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.TempDocument addTempDocument(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(tempDocument) });
		}
		catch (Throwable t) {
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.TempDocument> getTempDocuments(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.TempDocument>)ClpSerializer.translateOutput(returnObj);
	}
