...
public class DmGtVersionLocalServiceClp implements DmGtVersionLocalService {
	public DmGtVersionLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.DmGtVersion addDmGtVersion(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dmGtVersion) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.DmGtVersion)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmGtVersion> getDmGtVersions(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmGtVersion>)ClpSerializer.translateOutput(returnObj);
	}
