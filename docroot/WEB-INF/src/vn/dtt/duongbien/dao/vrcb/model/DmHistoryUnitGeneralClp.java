...
public class DmHistoryUnitGeneralClp extends BaseModelImpl<DmHistoryUnitGeneral>
	...
	public void setId(int id) {
		...
		if (_dmHistoryUnitGeneralRemoteModel != null) {
			try {
				Class<?> clazz = _dmHistoryUnitGeneralRemoteModel.getClass();

				Method method = clazz.getMethod("setId", int.class);

				method.invoke(_dmHistoryUnitGeneralRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setUnitCode(String unitCode) {
		...
		if (_dmHistoryUnitGeneralRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryUnitGeneralRemoteModel, unitCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setUnitName(String unitName) {
		...
		if (_dmHistoryUnitGeneralRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryUnitGeneralRemoteModel, unitName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsDelete(int isDelete) {
		...
		if (_dmHistoryUnitGeneralRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryUnitGeneralRemoteModel, isDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMarkedAsDelete(int markedAsDelete) {
		...
		if (_dmHistoryUnitGeneralRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryUnitGeneralRemoteModel, markedAsDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_dmHistoryUnitGeneralRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryUnitGeneralRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setRequestedDate(Date requestedDate) {
		...
		if (_dmHistoryUnitGeneralRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryUnitGeneralRemoteModel, requestedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSyncVersion(String syncVersion) {
		...
		if (_dmHistoryUnitGeneralRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryUnitGeneralRemoteModel, syncVersion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDmHistoryUnitGeneralRemoteModel() {
		return _dmHistoryUnitGeneralRemoteModel;
	}

	public void setDmHistoryUnitGeneralRemoteModel(
		BaseModel<?> dmHistoryUnitGeneralRemoteModel) {
		_dmHistoryUnitGeneralRemoteModel = dmHistoryUnitGeneralRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _dmHistoryUnitGeneralRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_dmHistoryUnitGeneralRemoteModel,
	...
	public DmHistoryUnitGeneral toEscapedModel() {
		return (DmHistoryUnitGeneral)ProxyUtil.newProxyInstance(DmHistoryUnitGeneral.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DmHistoryUnitGeneralClp)) {
			return false;
		}

		DmHistoryUnitGeneralClp dmHistoryUnitGeneral = (DmHistoryUnitGeneralClp)obj;
	...
	private BaseModel<?> _dmHistoryUnitGeneralRemoteModel;
}