 ...
 * @generated
 */
public class TempDeclarationForAnimalQuarantineServiceClpInvoker {
	public TempDeclarationForAnimalQuarantineServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempDeclarationForAnimalQuarantineServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempDeclarationForAnimalQuarantineServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
