...
import vn.dtt.duongbien.dao.vrcb.service.TempHealthQuestionLocalService;
...
/**
 * Provides the base implementation for the temp health question local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempHealthQuestionLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempHealthQuestionLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.TempHealthQuestionLocalServiceUtil
 * @generated
 */
public abstract class TempHealthQuestionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempHealthQuestionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempHealthQuestionLocalServiceUtil} to access the temp health question local service.
	 */
	...
	public TempHealthQuestion addTempHealthQuestion(
		...
		return tempHealthQuestionPersistence.update(tempHealthQuestion);
	}
	...
	@Override
	public TempHealthQuestion deleteTempHealthQuestion(long id)
		throws PortalException, SystemException {
		return tempHealthQuestionPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempHealthQuestion deleteTempHealthQuestion(
		TempHealthQuestion tempHealthQuestion) throws SystemException {
		return tempHealthQuestionPersistence.remove(tempHealthQuestion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempHealthQuestion.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempHealthQuestion",
	...
	private TempHealthQuestionLocalServiceClpInvoker _clpInvoker = new TempHealthQuestionLocalServiceClpInvoker();
}