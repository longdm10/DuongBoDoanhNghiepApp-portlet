 ...
 * @generated
 */
public class TempHealthCrewPassengerListServiceClpInvoker {
	public TempHealthCrewPassengerListServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempHealthCrewPassengerListServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempHealthCrewPassengerListServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
