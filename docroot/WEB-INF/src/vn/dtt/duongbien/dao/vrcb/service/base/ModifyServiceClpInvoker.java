 ...
 * @generated
 */
public class ModifyServiceClpInvoker {
	public ModifyServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return ModifyServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			ModifyServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
