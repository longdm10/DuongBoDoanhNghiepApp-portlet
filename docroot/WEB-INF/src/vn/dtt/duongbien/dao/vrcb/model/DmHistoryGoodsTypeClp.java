...
public class DmHistoryGoodsTypeClp extends BaseModelImpl<DmHistoryGoodsType>
	...
	public void setId(int id) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				Class<?> clazz = _dmHistoryGoodsTypeRemoteModel.getClass();

				Method method = clazz.getMethod("setId", int.class);

				method.invoke(_dmHistoryGoodsTypeRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setGoodsTypeCode(String goodsTypeCode) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryGoodsTypeRemoteModel, goodsTypeCode);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setGoodsTypeName(String goodsTypeName) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryGoodsTypeRemoteModel, goodsTypeName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setGoodsTypeNameVN(String goodsTypeNameVN) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryGoodsTypeRemoteModel, goodsTypeNameVN);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setGoodsTypeOrder(int goodsTypeOrder) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryGoodsTypeRemoteModel, goodsTypeOrder);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsDelete(int isDelete) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryGoodsTypeRemoteModel, isDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMarkedAsDelete(int markedAsDelete) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryGoodsTypeRemoteModel, markedAsDelete);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setModifiedDate(Date modifiedDate) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryGoodsTypeRemoteModel, modifiedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setRequestedDate(Date requestedDate) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryGoodsTypeRemoteModel, requestedDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSyncVersion(String syncVersion) {
		...
		if (_dmHistoryGoodsTypeRemoteModel != null) {
			try {
				...
				method.invoke(_dmHistoryGoodsTypeRemoteModel, syncVersion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getDmHistoryGoodsTypeRemoteModel() {
		return _dmHistoryGoodsTypeRemoteModel;
	}

	public void setDmHistoryGoodsTypeRemoteModel(
		BaseModel<?> dmHistoryGoodsTypeRemoteModel) {
		_dmHistoryGoodsTypeRemoteModel = dmHistoryGoodsTypeRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _dmHistoryGoodsTypeRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_dmHistoryGoodsTypeRemoteModel,
	...
	public DmHistoryGoodsType toEscapedModel() {
		return (DmHistoryGoodsType)ProxyUtil.newProxyInstance(DmHistoryGoodsType.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DmHistoryGoodsTypeClp)) {
			return false;
		}

		DmHistoryGoodsTypeClp dmHistoryGoodsType = (DmHistoryGoodsTypeClp)obj;
	...
	public String toXmlString() {
		...
		sb.append("vn.dtt.duongbien.dao.vrcb.model.DmHistoryGoodsType");
	...
	private BaseModel<?> _dmHistoryGoodsTypeRemoteModel;
