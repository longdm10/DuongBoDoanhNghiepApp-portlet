...
/**
 * Provides the local service utility for TempShipStoresDeclaration. This utility wraps
 * {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempShipStoresDeclarationLocalServiceImpl} and is the
 ...
 * @see vn.dtt.duongbien.dao.vrcb.service.base.TempShipStoresDeclarationLocalServiceBaseImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempShipStoresDeclarationLocalServiceImpl
 * @generated
 */
public class TempShipStoresDeclarationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempShipStoresDeclarationLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipStoresDeclaration addTempShipStoresDeclaration(
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipStoresDeclaration createTempShipStoresDeclaration(
		long id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipStoresDeclaration deleteTempShipStoresDeclaration(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTempShipStoresDeclaration(id);
	}
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipStoresDeclaration deleteTempShipStoresDeclaration(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .deleteTempShipStoresDeclaration(tempShipStoresDeclaration);
	}
	...
	*/
	...
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipStoresDeclaration fetchTempShipStoresDeclaration(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipStoresDeclaration getTempShipStoresDeclaration(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbien.dao.vrcb.model.TempShipStoresDeclaration> getTempShipStoresDeclarations(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.TempShipStoresDeclaration updateTempShipStoresDeclaration(
		vn.dtt.duongbien.dao.vrcb.model.TempShipStoresDeclaration tempShipStoresDeclaration)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
	...
	*/
	...
	public static TempShipStoresDeclarationLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof TempShipStoresDeclarationLocalService) {
				_service = (TempShipStoresDeclarationLocalService)invokableLocalService;
			}
			else {
				_service = new TempShipStoresDeclarationLocalServiceClp(invokableLocalService);
			}
