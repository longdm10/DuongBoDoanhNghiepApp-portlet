 ...
 * @generated
 */
public class IssueAcceptanceForTransitServiceClpInvoker {
	public IssueAcceptanceForTransitServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return IssueAcceptanceForTransitServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			IssueAcceptanceForTransitServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
