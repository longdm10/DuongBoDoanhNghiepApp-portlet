...
import vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShipModel;
import vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShipSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShipModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link HistoryRmdcShipImpl}.
 * </p>
 *
 * @author longdm
 * @see HistoryRmdcShipImpl
 * @see vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip
 * @see vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShipModel
 * @generated
 */
@JSON(strict = true)
public class HistoryRmdcShipModelImpl extends BaseModelImpl<HistoryRmdcShip>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a history rmdc ship model instance should use the {@link vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.dtt.duongbien.dao.vrcb.model.HistoryRmdcShip"));
	...
	public HistoryRmdcShip toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (HistoryRmdcShip)ProxyUtil.newProxyInstance(_classLoader,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof HistoryRmdcShip)) {
			return false;
		}

		HistoryRmdcShip historyRmdcShip = (HistoryRmdcShip)obj;
	...
	private HistoryRmdcShip _escapedModel;
}