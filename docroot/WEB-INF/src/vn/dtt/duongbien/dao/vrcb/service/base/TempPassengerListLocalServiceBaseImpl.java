...
import vn.dtt.duongbien.dao.vrcb.service.TempPassengerListLocalService;
...
/**
 * Provides the base implementation for the temp passenger list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempPassengerListLocalServiceImpl}.
 * </p>
 *
 * @author longdm
...
public abstract class TempPassengerListLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TempPassengerListLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempPassengerListLocalServiceUtil} to access the temp passenger list local service.
	 */
	...
	public TempPassengerList addTempPassengerList(
		...
		return tempPassengerListPersistence.update(tempPassengerList);
	}
	...
	@Override
	public TempPassengerList deleteTempPassengerList(long id)
		throws PortalException, SystemException {
		return tempPassengerListPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempPassengerList deleteTempPassengerList(
		TempPassengerList tempPassengerList) throws SystemException {
		return tempPassengerListPersistence.remove(tempPassengerList);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempPassengerList.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempPassengerList",
	...
	private TempPassengerListLocalServiceClpInvoker _clpInvoker = new TempPassengerListLocalServiceClpInvoker();
}