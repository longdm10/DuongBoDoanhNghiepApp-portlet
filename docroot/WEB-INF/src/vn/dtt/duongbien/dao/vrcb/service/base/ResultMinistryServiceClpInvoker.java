 ...
 * @generated
 */
public class ResultMinistryServiceClpInvoker {
	public ResultMinistryServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return ResultMinistryServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			ResultMinistryServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
