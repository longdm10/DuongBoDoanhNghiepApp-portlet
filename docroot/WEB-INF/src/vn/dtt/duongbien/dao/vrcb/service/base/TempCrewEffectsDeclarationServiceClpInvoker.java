 ...
 * @generated
 */
public class TempCrewEffectsDeclarationServiceClpInvoker {
	public TempCrewEffectsDeclarationServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempCrewEffectsDeclarationServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempCrewEffectsDeclarationServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
