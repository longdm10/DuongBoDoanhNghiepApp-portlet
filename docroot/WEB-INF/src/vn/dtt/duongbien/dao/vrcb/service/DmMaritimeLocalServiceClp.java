...
public class DmMaritimeLocalServiceClp implements DmMaritimeLocalService {
	public DmMaritimeLocalServiceClp(
	...
	public vn.dtt.duongbien.dao.vrcb.model.DmMaritime addDmMaritime(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dmMaritime) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.DmMaritime)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmMaritime> getDmMaritimes(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.DmMaritime>)ClpSerializer.translateOutput(returnObj);
	}
