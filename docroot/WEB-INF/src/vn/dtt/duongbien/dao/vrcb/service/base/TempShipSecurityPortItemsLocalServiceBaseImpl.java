...
import vn.dtt.duongbien.dao.vrcb.service.TempShipSecurityPortItemsLocalService;
...
/**
 * Provides the base implementation for the temp ship security port items local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.TempShipSecurityPortItemsLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.TempShipSecurityPortItemsLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.TempShipSecurityPortItemsLocalServiceUtil
 * @generated
 */
public abstract class TempShipSecurityPortItemsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.TempShipSecurityPortItemsLocalServiceUtil} to access the temp ship security port items local service.
	 */
	...
	public TempShipSecurityPortItems addTempShipSecurityPortItems(
		...
		return tempShipSecurityPortItemsPersistence.update(tempShipSecurityPortItems);
	}
	...
	@Override
	public TempShipSecurityPortItems deleteTempShipSecurityPortItems(long id)
		throws PortalException, SystemException {
		return tempShipSecurityPortItemsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TempShipSecurityPortItems deleteTempShipSecurityPortItems(
		TempShipSecurityPortItems tempShipSecurityPortItems)
		throws SystemException {
		return tempShipSecurityPortItemsPersistence.remove(tempShipSecurityPortItems);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TempShipSecurityPortItems.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.TempShipSecurityPortItems",
	...
	private TempShipSecurityPortItemsLocalServiceClpInvoker _clpInvoker = new TempShipSecurityPortItemsLocalServiceClpInvoker();
}