...
public class RmdcShipLocalServiceClp implements RmdcShipLocalService {
	public RmdcShipLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public vn.dtt.duongbien.dao.vrcb.model.RmdcShip addRmdcShip(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(rmdcShip) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbien.dao.vrcb.model.RmdcShip)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbien.dao.vrcb.model.RmdcShip> getRmdcShips(
		...
		return (java.util.List<vn.dtt.duongbien.dao.vrcb.model.RmdcShip>)ClpSerializer.translateOutput(returnObj);
	}
