...
import vn.dtt.duongbien.dao.vrcb.service.ModifyLocalService;
...
/**
 * Provides the base implementation for the modify local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.ModifyLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.ModifyLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.ModifyLocalServiceUtil
 * @generated
 */
public abstract class ModifyLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ModifyLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.ModifyLocalServiceUtil} to access the modify local service.
	 */
	...
	public Modify addModify(Modify modify) throws SystemException {
		...
		return modifyPersistence.update(modify);
	}
	...
	@Override
	public Modify deleteModify(long id) throws PortalException, SystemException {
		return modifyPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Modify deleteModify(Modify modify) throws SystemException {
		return modifyPersistence.remove(modify);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Modify.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return modifyPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.Modify",
			modifyLocalService);
	}
	...
	private ModifyLocalServiceClpInvoker _clpInvoker = new ModifyLocalServiceClpInvoker();
}