...
/**
 * Provides the local service utility for ResultCertificate. This utility wraps
 * {@link vn.dtt.duongbien.dao.vrcb.service.impl.ResultCertificateLocalServiceImpl} and is the
 ...
 * @see vn.dtt.duongbien.dao.vrcb.service.base.ResultCertificateLocalServiceBaseImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.ResultCertificateLocalServiceImpl
 * @generated
 */
public class ResultCertificateLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.duongbien.dao.vrcb.service.impl.ResultCertificateLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultCertificate addResultCertificate(
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultCertificate createResultCertificate(
		long id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultCertificate deleteResultCertificate(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteResultCertificate(id);
	}
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultCertificate deleteResultCertificate(
		vn.dtt.duongbien.dao.vrcb.model.ResultCertificate resultCertificate)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteResultCertificate(resultCertificate);
	}
	...
	*/
	...
	public static vn.dtt.duongbien.dao.vrcb.model.ResultCertificate fetchResultCertificate(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultCertificate getResultCertificate(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbien.dao.vrcb.model.ResultCertificate> getResultCertificates(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultCertificate updateResultCertificate(
		vn.dtt.duongbien.dao.vrcb.model.ResultCertificate resultCertificate)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ResultCertificateLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof ResultCertificateLocalService) {
				_service = (ResultCertificateLocalService)invokableLocalService;
			}
			else {
				_service = new ResultCertificateLocalServiceClp(invokableLocalService);
			}
