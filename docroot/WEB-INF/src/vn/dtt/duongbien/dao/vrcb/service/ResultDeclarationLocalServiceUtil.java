...
/**
 * Provides the local service utility for ResultDeclaration. This utility wraps
 * {@link vn.dtt.duongbien.dao.vrcb.service.impl.ResultDeclarationLocalServiceImpl} and is the
 ...
 * @see vn.dtt.duongbien.dao.vrcb.service.base.ResultDeclarationLocalServiceBaseImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.ResultDeclarationLocalServiceImpl
 * @generated
 */
public class ResultDeclarationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.duongbien.dao.vrcb.service.impl.ResultDeclarationLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration addResultDeclaration(
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration createResultDeclaration(
		long id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration deleteResultDeclaration(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteResultDeclaration(id);
	}
	...
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration deleteResultDeclaration(
		vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration resultDeclaration)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteResultDeclaration(resultDeclaration);
	}
	...
	*/
	...
	public static vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration fetchResultDeclaration(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration getResultDeclaration(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration> getResultDeclarations(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration updateResultDeclaration(
		vn.dtt.duongbien.dao.vrcb.model.ResultDeclaration resultDeclaration)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ResultDeclarationLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof ResultDeclarationLocalService) {
				_service = (ResultDeclarationLocalService)invokableLocalService;
			}
			else {
				_service = new ResultDeclarationLocalServiceClp(invokableLocalService);
			}
