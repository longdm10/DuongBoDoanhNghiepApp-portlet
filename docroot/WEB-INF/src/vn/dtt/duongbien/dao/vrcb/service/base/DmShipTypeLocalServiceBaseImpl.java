...
import vn.dtt.duongbien.dao.vrcb.service.DmShipTypeLocalService;
...
/**
 * Provides the base implementation for the dm ship type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbien.dao.vrcb.service.impl.DmShipTypeLocalServiceImpl}.
 * </p>
 *
 * @author longdm
 * @see vn.dtt.duongbien.dao.vrcb.service.impl.DmShipTypeLocalServiceImpl
 * @see vn.dtt.duongbien.dao.vrcb.service.DmShipTypeLocalServiceUtil
 * @generated
 */
public abstract class DmShipTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DmShipTypeLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbien.dao.vrcb.service.DmShipTypeLocalServiceUtil} to access the dm ship type local service.
	 */
	...
	public DmShipType addDmShipType(DmShipType dmShipType)
		...
		return dmShipTypePersistence.update(dmShipType);
	}
	...
	@Override
	public DmShipType deleteDmShipType(int id)
		throws PortalException, SystemException {
		return dmShipTypePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DmShipType deleteDmShipType(DmShipType dmShipType)
		throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DmShipType.class,
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbien.dao.vrcb.model.DmShipType",
	...
	private DmShipTypeLocalServiceClpInvoker _clpInvoker = new DmShipTypeLocalServiceClpInvoker();
}