 ...
 * @generated
 */
public class TempPlantQuarantineServiceClpInvoker {
	public TempPlantQuarantineServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempPlantQuarantineServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempPlantQuarantineServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
