 ...
 * @generated
 */
public class TempDeclarationOfHealthServiceClpInvoker {
	public TempDeclarationOfHealthServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempDeclarationOfHealthServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempDeclarationOfHealthServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
