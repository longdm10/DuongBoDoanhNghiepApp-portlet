 ...
 * @generated
 */
public class TempShipSecurityMessageServiceClpInvoker {
	public TempShipSecurityMessageServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName552.equals(name) &&
			...
			return TempShipSecurityMessageServiceUtil.getBeanIdentifier();
		}

		if (_methodName553.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes553, parameterTypes)) {
			TempShipSecurityMessageServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
