...
/**
 * The persistence utility for the qlvt cap phep gp lien van service. This utility wraps {@link QlvtCapPhepGpLienVanPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see QlvtCapPhepGpLienVanPersistenceImpl
 * @generated
 */
public class QlvtCapPhepGpLienVanUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(QlvtCapPhepGpLienVan qlvtCapPhepGpLienVan) {
		getPersistence().clearCache(qlvtCapPhepGpLienVan);
	}
	 ...
	 */
	public static List<QlvtCapPhepGpLienVan> findWithDynamicQuery(
	 ...
	 */
	public static QlvtCapPhepGpLienVan update(
		QlvtCapPhepGpLienVan qlvtCapPhepGpLienVan) throws SystemException {
		return getPersistence().update(qlvtCapPhepGpLienVan);
	}
	 ...
	 */
	public static QlvtCapPhepGpLienVan update(
		QlvtCapPhepGpLienVan qlvtCapPhepGpLienVan, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(qlvtCapPhepGpLienVan, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qlvtCapPhepGpLienVan);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGpLienVan> qlvtCapPhepGpLienVans) {
		getPersistence().cacheResult(qlvtCapPhepGpLienVans);
	}
	...
	*/
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGpLienVan create(
		long id) {
	...
	*/
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGpLienVan remove(
		long id)
	...
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGpLienVan updateImpl(
		vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGpLienVan qlvtCapPhepGpLienVan)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(qlvtCapPhepGpLienVan);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGpLienVan findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.duongbo.dao.lienvan.NoSuchQlvtCapPhepGpLienVanException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGpLienVan fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGpLienVan> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static QlvtCapPhepGpLienVanPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (QlvtCapPhepGpLienVanPersistence)PortletBeanLocatorUtil.locate(vn.dtt.duongbo.dao.lienvan.service.ClpSerializer.getServletContextName(),
					QlvtCapPhepGpLienVanPersistence.class.getName());

			ReferenceRegistry.registerReference(QlvtCapPhepGpLienVanUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(QlvtCapPhepGpLienVanPersistence persistence) {
	}

	private static QlvtCapPhepGpLienVanPersistence _persistence;
}