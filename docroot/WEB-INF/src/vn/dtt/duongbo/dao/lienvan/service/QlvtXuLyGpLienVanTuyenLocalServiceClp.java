 ...
 * @generated
 */
public class QlvtXuLyGpLienVanTuyenLocalServiceClp
	implements QlvtXuLyGpLienVanTuyenLocalService {
	public QlvtXuLyGpLienVanTuyenLocalServiceClp(
	...
	public vn.dtt.duongbo.dao.lienvan.model.QlvtXuLyGpLienVanTuyen addQlvtXuLyGpLienVanTuyen(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(qlvtXuLyGpLienVanTuyen)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.lienvan.model.QlvtXuLyGpLienVanTuyen)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.lienvan.model.QlvtXuLyGpLienVanTuyen> getQlvtXuLyGpLienVanTuyens(
		...
		return (java.util.List<vn.dtt.duongbo.dao.lienvan.model.QlvtXuLyGpLienVanTuyen>)ClpSerializer.translateOutput(returnObj);
	}
