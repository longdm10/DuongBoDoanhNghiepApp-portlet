...
/**
 * The persistence utility for the qlvt cap phep gplv phuong tien van tai service. This utility wraps {@link QlvtCapPhepGplvPhuongTienVanTaiPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class QlvtCapPhepGplvPhuongTienVanTaiUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(qlvtCapPhepGplvPhuongTienVanTai);
	}
	 ...
	 */
	public static List<QlvtCapPhepGplvPhuongTienVanTai> findWithDynamicQuery(
	 ...
	 */
	public static QlvtCapPhepGplvPhuongTienVanTai update(
		QlvtCapPhepGplvPhuongTienVanTai qlvtCapPhepGplvPhuongTienVanTai)
		throws SystemException {
		return getPersistence().update(qlvtCapPhepGplvPhuongTienVanTai);
	}
	...
	public static QlvtCapPhepGplvPhuongTienVanTai update(
		...
		return getPersistence()
				   .update(qlvtCapPhepGplvPhuongTienVanTai, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qlvtCapPhepGplvPhuongTienVanTai);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qlvtCapPhepGplvPhuongTienVanTais);
	}
	...
	*/
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGplvPhuongTienVanTai create(
		long id) {
	...
	*/
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGplvPhuongTienVanTai remove(
		long id)
	...
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGplvPhuongTienVanTai updateImpl(
		vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGplvPhuongTienVanTai qlvtCapPhepGplvPhuongTienVanTai)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(qlvtCapPhepGplvPhuongTienVanTai);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGplvPhuongTienVanTai findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.duongbo.dao.lienvan.NoSuchQlvtCapPhepGplvPhuongTienVanTaiException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGplvPhuongTienVanTai fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbo.dao.lienvan.model.QlvtCapPhepGplvPhuongTienVanTai> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static QlvtCapPhepGplvPhuongTienVanTaiPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (QlvtCapPhepGplvPhuongTienVanTaiPersistence)PortletBeanLocatorUtil.locate(vn.dtt.duongbo.dao.lienvan.service.ClpSerializer.getServletContextName(),
					QlvtCapPhepGplvPhuongTienVanTaiPersistence.class.getName());

			ReferenceRegistry.registerReference(QlvtCapPhepGplvPhuongTienVanTaiUtil.class,
				"_persistence");
		}
	...
	public void setPersistence(
		QlvtCapPhepGplvPhuongTienVanTaiPersistence persistence) {
	}

	private static QlvtCapPhepGplvPhuongTienVanTaiPersistence _persistence;
}