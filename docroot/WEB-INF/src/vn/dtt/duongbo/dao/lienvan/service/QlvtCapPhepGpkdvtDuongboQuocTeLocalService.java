...
/**
 * Provides the local service interface for QlvtCapPhepGpkdvtDuongboQuocTe. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanNc
 * @see QlvtCapPhepGpkdvtDuongboQuocTeLocalServiceUtil
...
public interface QlvtCapPhepGpkdvtDuongboQuocTeLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtCapPhepGpkdvtDuongboQuocTeLocalServiceUtil} to access the qlvt cap phep gpkdvt duongbo quoc te local service. Add custom service methods to {@link vn.dtt.duongbo.dao.lienvan.service.impl.QlvtCapPhepGpkdvtDuongboQuocTeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
