...
/**
 * Provides the local service interface for QlvtXuLyGpLienVanPhuongTienTramDungNghi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanNc
 * @see QlvtXuLyGpLienVanPhuongTienTramDungNghiLocalServiceUtil
...
public interface QlvtXuLyGpLienVanPhuongTienTramDungNghiLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtXuLyGpLienVanPhuongTienTramDungNghiLocalServiceUtil} to access the qlvt xu ly gp lien van phuong tien tram dung nghi local service. Add custom service methods to {@link vn.dtt.duongbo.dao.lienvan.service.impl.QlvtXuLyGpLienVanPhuongTienTramDungNghiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
