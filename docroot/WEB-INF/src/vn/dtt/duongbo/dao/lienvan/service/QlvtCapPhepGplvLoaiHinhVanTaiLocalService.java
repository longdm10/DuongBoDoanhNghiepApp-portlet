...
/**
 * Provides the local service interface for QlvtCapPhepGplvLoaiHinhVanTai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanNc
 * @see QlvtCapPhepGplvLoaiHinhVanTaiLocalServiceUtil
...
public interface QlvtCapPhepGplvLoaiHinhVanTaiLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtCapPhepGplvLoaiHinhVanTaiLocalServiceUtil} to access the qlvt cap phep gplv loai hinh van tai local service. Add custom service methods to {@link vn.dtt.duongbo.dao.lienvan.service.impl.QlvtCapPhepGplvLoaiHinhVanTaiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
