...
/**
 * Provides the local service interface for QlvtCapPhepGplvPhuongTienVanTaiTramdungnghi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanNc
 * @see QlvtCapPhepGplvPhuongTienVanTaiTramdungnghiLocalServiceUtil
...
public interface QlvtCapPhepGplvPhuongTienVanTaiTramdungnghiLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtCapPhepGplvPhuongTienVanTaiTramdungnghiLocalServiceUtil} to access the qlvt cap phep gplv phuong tien van tai tramdungnghi local service. Add custom service methods to {@link vn.dtt.duongbo.dao.lienvan.service.impl.QlvtCapPhepGplvPhuongTienVanTaiTramdungnghiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
