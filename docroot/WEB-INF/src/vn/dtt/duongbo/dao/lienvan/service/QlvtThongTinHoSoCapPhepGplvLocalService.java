...
/**
 * Provides the local service interface for QlvtThongTinHoSoCapPhepGplv. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanNc
 * @see QlvtThongTinHoSoCapPhepGplvLocalServiceUtil
...
public interface QlvtThongTinHoSoCapPhepGplvLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtThongTinHoSoCapPhepGplvLocalServiceUtil} to access the qlvt thong tin ho so cap phep gplv local service. Add custom service methods to {@link vn.dtt.duongbo.dao.lienvan.service.impl.QlvtThongTinHoSoCapPhepGplvLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
