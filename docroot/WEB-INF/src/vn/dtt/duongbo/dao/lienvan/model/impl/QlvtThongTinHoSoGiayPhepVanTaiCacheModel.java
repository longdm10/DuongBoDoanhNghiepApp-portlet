...
/**
 * The cache model class for representing QlvtThongTinHoSoGiayPhepVanTai in entity cache.
 *
 * @author NhanNc
 * @see QlvtThongTinHoSoGiayPhepVanTai
 * @generated
 */
public class QlvtThongTinHoSoGiayPhepVanTaiCacheModel implements CacheModel<QlvtThongTinHoSoGiayPhepVanTai>,
	Externalizable {
	@Override
	...
	public QlvtThongTinHoSoGiayPhepVanTai toEntityModel() {
		...
		qlvtThongTinHoSoGiayPhepVanTaiImpl.setId(id);
		qlvtThongTinHoSoGiayPhepVanTaiImpl.setThongtinhosoId(thongtinhosoId);
		qlvtThongTinHoSoGiayPhepVanTaiImpl.setCapphepGpkdvtId(capphepGpkdvtId);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		capphepGpkdvtId = objectInput.readLong();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeLong(capphepGpkdvtId);
	}

	public long id;
	public long thongtinhosoId;
	public long capphepGpkdvtId;
}