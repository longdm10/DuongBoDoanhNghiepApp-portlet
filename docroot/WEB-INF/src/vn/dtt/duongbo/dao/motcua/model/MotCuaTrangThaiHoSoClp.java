	...
	public void setMaTrangThai(String maTrangThai) {
		...
		if (_motCuaTrangThaiHoSoRemoteModel != null) {
			try {
				...
				method.invoke(_motCuaTrangThaiHoSoRemoteModel, maTrangThai);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTenTiengAnh(String tenTiengAnh) {
		...
		if (_motCuaTrangThaiHoSoRemoteModel != null) {
			try {
				...
				method.invoke(_motCuaTrangThaiHoSoRemoteModel, tenTiengAnh);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSoThuTu(int soThuTu) {
		...
		if (_motCuaTrangThaiHoSoRemoteModel != null) {
			try {
				...
				method.invoke(_motCuaTrangThaiHoSoRemoteModel, soThuTu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTrangThaiKetThuc(int trangThaiKetThuc) {
		...
		if (_motCuaTrangThaiHoSoRemoteModel != null) {
			try {
				...
				method.invoke(_motCuaTrangThaiHoSoRemoteModel, trangThaiKetThuc);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
