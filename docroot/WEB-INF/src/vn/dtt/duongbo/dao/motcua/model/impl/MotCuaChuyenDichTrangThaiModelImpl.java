...
import vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThaiModel;
import vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThaiSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThaiModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link MotCuaChuyenDichTrangThaiImpl}.
 * </p>
 *
 * @author win_64
 * @see MotCuaChuyenDichTrangThaiImpl
 * @see vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThai
 * @see vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThaiModel
 * @generated
 */
@JSON(strict = true)
public class MotCuaChuyenDichTrangThaiModelImpl extends BaseModelImpl<MotCuaChuyenDichTrangThai>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a mot cua chuyen dich trang thai model instance should use the {@link vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThai} interface instead.
	 */
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "taophieumoi", Types.INTEGER },
			{ "thongbaoxuly", Types.VARCHAR },
			{ "chuyenxuly", Types.INTEGER }
		};
	public static final String TABLE_SQL_CREATE = "create table motcua_chuyendichtrangthai (id LONG not null primary key,trangthainguonid LONG,trangthaidichid LONG,dieukienchuyendich VARCHAR(75) null,hanhdongxuly VARCHAR(75) null,songayxuly INTEGER,phannhomhosoid LONG,quytrinhthutucid LONG,taophieumoi INTEGER,thongbaoxuly VARCHAR(75) null,chuyenxuly INTEGER)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThai"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThai"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThai"),
			true);
	public static long DIEUKIENCHUYENDICH_COLUMN_BITMASK = 1L;
	public static long QUYTRINHTHUTUCID_COLUMN_BITMASK = 2L;
	public static long TRANGTHAIDICHID_COLUMN_BITMASK = 4L;
	public static long TRANGTHAINGUONID_COLUMN_BITMASK = 8L;
	...
	public static MotCuaChuyenDichTrangThai toModel(
		...
		model.setTaoPhieuMoi(soapModel.getTaoPhieuMoi());
		model.setThongBaoXuLy(soapModel.getThongBaoXuLy());
		model.setChuyenXuLy(soapModel.getChuyenXuLy());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.dtt.duongbo.dao.motcua.model.MotCuaChuyenDichTrangThai"));
	...
	public Object clone() {
		...
		motCuaChuyenDichTrangThaiImpl.setQuyTrinhThuTucId(getQuyTrinhThuTucId());
		motCuaChuyenDichTrangThaiImpl.setTaoPhieuMoi(getTaoPhieuMoi());
		motCuaChuyenDichTrangThaiImpl.setThongBaoXuLy(getThongBaoXuLy());
		motCuaChuyenDichTrangThaiImpl.setChuyenXuLy(getChuyenXuLy());
	...
	public void resetOriginalValues() {
		...
		motCuaChuyenDichTrangThaiModelImpl._originalQuyTrinhThuTucId = motCuaChuyenDichTrangThaiModelImpl._quyTrinhThuTucId;

		motCuaChuyenDichTrangThaiModelImpl._setOriginalQuyTrinhThuTucId = false;
	...
	public CacheModel<MotCuaChuyenDichTrangThai> toCacheModel() {
		...
		motCuaChuyenDichTrangThaiCacheModel.quyTrinhThuTucId = getQuyTrinhThuTucId();

		motCuaChuyenDichTrangThaiCacheModel.taoPhieuMoi = getTaoPhieuMoi();

		motCuaChuyenDichTrangThaiCacheModel.thongBaoXuLy = getThongBaoXuLy();

		String thongBaoXuLy = motCuaChuyenDichTrangThaiCacheModel.thongBaoXuLy;

		if ((thongBaoXuLy != null) && (thongBaoXuLy.length() == 0)) {
			motCuaChuyenDichTrangThaiCacheModel.thongBaoXuLy = null;
		}

		motCuaChuyenDichTrangThaiCacheModel.chuyenXuLy = getChuyenXuLy();
