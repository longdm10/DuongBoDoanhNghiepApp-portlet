...
/**
 * Provides the local service interface for MotCuaChuyenDichTrangThai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see MotCuaChuyenDichTrangThaiLocalServiceUtil
 * @see vn.dtt.duongbo.dao.motcua.service.base.MotCuaChuyenDichTrangThaiLocalServiceBaseImpl
 * @see vn.dtt.duongbo.dao.motcua.service.impl.MotCuaChuyenDichTrangThaiLocalServiceImpl
 * @generated
 */
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface MotCuaChuyenDichTrangThaiLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MotCuaChuyenDichTrangThaiLocalServiceUtil} to access the mot cua chuyen dich trang thai local service. Add custom service methods to {@link vn.dtt.duongbo.dao.motcua.service.impl.MotCuaChuyenDichTrangThaiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
