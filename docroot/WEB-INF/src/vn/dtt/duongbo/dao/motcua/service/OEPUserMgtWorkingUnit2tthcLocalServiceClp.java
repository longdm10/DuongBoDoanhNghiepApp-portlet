 ...
 * @generated
 */
public class OEPUserMgtWorkingUnit2tthcLocalServiceClp
	implements OEPUserMgtWorkingUnit2tthcLocalService {
	public OEPUserMgtWorkingUnit2tthcLocalServiceClp(
		...
		_methodName19 = "fetchByF_TTHCId_workingUnitId";
	...
	public vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit2tthc addOEPUserMgtWorkingUnit2tthc(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(oepUserMgtWorkingUnit2tthc)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit2tthc)ClpSerializer.translateOutput(returnObj);
	}
	...
	public vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit2tthc createOEPUserMgtWorkingUnit2tthc(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { workingUnit2TTHCId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit2tthc deleteOEPUserMgtWorkingUnit2tthc(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { workingUnit2TTHCId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit2tthc fetchOEPUserMgtWorkingUnit2tthc(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { workingUnit2TTHCId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit2tthc getOEPUserMgtWorkingUnit2tthc(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName11,
					_methodParameterTypes11, new Object[] { workingUnit2TTHCId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit2tthc> getOEPUserMgtWorkingUnit2tthcs(
		...
		return (java.util.List<vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit2tthc>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit2tthc fetchByF_TTHCId_workingUnitId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] { TTHCId, workingUnitId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
