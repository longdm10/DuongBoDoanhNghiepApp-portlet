...
/**
 * Provides the local service interface for OEPUserMgtWorkingUnit2tthc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see OEPUserMgtWorkingUnit2tthcLocalServiceUtil
...
public interface OEPUserMgtWorkingUnit2tthcLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OEPUserMgtWorkingUnit2tthcLocalServiceUtil} to access the o e p user mgt working unit2tthc local service. Add custom service methods to {@link vn.dtt.duongbo.dao.motcua.service.impl.OEPUserMgtWorkingUnit2tthcLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
