...
/**
 * Provides the local service interface for MotCuaQuyTrinhThuTuc. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see MotCuaQuyTrinhThuTucLocalServiceUtil
 * @see vn.dtt.duongbo.dao.motcua.service.base.MotCuaQuyTrinhThuTucLocalServiceBaseImpl
 * @see vn.dtt.duongbo.dao.motcua.service.impl.MotCuaQuyTrinhThuTucLocalServiceImpl
 * @generated
 */
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface MotCuaQuyTrinhThuTucLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MotCuaQuyTrinhThuTucLocalServiceUtil} to access the mot cua quy trinh thu tuc local service. Add custom service methods to {@link vn.dtt.duongbo.dao.motcua.service.impl.MotCuaQuyTrinhThuTucLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
