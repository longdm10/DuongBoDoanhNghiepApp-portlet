...
public class MotCuaPhanCongXuLyLocalServiceWrapper
	...
	*/
	...
	public vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLy findMotCuaPhanCongXuLyByPhieuXuLyId(
		long idPhieuXuLy) {
		return _motCuaPhanCongXuLyLocalService.findMotCuaPhanCongXuLyByPhieuXuLyId(idPhieuXuLy);
	}

	@Override
	public int updateMotCuaPhanCongXuLy(long idNguoiPhanCong,
		long idNguoiDuocUyQuyen) {
		return _motCuaPhanCongXuLyLocalService.updateMotCuaPhanCongXuLy(idNguoiPhanCong,
			idNguoiDuocUyQuyen);
	}
	...
	public vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLy fetchByF_UNI_PhieuXuLyId(
		long phieuXuLyId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _motCuaPhanCongXuLyLocalService.fetchByF_UNI_PhieuXuLyId(phieuXuLyId);
	}
