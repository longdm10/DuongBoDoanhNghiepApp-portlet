...
public class MotCuaQuyTrinhThuTucWrapper implements MotCuaQuyTrinhThuTuc,
	...
	*/
	...
	/**
	* Returns the ten quy trinh of this mot cua quy trinh thu tuc.
	*
	* @return the ten quy trinh of this mot cua quy trinh thu tuc
	*/
	@Override
	public java.lang.String getTenQuyTrinh() {
		return _motCuaQuyTrinhThuTuc.getTenQuyTrinh();
	}

	/**
	* Sets the ten quy trinh of this mot cua quy trinh thu tuc.
	*
	* @param tenQuyTrinh the ten quy trinh of this mot cua quy trinh thu tuc
	*/
	@Override
	public void setTenQuyTrinh(java.lang.String tenQuyTrinh) {
		_motCuaQuyTrinhThuTuc.setTenQuyTrinh(tenQuyTrinh);
	}
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<vn.dtt.duongbo.dao.motcua.model.MotCuaQuyTrinhThuTuc> toCacheModel() {
		return _motCuaQuyTrinhThuTuc.toCacheModel();
	}

	@Override
	public vn.dtt.duongbo.dao.motcua.model.MotCuaQuyTrinhThuTuc toEscapedModel() {
		return new MotCuaQuyTrinhThuTucWrapper(_motCuaQuyTrinhThuTuc.toEscapedModel());
	}

	@Override
	public vn.dtt.duongbo.dao.motcua.model.MotCuaQuyTrinhThuTuc toUnescapedModel() {
