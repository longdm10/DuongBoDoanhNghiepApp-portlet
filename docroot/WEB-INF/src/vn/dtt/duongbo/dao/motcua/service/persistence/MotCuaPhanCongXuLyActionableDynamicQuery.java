 ...
 * @generated
 */
public abstract class MotCuaPhanCongXuLyActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public MotCuaPhanCongXuLyActionableDynamicQuery() throws SystemException {
		setBaseLocalService(MotCuaPhanCongXuLyLocalServiceUtil.getService());
		setClass(MotCuaPhanCongXuLy.class);
