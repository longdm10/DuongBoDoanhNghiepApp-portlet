...
/**
 * The persistence utility for the o e p user mgt employee2jobpos service. This utility wraps {@link OEPUserMgtEmployee2jobposPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class OEPUserMgtEmployee2jobposUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(oepUserMgtEmployee2jobpos);
	}
	 ...
	 */
	public static List<OEPUserMgtEmployee2jobpos> findWithDynamicQuery(
	 ...
	 */
	public static OEPUserMgtEmployee2jobpos update(
		OEPUserMgtEmployee2jobpos oepUserMgtEmployee2jobpos)
		throws SystemException {
		return getPersistence().update(oepUserMgtEmployee2jobpos);
	}
	...
	public static OEPUserMgtEmployee2jobpos update(
		...
		return getPersistence().update(oepUserMgtEmployee2jobpos, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(oepUserMgtEmployee2jobpos);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(oepUserMgtEmployee2jobposes);
	}
	...
	*/
	public static vn.dtt.duongbo.dao.motcua.model.OEPUserMgtEmployee2jobpos create(
		vn.dtt.duongbo.dao.motcua.service.persistence.OEPUserMgtEmployee2jobposPK oepUserMgtEmployee2jobposPK) {
		return getPersistence().create(oepUserMgtEmployee2jobposPK);
	}
	...
	*/
	public static vn.dtt.duongbo.dao.motcua.model.OEPUserMgtEmployee2jobpos remove(
		vn.dtt.duongbo.dao.motcua.service.persistence.OEPUserMgtEmployee2jobposPK oepUserMgtEmployee2jobposPK)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.duongbo.dao.motcua.NoSuchOEPUserMgtEmployee2jobposException {
		return getPersistence().remove(oepUserMgtEmployee2jobposPK);
	}

	public static vn.dtt.duongbo.dao.motcua.model.OEPUserMgtEmployee2jobpos updateImpl(
		vn.dtt.duongbo.dao.motcua.model.OEPUserMgtEmployee2jobpos oepUserMgtEmployee2jobpos)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(oepUserMgtEmployee2jobpos);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.motcua.model.OEPUserMgtEmployee2jobpos findByPrimaryKey(
		vn.dtt.duongbo.dao.motcua.service.persistence.OEPUserMgtEmployee2jobposPK oepUserMgtEmployee2jobposPK)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.duongbo.dao.motcua.NoSuchOEPUserMgtEmployee2jobposException {
		return getPersistence().findByPrimaryKey(oepUserMgtEmployee2jobposPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.motcua.model.OEPUserMgtEmployee2jobpos fetchByPrimaryKey(
		vn.dtt.duongbo.dao.motcua.service.persistence.OEPUserMgtEmployee2jobposPK oepUserMgtEmployee2jobposPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(oepUserMgtEmployee2jobposPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbo.dao.motcua.model.OEPUserMgtEmployee2jobpos> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static OEPUserMgtEmployee2jobposPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (OEPUserMgtEmployee2jobposPersistence)PortletBeanLocatorUtil.locate(vn.dtt.duongbo.dao.motcua.service.ClpSerializer.getServletContextName(),
					OEPUserMgtEmployee2jobposPersistence.class.getName());

			ReferenceRegistry.registerReference(OEPUserMgtEmployee2jobposUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(OEPUserMgtEmployee2jobposPersistence persistence) {
	}

	private static OEPUserMgtEmployee2jobposPersistence _persistence;
}