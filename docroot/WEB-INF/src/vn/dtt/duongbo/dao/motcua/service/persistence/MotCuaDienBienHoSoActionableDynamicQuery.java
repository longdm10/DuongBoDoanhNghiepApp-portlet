 ...
 * @generated
 */
public abstract class MotCuaDienBienHoSoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public MotCuaDienBienHoSoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(MotCuaDienBienHoSoLocalServiceUtil.getService());
		setClass(MotCuaDienBienHoSo.class);
