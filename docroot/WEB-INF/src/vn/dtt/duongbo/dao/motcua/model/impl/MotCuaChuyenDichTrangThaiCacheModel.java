...
public class MotCuaChuyenDichTrangThaiCacheModel implements CacheModel<MotCuaChuyenDichTrangThai>,
	...
	public MotCuaChuyenDichTrangThai toEntityModel() {
		...
		motCuaChuyenDichTrangThaiImpl.setQuyTrinhThuTucId(quyTrinhThuTucId);
		motCuaChuyenDichTrangThaiImpl.setTaoPhieuMoi(taoPhieuMoi);

		if (thongBaoXuLy == null) {
			motCuaChuyenDichTrangThaiImpl.setThongBaoXuLy(StringPool.BLANK);
		}
		else {
			motCuaChuyenDichTrangThaiImpl.setThongBaoXuLy(thongBaoXuLy);
		}

		motCuaChuyenDichTrangThaiImpl.setChuyenXuLy(chuyenXuLy);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		taoPhieuMoi = objectInput.readInt();
		thongBaoXuLy = objectInput.readUTF();
		chuyenXuLy = objectInput.readInt();
	}
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeInt(taoPhieuMoi);
		...
		objectOutput.writeInt(chuyenXuLy);
	}
	...
	public int taoPhieuMoi;
	public String thongBaoXuLy;
	public int chuyenXuLy;
}