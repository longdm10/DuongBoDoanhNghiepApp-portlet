...
public class MotCuaKetQuaDienBienWrapper implements MotCuaKetQuaDienBien,
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<vn.dtt.duongbo.dao.motcua.model.MotCuaKetQuaDienBien> toCacheModel() {
		return _motCuaKetQuaDienBien.toCacheModel();
	}

	@Override
	public vn.dtt.duongbo.dao.motcua.model.MotCuaKetQuaDienBien toEscapedModel() {
		return new MotCuaKetQuaDienBienWrapper(_motCuaKetQuaDienBien.toEscapedModel());
	}

	@Override
	public vn.dtt.duongbo.dao.motcua.model.MotCuaKetQuaDienBien toUnescapedModel() {
