...
import vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLyModel;
import vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLySoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLyModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link MotCuaPhanCongXuLyImpl}.
 * </p>
 *
 * @author win_64
 * @see MotCuaPhanCongXuLyImpl
 * @see vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLy
 * @see vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLyModel
 * @generated
 */
@JSON(strict = true)
public class MotCuaPhanCongXuLyModelImpl extends BaseModelImpl<MotCuaPhanCongXuLy>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a mot cua phan cong xu ly model instance should use the {@link vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLy} interface instead.
	 */
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "TOCHUCXETDUYET", Types.BIGINT }
		};
	public static final String TABLE_SQL_CREATE = "create table motcua_phancongxuly (id LONG not null primary key,PHIEUXULYID LONG,trangthaihosoid LONG,nguoixuly LONG,nhomxuly LONG,ngayphancong DATE null,nguoiphancong LONG,NGUOIDUOCUYQUYEN LONG,TOCHUCXULY LONG,TOCHUCXETDUYET LONG)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLy"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLy"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLy"),
			true);
	public static long PHIEUXULYID_COLUMN_BITMASK = 1L;
	...
	public static MotCuaPhanCongXuLy toModel(MotCuaPhanCongXuLySoap soapModel) {
		...
		model.setToChucXetDuyet(soapModel.getToChucXetDuyet());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.dtt.duongbo.dao.motcua.model.MotCuaPhanCongXuLy"));
	...
	public Object clone() {
		...
		motCuaPhanCongXuLyImpl.setPhieuXuLyId(getPhieuXuLyId());
		...
		motCuaPhanCongXuLyImpl.setNguoiDuocUyQuyen(getNguoiDuocUyQuyen());
		motCuaPhanCongXuLyImpl.setToChucXuLy(getToChucXuLy());
		motCuaPhanCongXuLyImpl.setToChucXetDuyet(getToChucXetDuyet());
	...
	public void resetOriginalValues() {
		...
		motCuaPhanCongXuLyModelImpl._originalPhieuXuLyId = motCuaPhanCongXuLyModelImpl._phieuXuLyId;

		motCuaPhanCongXuLyModelImpl._setOriginalPhieuXuLyId = false;
	...
	public CacheModel<MotCuaPhanCongXuLy> toCacheModel() {
		...
		motCuaPhanCongXuLyCacheModel.phieuXuLyId = getPhieuXuLyId();
		...
		motCuaPhanCongXuLyCacheModel.nguoiDuocUyQuyen = getNguoiDuocUyQuyen();

		motCuaPhanCongXuLyCacheModel.toChucXuLy = getToChucXuLy();

		motCuaPhanCongXuLyCacheModel.toChucXetDuyet = getToChucXetDuyet();
