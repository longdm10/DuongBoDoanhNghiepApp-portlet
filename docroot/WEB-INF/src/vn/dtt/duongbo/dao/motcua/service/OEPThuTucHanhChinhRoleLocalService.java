...
/**
 * Provides the local service interface for OEPThuTucHanhChinhRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see OEPThuTucHanhChinhRoleLocalServiceUtil
...
public interface OEPThuTucHanhChinhRoleLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OEPThuTucHanhChinhRoleLocalServiceUtil} to access the o e p thu tuc hanh chinh role local service. Add custom service methods to {@link vn.dtt.duongbo.dao.motcua.service.impl.OEPThuTucHanhChinhRoleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
