 ...
 * @generated
 */
public class OEPUserMgtWorkingUnitLocalServiceClp
	implements OEPUserMgtWorkingUnitLocalService {
	public OEPUserMgtWorkingUnitLocalServiceClp(
		...
		_methodName19 = "getWorkingUnitByTTHCId";

		_methodParameterTypes19 = new String[] { "long" };

		_methodName20 = "getByGovAgentId";

		_methodParameterTypes20 = new String[] { "java.lang.String" };

		_methodName21 = "fetchByF_organizationId";

		_methodParameterTypes21 = new String[] { "java.lang.String" };

		_methodName22 = "findByF_parentWorkingUnitId";

		_methodParameterTypes22 = new String[] { "long" };

		_methodName23 = "findByF_parentWorkingUnitId";
	...
	public vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit addOEPUserMgtWorkingUnit(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(oepUserMgtWorkingUnit)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit> getOEPUserMgtWorkingUnits(
		...
		return (java.util.List<vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit> getWorkingUnitByTTHCId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					_methodParameterTypes19, new Object[] { tthcId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit getByGovAgentId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					new Object[] { ClpSerializer.translateInput(govAgentId) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
			...
			if (t instanceof vn.dtt.duongbo.dao.motcua.NoSuchOEPUserMgtWorkingUnitException) {
				throw (vn.dtt.duongbo.dao.motcua.NoSuchOEPUserMgtWorkingUnitException)t;
			}
	...
	public vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit fetchByF_organizationId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					...
					new Object[] { ClpSerializer.translateInput(organizationId) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit> findByF_parentWorkingUnitId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName22,
					...
					new Object[] { parentWorkingUnitId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.duongbo.dao.motcua.model.OEPUserMgtWorkingUnit> findByF_parentWorkingUnitId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					new Object[] { parentWorkingUnitId, TTHCId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
