 ...
 * @generated
 */
public abstract class OEPUserMgtEmployee2jobposActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public OEPUserMgtEmployee2jobposActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(OEPUserMgtEmployee2jobposLocalServiceUtil.getService());
		setClass(OEPUserMgtEmployee2jobpos.class);

		setClassLoader(vn.dtt.duongbo.dao.motcua.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("primaryKey.employeeId");
	}
}