...
public class MotCuaDienBienHoSoFinderUtil {
	public static java.util.List<vn.dtt.duongbo.dao.motcua.model.MotCuaDienBienHoSo> findMotCuaDienBienHoSo(
		long phieuxulyid) {
		return getFinder().findMotCuaDienBienHoSo(phieuxulyid);
	}

	public static MotCuaDienBienHoSoFinder getFinder() {
		if (_finder == null) {
			_finder = (MotCuaDienBienHoSoFinder)PortletBeanLocatorUtil.locate(vn.dtt.duongbo.dao.motcua.service.ClpSerializer.getServletContextName(),
