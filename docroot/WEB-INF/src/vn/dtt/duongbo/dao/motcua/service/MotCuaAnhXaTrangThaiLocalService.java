...
/**
 * Provides the local service interface for MotCuaAnhXaTrangThai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see MotCuaAnhXaTrangThaiLocalServiceUtil
...
public interface MotCuaAnhXaTrangThaiLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MotCuaAnhXaTrangThaiLocalServiceUtil} to access the mot cua anh xa trang thai local service. Add custom service methods to {@link vn.dtt.duongbo.dao.motcua.service.impl.MotCuaAnhXaTrangThaiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
