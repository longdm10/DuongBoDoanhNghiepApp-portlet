...
/**
 * Provides the local service interface for QlvtDiemDungDangKyVietLao. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see QlvtDiemDungDangKyVietLaoLocalServiceUtil
...
public interface QlvtDiemDungDangKyVietLaoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtDiemDungDangKyVietLaoLocalServiceUtil} to access the qlvt diem dung dang ky viet lao local service. Add custom service methods to {@link vn.dtt.duongbo.dao.common.service.impl.QlvtDiemDungDangKyVietLaoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
