...
import vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSoModel;
import vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSoSoap;
...
/**
 * The base model implementation for the TthcTrangThaiHoSo service. Represents a row in the &quot;motcua_trangthaihoso&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSoModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TthcTrangThaiHoSoImpl}.
 * </p>
 *
 * @author win_64
 * @see TthcTrangThaiHoSoImpl
 * @see vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSo
 * @see vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSoModel
 * @generated
 */
@JSON(strict = true)
public class TthcTrangThaiHoSoModelImpl extends BaseModelImpl<TthcTrangThaiHoSo>
	implements TthcTrangThaiHoSoModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a tthc trang thai ho so model instance should use the {@link vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSo} interface instead.
	 */
	...
	public static final String ORDER_BY_JPQL = " ORDER BY tthcTrangThaiHoSo.id ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSo"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSo"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSo"),
			true);
	public static long MATRANGTHAI_COLUMN_BITMASK = 1L;
	public static long QUYTRINHTHUTUCID_COLUMN_BITMASK = 2L;
	public static long VAITROXULY1_COLUMN_BITMASK = 4L;
	public static long VAITROXULY2_COLUMN_BITMASK = 8L;
	public static long VAITROXULY3_COLUMN_BITMASK = 16L;
	 ...
	 */
	public static TthcTrangThaiHoSo toModel(TthcTrangThaiHoSoSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		TthcTrangThaiHoSo model = new TthcTrangThaiHoSoImpl();
	 ...
	 */
	public static List<TthcTrangThaiHoSo> toModels(
		TthcTrangThaiHoSoSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<TthcTrangThaiHoSo> models = new ArrayList<TthcTrangThaiHoSo>(soapModels.length);

		for (TthcTrangThaiHoSoSoap soapModel : soapModels) {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSo"));

	public TthcTrangThaiHoSoModelImpl() {
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(0,
			TthcTrangThaiHoSo.class.getName(), getPrimaryKey());
	}
	...
	public TthcTrangThaiHoSo toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (TthcTrangThaiHoSo)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		tthcTrangThaiHoSoImpl.setId(getId());
		tthcTrangThaiHoSoImpl.setQuyTrinhThuTucId(getQuyTrinhThuTucId());
		tthcTrangThaiHoSoImpl.setMaTrangThai(getMaTrangThai());
		tthcTrangThaiHoSoImpl.setTenTrangThai(getTenTrangThai());
		tthcTrangThaiHoSoImpl.setTenTiengAnh(getTenTiengAnh());
		tthcTrangThaiHoSoImpl.setSoThuTu(getSoThuTu());
		tthcTrangThaiHoSoImpl.setTrangThaiKetThuc(getTrangThaiKetThuc());
		tthcTrangThaiHoSoImpl.setMoTaTrangThai(getMoTaTrangThai());
		tthcTrangThaiHoSoImpl.setVaiTroXuLy1(getVaiTroXuLy1());
		tthcTrangThaiHoSoImpl.setVaiTroXuLy2(getVaiTroXuLy2());
		tthcTrangThaiHoSoImpl.setVaiTroXuLy3(getVaiTroXuLy3());
		tthcTrangThaiHoSoImpl.setFormXuLy(getFormXuLy());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TthcTrangThaiHoSo)) {
			return false;
		}

		TthcTrangThaiHoSo tthcTrangThaiHoSo = (TthcTrangThaiHoSo)obj;
	...
	public void resetOriginalValues() {
		TthcTrangThaiHoSoModelImpl tthcTrangThaiHoSoModelImpl = this;

		tthcTrangThaiHoSoModelImpl._originalQuyTrinhThuTucId = tthcTrangThaiHoSoModelImpl._quyTrinhThuTucId;

		tthcTrangThaiHoSoModelImpl._setOriginalQuyTrinhThuTucId = false;

		tthcTrangThaiHoSoModelImpl._originalMaTrangThai = tthcTrangThaiHoSoModelImpl._maTrangThai;

		tthcTrangThaiHoSoModelImpl._originalVaiTroXuLy1 = tthcTrangThaiHoSoModelImpl._vaiTroXuLy1;

		tthcTrangThaiHoSoModelImpl._setOriginalVaiTroXuLy1 = false;

		tthcTrangThaiHoSoModelImpl._originalVaiTroXuLy2 = tthcTrangThaiHoSoModelImpl._vaiTroXuLy2;

		tthcTrangThaiHoSoModelImpl._setOriginalVaiTroXuLy2 = false;

		tthcTrangThaiHoSoModelImpl._originalVaiTroXuLy3 = tthcTrangThaiHoSoModelImpl._vaiTroXuLy3;

		tthcTrangThaiHoSoModelImpl._setOriginalVaiTroXuLy3 = false;

		tthcTrangThaiHoSoModelImpl._columnBitmask = 0;
	}

	@Override
	public CacheModel<TthcTrangThaiHoSo> toCacheModel() {
		TthcTrangThaiHoSoCacheModel tthcTrangThaiHoSoCacheModel = new TthcTrangThaiHoSoCacheModel();

		tthcTrangThaiHoSoCacheModel.id = getId();

		tthcTrangThaiHoSoCacheModel.quyTrinhThuTucId = getQuyTrinhThuTucId();

		tthcTrangThaiHoSoCacheModel.maTrangThai = getMaTrangThai();

		String maTrangThai = tthcTrangThaiHoSoCacheModel.maTrangThai;

		if ((maTrangThai != null) && (maTrangThai.length() == 0)) {
			tthcTrangThaiHoSoCacheModel.maTrangThai = null;
		}

		tthcTrangThaiHoSoCacheModel.tenTrangThai = getTenTrangThai();

		String tenTrangThai = tthcTrangThaiHoSoCacheModel.tenTrangThai;

		if ((tenTrangThai != null) && (tenTrangThai.length() == 0)) {
			tthcTrangThaiHoSoCacheModel.tenTrangThai = null;
		}

		tthcTrangThaiHoSoCacheModel.tenTiengAnh = getTenTiengAnh();

		String tenTiengAnh = tthcTrangThaiHoSoCacheModel.tenTiengAnh;

		if ((tenTiengAnh != null) && (tenTiengAnh.length() == 0)) {
			tthcTrangThaiHoSoCacheModel.tenTiengAnh = null;
		}

		tthcTrangThaiHoSoCacheModel.soThuTu = getSoThuTu();

		tthcTrangThaiHoSoCacheModel.trangThaiKetThuc = getTrangThaiKetThuc();

		tthcTrangThaiHoSoCacheModel.moTaTrangThai = getMoTaTrangThai();

		String moTaTrangThai = tthcTrangThaiHoSoCacheModel.moTaTrangThai;

		if ((moTaTrangThai != null) && (moTaTrangThai.length() == 0)) {
			tthcTrangThaiHoSoCacheModel.moTaTrangThai = null;
		}

		tthcTrangThaiHoSoCacheModel.vaiTroXuLy1 = getVaiTroXuLy1();

		tthcTrangThaiHoSoCacheModel.vaiTroXuLy2 = getVaiTroXuLy2();

		tthcTrangThaiHoSoCacheModel.vaiTroXuLy3 = getVaiTroXuLy3();

		tthcTrangThaiHoSoCacheModel.formXuLy = getFormXuLy();

		String formXuLy = tthcTrangThaiHoSoCacheModel.formXuLy;

		if ((formXuLy != null) && (formXuLy.length() == 0)) {
			tthcTrangThaiHoSoCacheModel.formXuLy = null;
		}

		return tthcTrangThaiHoSoCacheModel;
	}
	...
	private static ClassLoader _classLoader = TthcTrangThaiHoSo.class.getClassLoader();
	private static Class<?>[] _escapedModelInterfaces = new Class[] {
			TthcTrangThaiHoSo.class
		};
	private long _id;
	...
	private TthcTrangThaiHoSo _escapedModel;
}