...
/**
 * Provides the local service interface for TthcBieuMauHoSo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see TthcBieuMauHoSoLocalServiceUtil
 * @see vn.dtt.duongbo.dao.common.service.base.TthcBieuMauHoSoLocalServiceBaseImpl
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcBieuMauHoSoLocalServiceImpl
 * @generated
 */
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface TthcBieuMauHoSoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TthcBieuMauHoSoLocalServiceUtil} to access the tthc bieu mau ho so local service. Add custom service methods to {@link vn.dtt.duongbo.dao.common.service.impl.TthcBieuMauHoSoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
