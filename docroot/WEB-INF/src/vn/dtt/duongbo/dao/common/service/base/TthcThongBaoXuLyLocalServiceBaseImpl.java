...
import vn.dtt.duongbo.dao.common.service.TthcThongBaoXuLyLocalService;
...
/**
 * Provides the base implementation for the tthc thong bao xu ly local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcThongBaoXuLyLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcThongBaoXuLyLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.TthcThongBaoXuLyLocalServiceUtil
 * @generated
 */
public abstract class TthcThongBaoXuLyLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcThongBaoXuLyLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcThongBaoXuLyLocalServiceUtil} to access the tthc thong bao xu ly local service.
	 */
	...
	@Override
	public TthcThongBaoXuLy addTthcThongBaoXuLy(
		TthcThongBaoXuLy tthcThongBaoXuLy) throws SystemException {
		tthcThongBaoXuLy.setNew(true);

		return tthcThongBaoXuLyPersistence.update(tthcThongBaoXuLy);
	}
	 ...
	 */
	@Override
	public TthcThongBaoXuLy createTthcThongBaoXuLy(long id) {
		return tthcThongBaoXuLyPersistence.create(id);
	}
	...
	@Override
	public TthcThongBaoXuLy deleteTthcThongBaoXuLy(long id)
		throws PortalException, SystemException {
		return tthcThongBaoXuLyPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcThongBaoXuLy deleteTthcThongBaoXuLy(
		TthcThongBaoXuLy tthcThongBaoXuLy) throws SystemException {
		return tthcThongBaoXuLyPersistence.remove(tthcThongBaoXuLy);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcThongBaoXuLy.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tthcThongBaoXuLyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcThongBaoXuLyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcThongBaoXuLy fetchTthcThongBaoXuLy(long id)
		throws SystemException {
		return tthcThongBaoXuLyPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcThongBaoXuLy getTthcThongBaoXuLy(long id)
		throws PortalException, SystemException {
		return tthcThongBaoXuLyPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcThongBaoXuLyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcThongBaoXuLy> getTthcThongBaoXuLies(int start, int end)
		throws SystemException {
		return tthcThongBaoXuLyPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcThongBaoXuLiesCount() throws SystemException {
		return tthcThongBaoXuLyPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcThongBaoXuLy updateTthcThongBaoXuLy(
		TthcThongBaoXuLy tthcThongBaoXuLy) throws SystemException {
		return tthcThongBaoXuLyPersistence.update(tthcThongBaoXuLy);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcThongBaoXuLy",
			tthcThongBaoXuLyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.TthcThongBaoXuLy");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcThongBaoXuLyPersistence.getDataSource();
	...
	private TthcThongBaoXuLyLocalServiceClpInvoker _clpInvoker = new TthcThongBaoXuLyLocalServiceClpInvoker();
}