 ...
 * @generated
 */
public class QlvtPhuongTienDangKyVietTrungSoap implements Serializable {
	public static QlvtPhuongTienDangKyVietTrungSoap toSoapModel(
		QlvtPhuongTienDangKyVietTrung model) {
		QlvtPhuongTienDangKyVietTrungSoap soapModel = new QlvtPhuongTienDangKyVietTrungSoap();
		...
		soapModel.setLoaiXe(model.getLoaiXe());
		...
		soapModel.setHanhTrinhDeNghi(model.getHanhTrinhDeNghi());
		soapModel.setSoGiayPhepBiMatHong(model.getSoGiayPhepBiMatHong());
		soapModel.setDiemDungDoDangKy(model.getDiemDungDoDangKy());
	...
	public static QlvtPhuongTienDangKyVietTrungSoap[] toSoapModels(
		QlvtPhuongTienDangKyVietTrung[] models) {
		QlvtPhuongTienDangKyVietTrungSoap[] soapModels = new QlvtPhuongTienDangKyVietTrungSoap[models.length];
	...
	public static QlvtPhuongTienDangKyVietTrungSoap[][] toSoapModels(
		QlvtPhuongTienDangKyVietTrung[][] models) {
		QlvtPhuongTienDangKyVietTrungSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new QlvtPhuongTienDangKyVietTrungSoap[models.length][models[0].length];
		}
		else {
			soapModels = new QlvtPhuongTienDangKyVietTrungSoap[0][0];
		}
	...
	public static QlvtPhuongTienDangKyVietTrungSoap[] toSoapModels(
		List<QlvtPhuongTienDangKyVietTrung> models) {
		List<QlvtPhuongTienDangKyVietTrungSoap> soapModels = new ArrayList<QlvtPhuongTienDangKyVietTrungSoap>(models.size());

		for (QlvtPhuongTienDangKyVietTrung model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new QlvtPhuongTienDangKyVietTrungSoap[soapModels.size()]);
	}

	public QlvtPhuongTienDangKyVietTrungSoap() {
	}
