...
import vn.dtt.duongbo.dao.common.service.DmMetaDataLocalService;
...
/**
 * Provides the base implementation for the dm meta data local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.DmMetaDataLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.DmMetaDataLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.DmMetaDataLocalServiceUtil
 * @generated
 */
public abstract class DmMetaDataLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DmMetaDataLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.DmMetaDataLocalServiceUtil} to access the dm meta data local service.
	 */
	...
	@Override
	public DmMetaData addDmMetaData(DmMetaData dmMetaData)
		throws SystemException {
		dmMetaData.setNew(true);

		return dmMetaDataPersistence.update(dmMetaData);
	}
	 ...
	 */
	@Override
	public DmMetaData createDmMetaData(long id) {
		return dmMetaDataPersistence.create(id);
	}
	...
	@Override
	public DmMetaData deleteDmMetaData(long id)
		throws PortalException, SystemException {
		return dmMetaDataPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DmMetaData deleteDmMetaData(DmMetaData dmMetaData)
		throws SystemException {
		return dmMetaDataPersistence.remove(dmMetaData);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DmMetaData.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmMetaDataPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmMetaDataPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmMetaDataPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DmMetaData fetchDmMetaData(long id) throws SystemException {
		return dmMetaDataPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DmMetaData getDmMetaData(long id)
		throws PortalException, SystemException {
		return dmMetaDataPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmMetaDataPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DmMetaData> getDmMetaDatas(int start, int end)
		throws SystemException {
		return dmMetaDataPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDmMetaDatasCount() throws SystemException {
		return dmMetaDataPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DmMetaData updateDmMetaData(DmMetaData dmMetaData)
		throws SystemException {
		return dmMetaDataPersistence.update(dmMetaData);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.DmMetaData",
			dmMetaDataLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.DmMetaData");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmMetaDataPersistence.getDataSource();
	...
	private DmMetaDataLocalServiceClpInvoker _clpInvoker = new DmMetaDataLocalServiceClpInvoker();
}