...
import vn.dtt.duongbo.dao.common.service.QlvtPhuongTienDangKyVietLaoLocalService;
...
/**
 * Provides the base implementation for the qlvt phuong tien dang ky viet lao local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.QlvtPhuongTienDangKyVietLaoLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.QlvtPhuongTienDangKyVietLaoLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.QlvtPhuongTienDangKyVietLaoLocalServiceUtil
 * @generated
 */
public abstract class QlvtPhuongTienDangKyVietLaoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements QlvtPhuongTienDangKyVietLaoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.QlvtPhuongTienDangKyVietLaoLocalServiceUtil} to access the qlvt phuong tien dang ky viet lao local service.
	 */
	...
	@Override
	public QlvtPhuongTienDangKyVietLao addQlvtPhuongTienDangKyVietLao(
		QlvtPhuongTienDangKyVietLao qlvtPhuongTienDangKyVietLao)
		throws SystemException {
		qlvtPhuongTienDangKyVietLao.setNew(true);

		return qlvtPhuongTienDangKyVietLaoPersistence.update(qlvtPhuongTienDangKyVietLao);
	}
	 ...
	 */
	@Override
	public QlvtPhuongTienDangKyVietLao createQlvtPhuongTienDangKyVietLao(
		long id) {
		return qlvtPhuongTienDangKyVietLaoPersistence.create(id);
	}
	...
	@Override
	public QlvtPhuongTienDangKyVietLao deleteQlvtPhuongTienDangKyVietLao(
		long id) throws PortalException, SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.remove(id);
	}
	...
	public QlvtPhuongTienDangKyVietLao deleteQlvtPhuongTienDangKyVietLao(
		QlvtPhuongTienDangKyVietLao qlvtPhuongTienDangKyVietLao)
		throws SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.remove(qlvtPhuongTienDangKyVietLao);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QlvtPhuongTienDangKyVietLao.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QlvtPhuongTienDangKyVietLao fetchQlvtPhuongTienDangKyVietLao(long id)
		throws SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public QlvtPhuongTienDangKyVietLao getQlvtPhuongTienDangKyVietLao(long id)
		throws PortalException, SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QlvtPhuongTienDangKyVietLao> getQlvtPhuongTienDangKyVietLaos(
		int start, int end) throws SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQlvtPhuongTienDangKyVietLaosCount() throws SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QlvtPhuongTienDangKyVietLao updateQlvtPhuongTienDangKyVietLao(
		QlvtPhuongTienDangKyVietLao qlvtPhuongTienDangKyVietLao)
		throws SystemException {
		return qlvtPhuongTienDangKyVietLaoPersistence.update(qlvtPhuongTienDangKyVietLao);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.QlvtPhuongTienDangKyVietLao",
			qlvtPhuongTienDangKyVietLaoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qlvtPhuongTienDangKyVietLaoPersistence.getDataSource();
	...
	private QlvtPhuongTienDangKyVietLaoLocalServiceClpInvoker _clpInvoker = new QlvtPhuongTienDangKyVietLaoLocalServiceClpInvoker();
}