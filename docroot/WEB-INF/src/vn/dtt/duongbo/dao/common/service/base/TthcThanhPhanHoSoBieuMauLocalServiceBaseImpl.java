...
import vn.dtt.duongbo.dao.common.service.TthcThanhPhanHoSoBieuMauLocalService;
...
/**
 * Provides the base implementation for the tthc thanh phan ho so bieu mau local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcThanhPhanHoSoBieuMauLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcThanhPhanHoSoBieuMauLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.TthcThanhPhanHoSoBieuMauLocalServiceUtil
 * @generated
 */
public abstract class TthcThanhPhanHoSoBieuMauLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcThanhPhanHoSoBieuMauLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcThanhPhanHoSoBieuMauLocalServiceUtil} to access the tthc thanh phan ho so bieu mau local service.
	 */
	...
	@Override
	public TthcThanhPhanHoSoBieuMau addTthcThanhPhanHoSoBieuMau(
		TthcThanhPhanHoSoBieuMau tthcThanhPhanHoSoBieuMau)
		throws SystemException {
		tthcThanhPhanHoSoBieuMau.setNew(true);

		return tthcThanhPhanHoSoBieuMauPersistence.update(tthcThanhPhanHoSoBieuMau);
	}
	 ...
	 */
	@Override
	public TthcThanhPhanHoSoBieuMau createTthcThanhPhanHoSoBieuMau(long id) {
		return tthcThanhPhanHoSoBieuMauPersistence.create(id);
	}
	...
	@Override
	public TthcThanhPhanHoSoBieuMau deleteTthcThanhPhanHoSoBieuMau(long id)
		throws PortalException, SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcThanhPhanHoSoBieuMau deleteTthcThanhPhanHoSoBieuMau(
		TthcThanhPhanHoSoBieuMau tthcThanhPhanHoSoBieuMau)
		throws SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.remove(tthcThanhPhanHoSoBieuMau);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcThanhPhanHoSoBieuMau.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcThanhPhanHoSoBieuMau fetchTthcThanhPhanHoSoBieuMau(long id)
		throws SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcThanhPhanHoSoBieuMau getTthcThanhPhanHoSoBieuMau(long id)
		throws PortalException, SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcThanhPhanHoSoBieuMau> getTthcThanhPhanHoSoBieuMaus(
		int start, int end) throws SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcThanhPhanHoSoBieuMausCount() throws SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcThanhPhanHoSoBieuMau updateTthcThanhPhanHoSoBieuMau(
		TthcThanhPhanHoSoBieuMau tthcThanhPhanHoSoBieuMau)
		throws SystemException {
		return tthcThanhPhanHoSoBieuMauPersistence.update(tthcThanhPhanHoSoBieuMau);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcThanhPhanHoSoBieuMau",
			tthcThanhPhanHoSoBieuMauLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcThanhPhanHoSoBieuMauPersistence.getDataSource();
	...
	private TthcThanhPhanHoSoBieuMauLocalServiceClpInvoker _clpInvoker = new TthcThanhPhanHoSoBieuMauLocalServiceClpInvoker();
}