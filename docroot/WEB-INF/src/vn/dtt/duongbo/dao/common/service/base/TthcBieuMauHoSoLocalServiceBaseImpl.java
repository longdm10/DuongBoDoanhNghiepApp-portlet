...
import vn.dtt.duongbo.dao.common.service.TthcBieuMauHoSoLocalService;
...
/**
 * Provides the base implementation for the tthc bieu mau ho so local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcBieuMauHoSoLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcBieuMauHoSoLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.TthcBieuMauHoSoLocalServiceUtil
 * @generated
 */
public abstract class TthcBieuMauHoSoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcBieuMauHoSoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcBieuMauHoSoLocalServiceUtil} to access the tthc bieu mau ho so local service.
	 */
	...
	@Override
	public TthcBieuMauHoSo addTthcBieuMauHoSo(TthcBieuMauHoSo tthcBieuMauHoSo)
		throws SystemException {
		tthcBieuMauHoSo.setNew(true);

		return tthcBieuMauHoSoPersistence.update(tthcBieuMauHoSo);
	}
	 ...
	 */
	@Override
	public TthcBieuMauHoSo createTthcBieuMauHoSo(long id) {
		return tthcBieuMauHoSoPersistence.create(id);
	}
	...
	@Override
	public TthcBieuMauHoSo deleteTthcBieuMauHoSo(long id)
		throws PortalException, SystemException {
		return tthcBieuMauHoSoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcBieuMauHoSo deleteTthcBieuMauHoSo(
		TthcBieuMauHoSo tthcBieuMauHoSo) throws SystemException {
		return tthcBieuMauHoSoPersistence.remove(tthcBieuMauHoSo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcBieuMauHoSo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcBieuMauHoSoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcBieuMauHoSoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcBieuMauHoSo fetchTthcBieuMauHoSo(long id)
		throws SystemException {
		return tthcBieuMauHoSoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcBieuMauHoSo getTthcBieuMauHoSo(long id)
		throws PortalException, SystemException {
		return tthcBieuMauHoSoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcBieuMauHoSoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcBieuMauHoSo> getTthcBieuMauHoSos(int start, int end)
		throws SystemException {
		return tthcBieuMauHoSoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcBieuMauHoSosCount() throws SystemException {
		return tthcBieuMauHoSoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcBieuMauHoSo updateTthcBieuMauHoSo(
		TthcBieuMauHoSo tthcBieuMauHoSo) throws SystemException {
		return tthcBieuMauHoSoPersistence.update(tthcBieuMauHoSo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcBieuMauHoSo",
			tthcBieuMauHoSoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.TthcBieuMauHoSo");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcBieuMauHoSoPersistence.getDataSource();
	...
	private TthcBieuMauHoSoLocalServiceClpInvoker _clpInvoker = new TthcBieuMauHoSoLocalServiceClpInvoker();
}