...
import vn.dtt.duongbo.dao.common.service.QlvtLoaiHinhHoatDongDnLocalService;
...
/**
 * Provides the base implementation for the qlvt loai hinh hoat dong dn local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.QlvtLoaiHinhHoatDongDnLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class QlvtLoaiHinhHoatDongDnLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements QlvtLoaiHinhHoatDongDnLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.QlvtLoaiHinhHoatDongDnLocalServiceUtil} to access the qlvt loai hinh hoat dong dn local service.
	 */
	...
	@Override
	public QlvtLoaiHinhHoatDongDn addQlvtLoaiHinhHoatDongDn(
		QlvtLoaiHinhHoatDongDn qlvtLoaiHinhHoatDongDn)
		throws SystemException {
		qlvtLoaiHinhHoatDongDn.setNew(true);

		return qlvtLoaiHinhHoatDongDnPersistence.update(qlvtLoaiHinhHoatDongDn);
	}
	 ...
	 */
	@Override
	public QlvtLoaiHinhHoatDongDn createQlvtLoaiHinhHoatDongDn(long id) {
		return qlvtLoaiHinhHoatDongDnPersistence.create(id);
	}
	...
	@Override
	public QlvtLoaiHinhHoatDongDn deleteQlvtLoaiHinhHoatDongDn(long id)
		throws PortalException, SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QlvtLoaiHinhHoatDongDn deleteQlvtLoaiHinhHoatDongDn(
		QlvtLoaiHinhHoatDongDn qlvtLoaiHinhHoatDongDn)
		throws SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.remove(qlvtLoaiHinhHoatDongDn);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QlvtLoaiHinhHoatDongDn.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QlvtLoaiHinhHoatDongDn fetchQlvtLoaiHinhHoatDongDn(long id)
		throws SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public QlvtLoaiHinhHoatDongDn getQlvtLoaiHinhHoatDongDn(long id)
		throws PortalException, SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QlvtLoaiHinhHoatDongDn> getQlvtLoaiHinhHoatDongDns(int start,
		int end) throws SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQlvtLoaiHinhHoatDongDnsCount() throws SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QlvtLoaiHinhHoatDongDn updateQlvtLoaiHinhHoatDongDn(
		QlvtLoaiHinhHoatDongDn qlvtLoaiHinhHoatDongDn)
		throws SystemException {
		return qlvtLoaiHinhHoatDongDnPersistence.update(qlvtLoaiHinhHoatDongDn);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.QlvtLoaiHinhHoatDongDn",
			qlvtLoaiHinhHoatDongDnLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qlvtLoaiHinhHoatDongDnPersistence.getDataSource();
	...
	private QlvtLoaiHinhHoatDongDnLocalServiceClpInvoker _clpInvoker = new QlvtLoaiHinhHoatDongDnLocalServiceClpInvoker();
}