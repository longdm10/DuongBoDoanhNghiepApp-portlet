...
import vn.dtt.duongbo.dao.common.service.TthcDoiTuongThucHienLocalService;
...
/**
 * Provides the base implementation for the tthc doi tuong thuc hien local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcDoiTuongThucHienLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TthcDoiTuongThucHienLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcDoiTuongThucHienLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcDoiTuongThucHienLocalServiceUtil} to access the tthc doi tuong thuc hien local service.
	 */
	...
	@Override
	public TthcDoiTuongThucHien addTthcDoiTuongThucHien(
		TthcDoiTuongThucHien tthcDoiTuongThucHien) throws SystemException {
		tthcDoiTuongThucHien.setNew(true);

		return tthcDoiTuongThucHienPersistence.update(tthcDoiTuongThucHien);
	}
	 ...
	 */
	@Override
	public TthcDoiTuongThucHien createTthcDoiTuongThucHien(long id) {
		return tthcDoiTuongThucHienPersistence.create(id);
	}
	...
	@Override
	public TthcDoiTuongThucHien deleteTthcDoiTuongThucHien(long id)
		throws PortalException, SystemException {
		return tthcDoiTuongThucHienPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcDoiTuongThucHien deleteTthcDoiTuongThucHien(
		TthcDoiTuongThucHien tthcDoiTuongThucHien) throws SystemException {
		return tthcDoiTuongThucHienPersistence.remove(tthcDoiTuongThucHien);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcDoiTuongThucHien.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tthcDoiTuongThucHienPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcDoiTuongThucHienPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcDoiTuongThucHien fetchTthcDoiTuongThucHien(long id)
		throws SystemException {
		return tthcDoiTuongThucHienPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcDoiTuongThucHien getTthcDoiTuongThucHien(long id)
		throws PortalException, SystemException {
		return tthcDoiTuongThucHienPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcDoiTuongThucHienPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcDoiTuongThucHien> getTthcDoiTuongThucHiens(int start,
		int end) throws SystemException {
		return tthcDoiTuongThucHienPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcDoiTuongThucHiensCount() throws SystemException {
		return tthcDoiTuongThucHienPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcDoiTuongThucHien updateTthcDoiTuongThucHien(
		TthcDoiTuongThucHien tthcDoiTuongThucHien) throws SystemException {
		return tthcDoiTuongThucHienPersistence.update(tthcDoiTuongThucHien);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcDoiTuongThucHien",
			tthcDoiTuongThucHienLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.TthcDoiTuongThucHien");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcDoiTuongThucHienPersistence.getDataSource();
	...
	private TthcDoiTuongThucHienLocalServiceClpInvoker _clpInvoker = new TthcDoiTuongThucHienLocalServiceClpInvoker();
}