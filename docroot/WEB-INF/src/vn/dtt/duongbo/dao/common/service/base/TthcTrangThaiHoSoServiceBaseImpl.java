...
import vn.dtt.duongbo.dao.common.service.TthcTrangThaiHoSoService;
...
/**
 * Provides the base implementation for the tthc trang thai ho so remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcTrangThaiHoSoServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcTrangThaiHoSoServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.TthcTrangThaiHoSoServiceUtil
 * @generated
 */
public abstract class TthcTrangThaiHoSoServiceBaseImpl extends BaseServiceImpl
	implements TthcTrangThaiHoSoService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcTrangThaiHoSoServiceUtil} to access the tthc trang thai ho so remote service.
	 */
	...
	private TthcTrangThaiHoSoServiceClpInvoker _clpInvoker = new TthcTrangThaiHoSoServiceClpInvoker();
}