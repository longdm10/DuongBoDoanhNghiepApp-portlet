 ...
 * @generated
 */
public class QlvtDiemDungDangKyVietCamSoap implements Serializable {
	public static QlvtDiemDungDangKyVietCamSoap toSoapModel(
		QlvtDiemDungDangKyVietCam model) {
		QlvtDiemDungDangKyVietCamSoap soapModel = new QlvtDiemDungDangKyVietCamSoap();
	...
	public static QlvtDiemDungDangKyVietCamSoap[] toSoapModels(
		QlvtDiemDungDangKyVietCam[] models) {
		QlvtDiemDungDangKyVietCamSoap[] soapModels = new QlvtDiemDungDangKyVietCamSoap[models.length];
	...
	public static QlvtDiemDungDangKyVietCamSoap[][] toSoapModels(
		QlvtDiemDungDangKyVietCam[][] models) {
		QlvtDiemDungDangKyVietCamSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new QlvtDiemDungDangKyVietCamSoap[models.length][models[0].length];
		}
		else {
			soapModels = new QlvtDiemDungDangKyVietCamSoap[0][0];
		}
	...
	public static QlvtDiemDungDangKyVietCamSoap[] toSoapModels(
		List<QlvtDiemDungDangKyVietCam> models) {
		List<QlvtDiemDungDangKyVietCamSoap> soapModels = new ArrayList<QlvtDiemDungDangKyVietCamSoap>(models.size());

		for (QlvtDiemDungDangKyVietCam model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new QlvtDiemDungDangKyVietCamSoap[soapModels.size()]);
	}

	public QlvtDiemDungDangKyVietCamSoap() {
	}
