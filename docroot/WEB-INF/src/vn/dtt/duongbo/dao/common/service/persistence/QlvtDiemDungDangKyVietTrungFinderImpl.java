...
public class QlvtDiemDungDangKyVietTrungFinderImpl extends BasePersistenceImpl<QlvtDiemDungDangKyVietTrung> implements QlvtDiemDungDangKyVietTrungFinder {
	
	private Log _log = LogFactoryUtil.getLog(QlvtDiemDungDangKyVietTrungFinderImpl.class);
	...
	public List<Long> findIdNoiDungHoSoId(long noiDungHoSoId)
		...
		try {
			if (noiDungHoSoId > 0) {
				...
				query.append("SELECT ID as id FROM qlvt_diemdungdangky_vt WHERE ");
