...
import vn.dtt.duongbo.dao.common.service.DmDataVersionLocalService;
...
/**
 * Provides the base implementation for the dm data version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.DmDataVersionLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.DmDataVersionLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.DmDataVersionLocalServiceUtil
 * @generated
 */
public abstract class DmDataVersionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DmDataVersionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.DmDataVersionLocalServiceUtil} to access the dm data version local service.
	 */

	/**
	 * Adds the dm data version to the database. Also notifies the appropriate model listeners.
	 *
	...
	@Override
	public DmDataVersion addDmDataVersion(DmDataVersion dmDataVersion)
		throws SystemException {
		dmDataVersion.setNew(true);

		return dmDataVersionPersistence.update(dmDataVersion);
	}
	 ...
	 */
	@Override
	public DmDataVersion createDmDataVersion(long id) {
		return dmDataVersionPersistence.create(id);
	}

	/**
	 * Deletes the dm data version with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	...
	@Override
	public DmDataVersion deleteDmDataVersion(long id)
		throws PortalException, SystemException {
		return dmDataVersionPersistence.remove(id);
	}

	/**
	 * Deletes the dm data version from the database. Also notifies the appropriate model listeners.
	 *
	 * @param dmDataVersion the dm data version
	 * @return the dm data version that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DmDataVersion deleteDmDataVersion(DmDataVersion dmDataVersion)
		throws SystemException {
		return dmDataVersionPersistence.remove(dmDataVersion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DmDataVersion.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmDataVersionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmDataVersionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DmDataVersion fetchDmDataVersion(long id) throws SystemException {
		return dmDataVersionPersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the dm data version with the primary key.
	 *
	 * @param id the primary key of the dm data version
	 ...
	 */
	@Override
	public DmDataVersion getDmDataVersion(long id)
		throws PortalException, SystemException {
		return dmDataVersionPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmDataVersionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DmDataVersion> getDmDataVersions(int start, int end)
		throws SystemException {
		return dmDataVersionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDmDataVersionsCount() throws SystemException {
		return dmDataVersionPersistence.countAll();
	}

	/**
	 * Updates the dm data version in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param dmDataVersion the dm data version
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DmDataVersion updateDmDataVersion(DmDataVersion dmDataVersion)
		throws SystemException {
		return dmDataVersionPersistence.update(dmDataVersion);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.DmDataVersion",
			dmDataVersionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.DmDataVersion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmDataVersionPersistence.getDataSource();
	...
	private DmDataVersionLocalServiceClpInvoker _clpInvoker = new DmDataVersionLocalServiceClpInvoker();
}