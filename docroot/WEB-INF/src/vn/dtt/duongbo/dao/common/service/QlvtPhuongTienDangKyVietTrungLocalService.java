...
/**
 * Provides the local service interface for QlvtPhuongTienDangKyVietTrung. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see QlvtPhuongTienDangKyVietTrungLocalServiceUtil
...
public interface QlvtPhuongTienDangKyVietTrungLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtPhuongTienDangKyVietTrungLocalServiceUtil} to access the qlvt phuong tien dang ky viet trung local service. Add custom service methods to {@link vn.dtt.duongbo.dao.common.service.impl.QlvtPhuongTienDangKyVietTrungLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
