...
import vn.dtt.duongbo.dao.common.service.QlvtDiemDungDangKyVietLaoLocalService;
...
/**
 * Provides the base implementation for the qlvt diem dung dang ky viet lao local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.QlvtDiemDungDangKyVietLaoLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.QlvtDiemDungDangKyVietLaoLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.QlvtDiemDungDangKyVietLaoLocalServiceUtil
 * @generated
 */
public abstract class QlvtDiemDungDangKyVietLaoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements QlvtDiemDungDangKyVietLaoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.QlvtDiemDungDangKyVietLaoLocalServiceUtil} to access the qlvt diem dung dang ky viet lao local service.
	 */
	...
	@Override
	public QlvtDiemDungDangKyVietLao addQlvtDiemDungDangKyVietLao(
		QlvtDiemDungDangKyVietLao qlvtDiemDungDangKyVietLao)
		throws SystemException {
		qlvtDiemDungDangKyVietLao.setNew(true);

		return qlvtDiemDungDangKyVietLaoPersistence.update(qlvtDiemDungDangKyVietLao);
	}
	 ...
	 */
	@Override
	public QlvtDiemDungDangKyVietLao createQlvtDiemDungDangKyVietLao(long id) {
		return qlvtDiemDungDangKyVietLaoPersistence.create(id);
	}
	...
	@Override
	public QlvtDiemDungDangKyVietLao deleteQlvtDiemDungDangKyVietLao(long id)
		throws PortalException, SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QlvtDiemDungDangKyVietLao deleteQlvtDiemDungDangKyVietLao(
		QlvtDiemDungDangKyVietLao qlvtDiemDungDangKyVietLao)
		throws SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.remove(qlvtDiemDungDangKyVietLao);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QlvtDiemDungDangKyVietLao.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QlvtDiemDungDangKyVietLao fetchQlvtDiemDungDangKyVietLao(long id)
		throws SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public QlvtDiemDungDangKyVietLao getQlvtDiemDungDangKyVietLao(long id)
		throws PortalException, SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QlvtDiemDungDangKyVietLao> getQlvtDiemDungDangKyVietLaos(
		int start, int end) throws SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQlvtDiemDungDangKyVietLaosCount() throws SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QlvtDiemDungDangKyVietLao updateQlvtDiemDungDangKyVietLao(
		QlvtDiemDungDangKyVietLao qlvtDiemDungDangKyVietLao)
		throws SystemException {
		return qlvtDiemDungDangKyVietLaoPersistence.update(qlvtDiemDungDangKyVietLao);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.QlvtDiemDungDangKyVietLao",
			qlvtDiemDungDangKyVietLaoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.QlvtDiemDungDangKyVietLao");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qlvtDiemDungDangKyVietLaoPersistence.getDataSource();
	...
	private QlvtDiemDungDangKyVietLaoLocalServiceClpInvoker _clpInvoker = new QlvtDiemDungDangKyVietLaoLocalServiceClpInvoker();
}