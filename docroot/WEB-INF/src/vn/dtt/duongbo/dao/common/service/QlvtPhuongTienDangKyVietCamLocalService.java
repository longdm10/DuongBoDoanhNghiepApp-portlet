...
/**
 * Provides the local service interface for QlvtPhuongTienDangKyVietCam. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see QlvtPhuongTienDangKyVietCamLocalServiceUtil
...
public interface QlvtPhuongTienDangKyVietCamLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtPhuongTienDangKyVietCamLocalServiceUtil} to access the qlvt phuong tien dang ky viet cam local service. Add custom service methods to {@link vn.dtt.duongbo.dao.common.service.impl.QlvtPhuongTienDangKyVietCamLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
