...
import vn.dtt.duongbo.dao.common.service.QlvtPhuongTienDangKyVietCamLocalService;
...
/**
 * Provides the base implementation for the qlvt phuong tien dang ky viet cam local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.QlvtPhuongTienDangKyVietCamLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.QlvtPhuongTienDangKyVietCamLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.QlvtPhuongTienDangKyVietCamLocalServiceUtil
 * @generated
 */
public abstract class QlvtPhuongTienDangKyVietCamLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements QlvtPhuongTienDangKyVietCamLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.QlvtPhuongTienDangKyVietCamLocalServiceUtil} to access the qlvt phuong tien dang ky viet cam local service.
	 */
	...
	@Override
	public QlvtPhuongTienDangKyVietCam addQlvtPhuongTienDangKyVietCam(
		QlvtPhuongTienDangKyVietCam qlvtPhuongTienDangKyVietCam)
		throws SystemException {
		qlvtPhuongTienDangKyVietCam.setNew(true);

		return qlvtPhuongTienDangKyVietCamPersistence.update(qlvtPhuongTienDangKyVietCam);
	}
	 ...
	 */
	@Override
	public QlvtPhuongTienDangKyVietCam createQlvtPhuongTienDangKyVietCam(
		long id) {
		return qlvtPhuongTienDangKyVietCamPersistence.create(id);
	}
	...
	@Override
	public QlvtPhuongTienDangKyVietCam deleteQlvtPhuongTienDangKyVietCam(
		long id) throws PortalException, SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.remove(id);
	}
	...
	public QlvtPhuongTienDangKyVietCam deleteQlvtPhuongTienDangKyVietCam(
		QlvtPhuongTienDangKyVietCam qlvtPhuongTienDangKyVietCam)
		throws SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.remove(qlvtPhuongTienDangKyVietCam);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QlvtPhuongTienDangKyVietCam.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QlvtPhuongTienDangKyVietCam fetchQlvtPhuongTienDangKyVietCam(long id)
		throws SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public QlvtPhuongTienDangKyVietCam getQlvtPhuongTienDangKyVietCam(long id)
		throws PortalException, SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QlvtPhuongTienDangKyVietCam> getQlvtPhuongTienDangKyVietCams(
		int start, int end) throws SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQlvtPhuongTienDangKyVietCamsCount() throws SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QlvtPhuongTienDangKyVietCam updateQlvtPhuongTienDangKyVietCam(
		QlvtPhuongTienDangKyVietCam qlvtPhuongTienDangKyVietCam)
		throws SystemException {
		return qlvtPhuongTienDangKyVietCamPersistence.update(qlvtPhuongTienDangKyVietCam);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.QlvtPhuongTienDangKyVietCam",
			qlvtPhuongTienDangKyVietCamLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.QlvtPhuongTienDangKyVietCam");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qlvtPhuongTienDangKyVietCamPersistence.getDataSource();
	...
	private QlvtPhuongTienDangKyVietCamLocalServiceClpInvoker _clpInvoker = new QlvtPhuongTienDangKyVietCamLocalServiceClpInvoker();
}