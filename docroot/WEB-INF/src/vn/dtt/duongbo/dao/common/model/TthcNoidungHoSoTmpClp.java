 ...
 * @author win_64
 */
public class TthcNoidungHoSoTmpClp extends BaseModelImpl<TthcNoidungHoSoTmp>
	implements TthcNoidungHoSoTmp {
	public TthcNoidungHoSoTmpClp() {
	}
	...
	public void setId(long id) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				Class<?> clazz = _tthcNoidungHoSoTmpRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_tthcNoidungHoSoTmpRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setMaTuSinh(String maTuSinh) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, maTuSinh);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setHoSoThuTucId(long hoSoThuTucId) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, hoSoThuTucId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setThanhPhanHoSoId(long thanhPhanHoSoId) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, thanhPhanHoSoId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTenTaiLieu(String tenTaiLieu) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, tenTaiLieu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTaiLieuDinhKem(long taiLieuDinhKem) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, taiLieuDinhKem);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNoiDungXml(String noiDungXml) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, noiDungXml);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNoiDungHtml(String noiDungHtml) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, noiDungHtml);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setBieuMauHoSoId(long bieuMauHoSoId) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, bieuMauHoSoId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgayGuiNhan(Date ngayGuiNhan) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, ngayGuiNhan);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setLoaiTaiLieu(long loaiTaiLieu) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, loaiTaiLieu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgayTao(Date ngayTao) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, ngayTao);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNguoiTao(long nguoiTao) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, nguoiTao);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTrangThai(long trangThai) {
		...
		if (_tthcNoidungHoSoTmpRemoteModel != null) {
			try {
				...
				method.invoke(_tthcNoidungHoSoTmpRemoteModel, trangThai);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getTthcNoidungHoSoTmpRemoteModel() {
		return _tthcNoidungHoSoTmpRemoteModel;
	}

	public void setTthcNoidungHoSoTmpRemoteModel(
		BaseModel<?> tthcNoidungHoSoTmpRemoteModel) {
		_tthcNoidungHoSoTmpRemoteModel = tthcNoidungHoSoTmpRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _tthcNoidungHoSoTmpRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_tthcNoidungHoSoTmpRemoteModel,
	...
	public void persist() throws SystemException {
		if (this.isNew()) {
			TthcNoidungHoSoTmpLocalServiceUtil.addTthcNoidungHoSoTmp(this);
		}
		else {
			TthcNoidungHoSoTmpLocalServiceUtil.updateTthcNoidungHoSoTmp(this);
		}
	}

	@Override
	public TthcNoidungHoSoTmp toEscapedModel() {
		return (TthcNoidungHoSoTmp)ProxyUtil.newProxyInstance(TthcNoidungHoSoTmp.class.getClassLoader(),
			new Class[] { TthcNoidungHoSoTmp.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		TthcNoidungHoSoTmpClp clone = new TthcNoidungHoSoTmpClp();
	...
	public int compareTo(TthcNoidungHoSoTmp tthcNoidungHoSoTmp) {
		...
		if (getId() < tthcNoidungHoSoTmp.getId()) {
			value = -1;
		}
		else if (getId() > tthcNoidungHoSoTmp.getId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TthcNoidungHoSoTmpClp)) {
			return false;
		}

		TthcNoidungHoSoTmpClp tthcNoidungHoSoTmp = (TthcNoidungHoSoTmpClp)obj;

		long primaryKey = tthcNoidungHoSoTmp.getPrimaryKey();
	...
	public String toXmlString() {
		...
		sb.append("vn.dtt.duongbo.dao.common.model.TthcNoidungHoSoTmp");
	...
	private BaseModel<?> _tthcNoidungHoSoTmpRemoteModel;
}