 ...
 * @author win_64
 */
public class QlvtDiemDungDangKyVietLaoClp extends BaseModelImpl<QlvtDiemDungDangKyVietLao>
	implements QlvtDiemDungDangKyVietLao {
	public QlvtDiemDungDangKyVietLaoClp() {
	}
	...
	public void setId(long id) {
		...
		if (_qlvtDiemDungDangKyVietLaoRemoteModel != null) {
			try {
				Class<?> clazz = _qlvtDiemDungDangKyVietLaoRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_qlvtDiemDungDangKyVietLaoRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setPhuongTienDangKyId(String PhuongTienDangKyId) {
		...
		if (_qlvtDiemDungDangKyVietLaoRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtDiemDungDangKyVietLaoRemoteModel,
					PhuongTienDangKyId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
	...
	public void setMaDiemDung(long MaDiemDung) {
		...
		if (_qlvtDiemDungDangKyVietLaoRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtDiemDungDangKyVietLaoRemoteModel, MaDiemDung);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTenDiemDung(long TenDiemDung) {
		...
		if (_qlvtDiemDungDangKyVietLaoRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtDiemDungDangKyVietLaoRemoteModel, TenDiemDung);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getQlvtDiemDungDangKyVietLaoRemoteModel() {
		return _qlvtDiemDungDangKyVietLaoRemoteModel;
	}

	public void setQlvtDiemDungDangKyVietLaoRemoteModel(
		BaseModel<?> qlvtDiemDungDangKyVietLaoRemoteModel) {
		_qlvtDiemDungDangKyVietLaoRemoteModel = qlvtDiemDungDangKyVietLaoRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _qlvtDiemDungDangKyVietLaoRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_qlvtDiemDungDangKyVietLaoRemoteModel,
	...
	public QlvtDiemDungDangKyVietLao toEscapedModel() {
		return (QlvtDiemDungDangKyVietLao)ProxyUtil.newProxyInstance(QlvtDiemDungDangKyVietLao.class.getClassLoader(),
			new Class[] { QlvtDiemDungDangKyVietLao.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		QlvtDiemDungDangKyVietLaoClp clone = new QlvtDiemDungDangKyVietLaoClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof QlvtDiemDungDangKyVietLaoClp)) {
			return false;
		}

		QlvtDiemDungDangKyVietLaoClp qlvtDiemDungDangKyVietLao = (QlvtDiemDungDangKyVietLaoClp)obj;
	...
	private BaseModel<?> _qlvtDiemDungDangKyVietLaoRemoteModel;
}