...
import vn.dtt.duongbo.dao.common.service.TthcLinhVucThuTucLocalService;
...
/**
 * Provides the base implementation for the tthc linh vuc thu tuc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcLinhVucThuTucLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcLinhVucThuTucLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.TthcLinhVucThuTucLocalServiceUtil
 * @generated
 */
public abstract class TthcLinhVucThuTucLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcLinhVucThuTucLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcLinhVucThuTucLocalServiceUtil} to access the tthc linh vuc thu tuc local service.
	 */
	...
	@Override
	public TthcLinhVucThuTuc addTthcLinhVucThuTuc(
		TthcLinhVucThuTuc tthcLinhVucThuTuc) throws SystemException {
		tthcLinhVucThuTuc.setNew(true);

		return tthcLinhVucThuTucPersistence.update(tthcLinhVucThuTuc);
	}
	 ...
	 */
	@Override
	public TthcLinhVucThuTuc createTthcLinhVucThuTuc(long id) {
		return tthcLinhVucThuTucPersistence.create(id);
	}
	...
	@Override
	public TthcLinhVucThuTuc deleteTthcLinhVucThuTuc(long id)
		throws PortalException, SystemException {
		return tthcLinhVucThuTucPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcLinhVucThuTuc deleteTthcLinhVucThuTuc(
		TthcLinhVucThuTuc tthcLinhVucThuTuc) throws SystemException {
		return tthcLinhVucThuTucPersistence.remove(tthcLinhVucThuTuc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcLinhVucThuTuc.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tthcLinhVucThuTucPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcLinhVucThuTucPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcLinhVucThuTuc fetchTthcLinhVucThuTuc(long id)
		throws SystemException {
		return tthcLinhVucThuTucPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcLinhVucThuTuc getTthcLinhVucThuTuc(long id)
		throws PortalException, SystemException {
		return tthcLinhVucThuTucPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcLinhVucThuTucPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcLinhVucThuTuc> getTthcLinhVucThuTucs(int start, int end)
		throws SystemException {
		return tthcLinhVucThuTucPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcLinhVucThuTucsCount() throws SystemException {
		return tthcLinhVucThuTucPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcLinhVucThuTuc updateTthcLinhVucThuTuc(
		TthcLinhVucThuTuc tthcLinhVucThuTuc) throws SystemException {
		return tthcLinhVucThuTucPersistence.update(tthcLinhVucThuTuc);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcLinhVucThuTuc",
			tthcLinhVucThuTucLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.TthcLinhVucThuTuc");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcLinhVucThuTucPersistence.getDataSource();
	...
	private TthcLinhVucThuTucLocalServiceClpInvoker _clpInvoker = new TthcLinhVucThuTucLocalServiceClpInvoker();
}