...
import vn.dtt.duongbo.dao.common.service.TthcDonViThucHienLocalService;
...
/**
 * Provides the base implementation for the tthc don vi thuc hien local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcDonViThucHienLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcDonViThucHienLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.TthcDonViThucHienLocalServiceUtil
 * @generated
 */
public abstract class TthcDonViThucHienLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcDonViThucHienLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcDonViThucHienLocalServiceUtil} to access the tthc don vi thuc hien local service.
	 */
	...
	@Override
	public TthcDonViThucHien addTthcDonViThucHien(
		TthcDonViThucHien tthcDonViThucHien) throws SystemException {
		tthcDonViThucHien.setNew(true);

		return tthcDonViThucHienPersistence.update(tthcDonViThucHien);
	}
	 ...
	 */
	@Override
	public TthcDonViThucHien createTthcDonViThucHien(long id) {
		return tthcDonViThucHienPersistence.create(id);
	}
	...
	@Override
	public TthcDonViThucHien deleteTthcDonViThucHien(long id)
		throws PortalException, SystemException {
		return tthcDonViThucHienPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcDonViThucHien deleteTthcDonViThucHien(
		TthcDonViThucHien tthcDonViThucHien) throws SystemException {
		return tthcDonViThucHienPersistence.remove(tthcDonViThucHien);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcDonViThucHien.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tthcDonViThucHienPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcDonViThucHienPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcDonViThucHien fetchTthcDonViThucHien(long id)
		throws SystemException {
		return tthcDonViThucHienPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcDonViThucHien getTthcDonViThucHien(long id)
		throws PortalException, SystemException {
		return tthcDonViThucHienPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcDonViThucHienPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcDonViThucHien> getTthcDonViThucHiens(int start, int end)
		throws SystemException {
		return tthcDonViThucHienPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcDonViThucHiensCount() throws SystemException {
		return tthcDonViThucHienPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcDonViThucHien updateTthcDonViThucHien(
		TthcDonViThucHien tthcDonViThucHien) throws SystemException {
		return tthcDonViThucHienPersistence.update(tthcDonViThucHien);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcDonViThucHien",
			tthcDonViThucHienLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.TthcDonViThucHien");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcDonViThucHienPersistence.getDataSource();
	...
	private TthcDonViThucHienLocalServiceClpInvoker _clpInvoker = new TthcDonViThucHienLocalServiceClpInvoker();
}