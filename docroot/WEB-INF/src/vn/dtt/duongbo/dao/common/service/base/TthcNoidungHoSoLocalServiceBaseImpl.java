...
import vn.dtt.duongbo.dao.common.service.TthcNoidungHoSoLocalService;
...
/**
 * Provides the base implementation for the tthc noidung ho so local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcNoidungHoSoLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TthcNoidungHoSoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcNoidungHoSoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcNoidungHoSoLocalServiceUtil} to access the tthc noidung ho so local service.
	 */
	...
	@Override
	public TthcNoidungHoSo addTthcNoidungHoSo(TthcNoidungHoSo tthcNoidungHoSo)
		throws SystemException {
		tthcNoidungHoSo.setNew(true);

		return tthcNoidungHoSoPersistence.update(tthcNoidungHoSo);
	}
	 ...
	 */
	@Override
	public TthcNoidungHoSo createTthcNoidungHoSo(long id) {
		return tthcNoidungHoSoPersistence.create(id);
	}
	...
	@Override
	public TthcNoidungHoSo deleteTthcNoidungHoSo(long id)
		throws PortalException, SystemException {
		return tthcNoidungHoSoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcNoidungHoSo deleteTthcNoidungHoSo(
		TthcNoidungHoSo tthcNoidungHoSo) throws SystemException {
		return tthcNoidungHoSoPersistence.remove(tthcNoidungHoSo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcNoidungHoSo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcNoidungHoSoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcNoidungHoSoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcNoidungHoSo fetchTthcNoidungHoSo(long id)
		throws SystemException {
		return tthcNoidungHoSoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcNoidungHoSo getTthcNoidungHoSo(long id)
		throws PortalException, SystemException {
		return tthcNoidungHoSoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcNoidungHoSoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcNoidungHoSo> getTthcNoidungHoSos(int start, int end)
		throws SystemException {
		return tthcNoidungHoSoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcNoidungHoSosCount() throws SystemException {
		return tthcNoidungHoSoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcNoidungHoSo updateTthcNoidungHoSo(
		TthcNoidungHoSo tthcNoidungHoSo) throws SystemException {
		return tthcNoidungHoSoPersistence.update(tthcNoidungHoSo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcNoidungHoSo",
			tthcNoidungHoSoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcNoidungHoSoPersistence.getDataSource();
	...
	private TthcNoidungHoSoLocalServiceClpInvoker _clpInvoker = new TthcNoidungHoSoLocalServiceClpInvoker();
}