...
/**
 * Provides the base implementation for the tthc thanh phan ho so local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcThanhPhanHoSoLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcThanhPhanHoSoLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.TthcThanhPhanHoSoLocalServiceUtil
 * @generated
 */
public abstract class TthcThanhPhanHoSoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcThanhPhanHoSoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcThanhPhanHoSoLocalServiceUtil} to access the tthc thanh phan ho so local service.
	 */
	...
	@Override
	public TthcThanhPhanHoSo addTthcThanhPhanHoSo(
		TthcThanhPhanHoSo tthcThanhPhanHoSo) throws SystemException {
		tthcThanhPhanHoSo.setNew(true);

		return tthcThanhPhanHoSoPersistence.update(tthcThanhPhanHoSo);
	}
	 ...
	 */
	@Override
	public TthcThanhPhanHoSo createTthcThanhPhanHoSo(long id) {
		return tthcThanhPhanHoSoPersistence.create(id);
	}
	...
	@Override
	public TthcThanhPhanHoSo deleteTthcThanhPhanHoSo(long id)
		throws PortalException, SystemException {
		return tthcThanhPhanHoSoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcThanhPhanHoSo deleteTthcThanhPhanHoSo(
		TthcThanhPhanHoSo tthcThanhPhanHoSo) throws SystemException {
		return tthcThanhPhanHoSoPersistence.remove(tthcThanhPhanHoSo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcThanhPhanHoSo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tthcThanhPhanHoSoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcThanhPhanHoSoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcThanhPhanHoSo fetchTthcThanhPhanHoSo(long id)
		throws SystemException {
		return tthcThanhPhanHoSoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcThanhPhanHoSo getTthcThanhPhanHoSo(long id)
		throws PortalException, SystemException {
		return tthcThanhPhanHoSoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcThanhPhanHoSoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcThanhPhanHoSo> getTthcThanhPhanHoSos(int start, int end)
		throws SystemException {
		return tthcThanhPhanHoSoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcThanhPhanHoSosCount() throws SystemException {
		return tthcThanhPhanHoSoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcThanhPhanHoSo updateTthcThanhPhanHoSo(
		TthcThanhPhanHoSo tthcThanhPhanHoSo) throws SystemException {
		return tthcThanhPhanHoSoPersistence.update(tthcThanhPhanHoSo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcThanhPhanHoSo",
			tthcThanhPhanHoSoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcThanhPhanHoSoPersistence.getDataSource();
	...
	private TthcThanhPhanHoSoLocalServiceClpInvoker _clpInvoker = new TthcThanhPhanHoSoLocalServiceClpInvoker();
}