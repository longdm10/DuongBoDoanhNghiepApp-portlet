 ...
 * @generated
 */
public class QlvtPhuongTienDangKyVietCamSoap implements Serializable {
	public static QlvtPhuongTienDangKyVietCamSoap toSoapModel(
		QlvtPhuongTienDangKyVietCam model) {
		QlvtPhuongTienDangKyVietCamSoap soapModel = new QlvtPhuongTienDangKyVietCamSoap();
	...
	public static QlvtPhuongTienDangKyVietCamSoap[] toSoapModels(
		QlvtPhuongTienDangKyVietCam[] models) {
		QlvtPhuongTienDangKyVietCamSoap[] soapModels = new QlvtPhuongTienDangKyVietCamSoap[models.length];
	...
	public static QlvtPhuongTienDangKyVietCamSoap[][] toSoapModels(
		QlvtPhuongTienDangKyVietCam[][] models) {
		QlvtPhuongTienDangKyVietCamSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new QlvtPhuongTienDangKyVietCamSoap[models.length][models[0].length];
		}
		else {
			soapModels = new QlvtPhuongTienDangKyVietCamSoap[0][0];
		}
	...
	public static QlvtPhuongTienDangKyVietCamSoap[] toSoapModels(
		List<QlvtPhuongTienDangKyVietCam> models) {
		List<QlvtPhuongTienDangKyVietCamSoap> soapModels = new ArrayList<QlvtPhuongTienDangKyVietCamSoap>(models.size());

		for (QlvtPhuongTienDangKyVietCam model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new QlvtPhuongTienDangKyVietCamSoap[soapModels.size()]);
	}

	public QlvtPhuongTienDangKyVietCamSoap() {
	}
