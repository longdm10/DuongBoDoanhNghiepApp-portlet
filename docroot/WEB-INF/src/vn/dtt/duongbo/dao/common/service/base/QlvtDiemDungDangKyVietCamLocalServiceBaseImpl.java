...
import vn.dtt.duongbo.dao.common.service.QlvtDiemDungDangKyVietCamLocalService;
...
/**
 * Provides the base implementation for the qlvt diem dung dang ky viet cam local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.QlvtDiemDungDangKyVietCamLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.QlvtDiemDungDangKyVietCamLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.QlvtDiemDungDangKyVietCamLocalServiceUtil
 * @generated
 */
public abstract class QlvtDiemDungDangKyVietCamLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements QlvtDiemDungDangKyVietCamLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.QlvtDiemDungDangKyVietCamLocalServiceUtil} to access the qlvt diem dung dang ky viet cam local service.
	 */
	...
	@Override
	public QlvtDiemDungDangKyVietCam addQlvtDiemDungDangKyVietCam(
		QlvtDiemDungDangKyVietCam qlvtDiemDungDangKyVietCam)
		throws SystemException {
		qlvtDiemDungDangKyVietCam.setNew(true);

		return qlvtDiemDungDangKyVietCamPersistence.update(qlvtDiemDungDangKyVietCam);
	}
	 ...
	 */
	@Override
	public QlvtDiemDungDangKyVietCam createQlvtDiemDungDangKyVietCam(long id) {
		return qlvtDiemDungDangKyVietCamPersistence.create(id);
	}
	...
	@Override
	public QlvtDiemDungDangKyVietCam deleteQlvtDiemDungDangKyVietCam(long id)
		throws PortalException, SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QlvtDiemDungDangKyVietCam deleteQlvtDiemDungDangKyVietCam(
		QlvtDiemDungDangKyVietCam qlvtDiemDungDangKyVietCam)
		throws SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.remove(qlvtDiemDungDangKyVietCam);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QlvtDiemDungDangKyVietCam.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QlvtDiemDungDangKyVietCam fetchQlvtDiemDungDangKyVietCam(long id)
		throws SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public QlvtDiemDungDangKyVietCam getQlvtDiemDungDangKyVietCam(long id)
		throws PortalException, SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QlvtDiemDungDangKyVietCam> getQlvtDiemDungDangKyVietCams(
		int start, int end) throws SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQlvtDiemDungDangKyVietCamsCount() throws SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QlvtDiemDungDangKyVietCam updateQlvtDiemDungDangKyVietCam(
		QlvtDiemDungDangKyVietCam qlvtDiemDungDangKyVietCam)
		throws SystemException {
		return qlvtDiemDungDangKyVietCamPersistence.update(qlvtDiemDungDangKyVietCam);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.QlvtDiemDungDangKyVietCam",
			qlvtDiemDungDangKyVietCamLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.QlvtDiemDungDangKyVietCam");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qlvtDiemDungDangKyVietCamPersistence.getDataSource();
	...
	private QlvtDiemDungDangKyVietCamLocalServiceClpInvoker _clpInvoker = new QlvtDiemDungDangKyVietCamLocalServiceClpInvoker();
}