...
import vn.dtt.duongbo.dao.common.service.TthcPhanNhomHoSoVaiTroLocalService;
...
/**
 * Provides the base implementation for the tthc phan nhom ho so vai tro local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcPhanNhomHoSoVaiTroLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcPhanNhomHoSoVaiTroLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.TthcPhanNhomHoSoVaiTroLocalServiceUtil
 * @generated
 */
public abstract class TthcPhanNhomHoSoVaiTroLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcPhanNhomHoSoVaiTroLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcPhanNhomHoSoVaiTroLocalServiceUtil} to access the tthc phan nhom ho so vai tro local service.
	 */
	...
	@Override
	public TthcPhanNhomHoSoVaiTro addTthcPhanNhomHoSoVaiTro(
		TthcPhanNhomHoSoVaiTro tthcPhanNhomHoSoVaiTro)
		throws SystemException {
		tthcPhanNhomHoSoVaiTro.setNew(true);

		return tthcPhanNhomHoSoVaiTroPersistence.update(tthcPhanNhomHoSoVaiTro);
	}
	 ...
	 */
	@Override
	public TthcPhanNhomHoSoVaiTro createTthcPhanNhomHoSoVaiTro(long id) {
		return tthcPhanNhomHoSoVaiTroPersistence.create(id);
	}
	...
	@Override
	public TthcPhanNhomHoSoVaiTro deleteTthcPhanNhomHoSoVaiTro(long id)
		throws PortalException, SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcPhanNhomHoSoVaiTro deleteTthcPhanNhomHoSoVaiTro(
		TthcPhanNhomHoSoVaiTro tthcPhanNhomHoSoVaiTro)
		throws SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.remove(tthcPhanNhomHoSoVaiTro);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcPhanNhomHoSoVaiTro.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcPhanNhomHoSoVaiTro fetchTthcPhanNhomHoSoVaiTro(long id)
		throws SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcPhanNhomHoSoVaiTro getTthcPhanNhomHoSoVaiTro(long id)
		throws PortalException, SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcPhanNhomHoSoVaiTro> getTthcPhanNhomHoSoVaiTros(int start,
		int end) throws SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcPhanNhomHoSoVaiTrosCount() throws SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcPhanNhomHoSoVaiTro updateTthcPhanNhomHoSoVaiTro(
		TthcPhanNhomHoSoVaiTro tthcPhanNhomHoSoVaiTro)
		throws SystemException {
		return tthcPhanNhomHoSoVaiTroPersistence.update(tthcPhanNhomHoSoVaiTro);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcPhanNhomHoSoVaiTro",
			tthcPhanNhomHoSoVaiTroLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.TthcPhanNhomHoSoVaiTro");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcPhanNhomHoSoVaiTroPersistence.getDataSource();
	...
	private TthcPhanNhomHoSoVaiTroLocalServiceClpInvoker _clpInvoker = new TthcPhanNhomHoSoVaiTroLocalServiceClpInvoker();
}