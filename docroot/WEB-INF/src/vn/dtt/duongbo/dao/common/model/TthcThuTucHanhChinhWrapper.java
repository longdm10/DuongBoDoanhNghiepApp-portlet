...
public class TthcThuTucHanhChinhWrapper implements TthcThuTucHanhChinh,
	...
	*/
	...
	/**
	* Returns the co quan qltt of this tthc thu tuc hanh chinh.
	*
	* @return the co quan qltt of this tthc thu tuc hanh chinh
	*/
	@Override
	public java.lang.String getCoQuanQltt() {
		return _tthcThuTucHanhChinh.getCoQuanQltt();
	}

	/**
	* Sets the co quan qltt of this tthc thu tuc hanh chinh.
	*
	* @param coQuanQltt the co quan qltt of this tthc thu tuc hanh chinh
	*/
	@Override
	public void setCoQuanQltt(java.lang.String coQuanQltt) {
		_tthcThuTucHanhChinh.setCoQuanQltt(coQuanQltt);
	}

	/**
	* Returns the linh vuc thu tuc of this tthc thu tuc hanh chinh.
	*
	* @return the linh vuc thu tuc of this tthc thu tuc hanh chinh
	*/
	@Override
	public java.lang.String getLinhVucThuTuc() {
		return _tthcThuTucHanhChinh.getLinhVucThuTuc();
	}

	/**
	* Sets the linh vuc thu tuc of this tthc thu tuc hanh chinh.
	*
	* @param linhVucThuTuc the linh vuc thu tuc of this tthc thu tuc hanh chinh
	*/
	@Override
	public void setLinhVucThuTuc(java.lang.String linhVucThuTuc) {
		_tthcThuTucHanhChinh.setLinhVucThuTuc(linhVucThuTuc);
	}
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<vn.dtt.duongbo.dao.common.model.TthcThuTucHanhChinh> toCacheModel() {
		return _tthcThuTucHanhChinh.toCacheModel();
	}

	@Override
	public vn.dtt.duongbo.dao.common.model.TthcThuTucHanhChinh toEscapedModel() {
		return new TthcThuTucHanhChinhWrapper(_tthcThuTucHanhChinh.toEscapedModel());
	}

	@Override
	public vn.dtt.duongbo.dao.common.model.TthcThuTucHanhChinh toUnescapedModel() {
