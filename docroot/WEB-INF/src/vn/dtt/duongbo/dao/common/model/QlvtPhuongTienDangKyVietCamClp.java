 ...
 * @author win_64
 */
public class QlvtPhuongTienDangKyVietCamClp extends BaseModelImpl<QlvtPhuongTienDangKyVietCam>
	implements QlvtPhuongTienDangKyVietCam {
	public QlvtPhuongTienDangKyVietCamClp() {
	}
	...
	public void setId(long id) {
		...
		if (_qlvtPhuongTienDangKyVietCamRemoteModel != null) {
			try {
				Class<?> clazz = _qlvtPhuongTienDangKyVietCamRemoteModel.getClass();

				Method method = clazz.getMethod("setId", long.class);

				method.invoke(_qlvtPhuongTienDangKyVietCamRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setBienSo(String BienSo) {
		...
		if (_qlvtPhuongTienDangKyVietCamRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtPhuongTienDangKyVietCamRemoteModel, BienSo);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTenDangKySoHuu(String TenDangKySoHuu) {
		...
		if (_qlvtPhuongTienDangKyVietCamRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtPhuongTienDangKyVietCamRemoteModel,
					TenDangKySoHuu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
	...
	public void setNhanHieu(String NhanHieu) {
		...
		if (_qlvtPhuongTienDangKyVietCamRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtPhuongTienDangKyVietCamRemoteModel, NhanHieu);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setTrongTai(String TrongTai) {
		...
		if (_qlvtPhuongTienDangKyVietCamRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtPhuongTienDangKyVietCamRemoteModel, TrongTai);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSoKhung(String SoKhung) {
		...
		if (_qlvtPhuongTienDangKyVietCamRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtPhuongTienDangKyVietCamRemoteModel, SoKhung);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setMauSon(String MauSon) {
		...
		if (_qlvtPhuongTienDangKyVietCamRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtPhuongTienDangKyVietCamRemoteModel, MauSon);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setSoMay(String SoMay) {
		...
		if (_qlvtPhuongTienDangKyVietCamRemoteModel != null) {
			try {
				...
				method.invoke(_qlvtPhuongTienDangKyVietCamRemoteModel, SoMay);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public BaseModel<?> getQlvtPhuongTienDangKyVietCamRemoteModel() {
		return _qlvtPhuongTienDangKyVietCamRemoteModel;
	}

	public void setQlvtPhuongTienDangKyVietCamRemoteModel(
		BaseModel<?> qlvtPhuongTienDangKyVietCamRemoteModel) {
		_qlvtPhuongTienDangKyVietCamRemoteModel = qlvtPhuongTienDangKyVietCamRemoteModel;
	}
	...
	public Object invokeOnRemoteModel(String methodName,
		...
		Class<?> remoteModelClass = _qlvtPhuongTienDangKyVietCamRemoteModel.getClass();
		...
		Object returnValue = method.invoke(_qlvtPhuongTienDangKyVietCamRemoteModel,
	...
	public QlvtPhuongTienDangKyVietCam toEscapedModel() {
		return (QlvtPhuongTienDangKyVietCam)ProxyUtil.newProxyInstance(QlvtPhuongTienDangKyVietCam.class.getClassLoader(),
			new Class[] { QlvtPhuongTienDangKyVietCam.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		QlvtPhuongTienDangKyVietCamClp clone = new QlvtPhuongTienDangKyVietCamClp();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof QlvtPhuongTienDangKyVietCamClp)) {
			return false;
		}

		QlvtPhuongTienDangKyVietCamClp qlvtPhuongTienDangKyVietCam = (QlvtPhuongTienDangKyVietCamClp)obj;
	...
	private BaseModel<?> _qlvtPhuongTienDangKyVietCamRemoteModel;
}