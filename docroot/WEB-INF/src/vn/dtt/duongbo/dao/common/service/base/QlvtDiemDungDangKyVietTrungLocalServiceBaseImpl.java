...
import vn.dtt.duongbo.dao.common.service.QlvtDiemDungDangKyVietTrungLocalService;
...
/**
 * Provides the base implementation for the qlvt diem dung dang ky viet trung local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.QlvtDiemDungDangKyVietTrungLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.QlvtDiemDungDangKyVietTrungLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.QlvtDiemDungDangKyVietTrungLocalServiceUtil
 * @generated
 */
public abstract class QlvtDiemDungDangKyVietTrungLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements QlvtDiemDungDangKyVietTrungLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.QlvtDiemDungDangKyVietTrungLocalServiceUtil} to access the qlvt diem dung dang ky viet trung local service.
	 */
	...
	@Override
	public QlvtDiemDungDangKyVietTrung addQlvtDiemDungDangKyVietTrung(
		QlvtDiemDungDangKyVietTrung qlvtDiemDungDangKyVietTrung)
		throws SystemException {
		qlvtDiemDungDangKyVietTrung.setNew(true);

		return qlvtDiemDungDangKyVietTrungPersistence.update(qlvtDiemDungDangKyVietTrung);
	}
	 ...
	 */
	@Override
	public QlvtDiemDungDangKyVietTrung createQlvtDiemDungDangKyVietTrung(
		long id) {
		return qlvtDiemDungDangKyVietTrungPersistence.create(id);
	}
	...
	@Override
	public QlvtDiemDungDangKyVietTrung deleteQlvtDiemDungDangKyVietTrung(
		long id) throws PortalException, SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.remove(id);
	}
	...
	public QlvtDiemDungDangKyVietTrung deleteQlvtDiemDungDangKyVietTrung(
		QlvtDiemDungDangKyVietTrung qlvtDiemDungDangKyVietTrung)
		throws SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.remove(qlvtDiemDungDangKyVietTrung);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QlvtDiemDungDangKyVietTrung.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QlvtDiemDungDangKyVietTrung fetchQlvtDiemDungDangKyVietTrung(long id)
		throws SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public QlvtDiemDungDangKyVietTrung getQlvtDiemDungDangKyVietTrung(long id)
		throws PortalException, SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QlvtDiemDungDangKyVietTrung> getQlvtDiemDungDangKyVietTrungs(
		int start, int end) throws SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQlvtDiemDungDangKyVietTrungsCount() throws SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QlvtDiemDungDangKyVietTrung updateQlvtDiemDungDangKyVietTrung(
		QlvtDiemDungDangKyVietTrung qlvtDiemDungDangKyVietTrung)
		throws SystemException {
		return qlvtDiemDungDangKyVietTrungPersistence.update(qlvtDiemDungDangKyVietTrung);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.QlvtDiemDungDangKyVietTrung",
			qlvtDiemDungDangKyVietTrungLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qlvtDiemDungDangKyVietTrungPersistence.getDataSource();
	...
	private QlvtDiemDungDangKyVietTrungLocalServiceClpInvoker _clpInvoker = new QlvtDiemDungDangKyVietTrungLocalServiceClpInvoker();
}