...
import vn.dtt.duongbo.dao.common.service.TthcTrangThaiHoSoLocalService;
...
/**
 * Provides the base implementation for the tthc trang thai ho so local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcTrangThaiHoSoLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TthcTrangThaiHoSoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcTrangThaiHoSoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcTrangThaiHoSoLocalServiceUtil} to access the tthc trang thai ho so local service.
	 */
	...
	@Override
	public TthcTrangThaiHoSo addTthcTrangThaiHoSo(
		TthcTrangThaiHoSo tthcTrangThaiHoSo) throws SystemException {
		tthcTrangThaiHoSo.setNew(true);

		return tthcTrangThaiHoSoPersistence.update(tthcTrangThaiHoSo);
	}
	 ...
	 */
	@Override
	public TthcTrangThaiHoSo createTthcTrangThaiHoSo(long id) {
		return tthcTrangThaiHoSoPersistence.create(id);
	}
	...
	@Override
	public TthcTrangThaiHoSo deleteTthcTrangThaiHoSo(long id)
		throws PortalException, SystemException {
		return tthcTrangThaiHoSoPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcTrangThaiHoSo deleteTthcTrangThaiHoSo(
		TthcTrangThaiHoSo tthcTrangThaiHoSo) throws SystemException {
		return tthcTrangThaiHoSoPersistence.remove(tthcTrangThaiHoSo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcTrangThaiHoSo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tthcTrangThaiHoSoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcTrangThaiHoSoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcTrangThaiHoSo fetchTthcTrangThaiHoSo(long id)
		throws SystemException {
		return tthcTrangThaiHoSoPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcTrangThaiHoSo getTthcTrangThaiHoSo(long id)
		throws PortalException, SystemException {
		return tthcTrangThaiHoSoPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcTrangThaiHoSoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcTrangThaiHoSo> getTthcTrangThaiHoSos(int start, int end)
		throws SystemException {
		return tthcTrangThaiHoSoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcTrangThaiHoSosCount() throws SystemException {
		return tthcTrangThaiHoSoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcTrangThaiHoSo updateTthcTrangThaiHoSo(
		TthcTrangThaiHoSo tthcTrangThaiHoSo) throws SystemException {
		return tthcTrangThaiHoSoPersistence.update(tthcTrangThaiHoSo);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcTrangThaiHoSo",
			tthcTrangThaiHoSoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcTrangThaiHoSoPersistence.getDataSource();
	...
	private TthcTrangThaiHoSoLocalServiceClpInvoker _clpInvoker = new TthcTrangThaiHoSoLocalServiceClpInvoker();
}