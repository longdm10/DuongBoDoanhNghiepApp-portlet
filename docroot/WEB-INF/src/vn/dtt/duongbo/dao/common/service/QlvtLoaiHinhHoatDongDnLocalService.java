...
/**
 * Provides the local service interface for QlvtLoaiHinhHoatDongDn. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see QlvtLoaiHinhHoatDongDnLocalServiceUtil
...
public interface QlvtLoaiHinhHoatDongDnLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtLoaiHinhHoatDongDnLocalServiceUtil} to access the qlvt loai hinh hoat dong dn local service. Add custom service methods to {@link vn.dtt.duongbo.dao.common.service.impl.QlvtLoaiHinhHoatDongDnLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
