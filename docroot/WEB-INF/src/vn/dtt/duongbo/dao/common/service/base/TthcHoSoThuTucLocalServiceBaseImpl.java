...
import vn.dtt.duongbo.dao.common.service.TthcHoSoThuTucLocalService;
...
/**
 * Provides the base implementation for the tthc ho so thu tuc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcHoSoThuTucLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TthcHoSoThuTucLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcHoSoThuTucLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcHoSoThuTucLocalServiceUtil} to access the tthc ho so thu tuc local service.
	 */
	...
	@Override
	public TthcHoSoThuTuc addTthcHoSoThuTuc(TthcHoSoThuTuc tthcHoSoThuTuc)
		throws SystemException {
		tthcHoSoThuTuc.setNew(true);

		return tthcHoSoThuTucPersistence.update(tthcHoSoThuTuc);
	}
	 ...
	 */
	@Override
	public TthcHoSoThuTuc createTthcHoSoThuTuc(long id) {
		return tthcHoSoThuTucPersistence.create(id);
	}
	...
	@Override
	public TthcHoSoThuTuc deleteTthcHoSoThuTuc(long id)
		throws PortalException, SystemException {
		return tthcHoSoThuTucPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcHoSoThuTuc deleteTthcHoSoThuTuc(TthcHoSoThuTuc tthcHoSoThuTuc)
		throws SystemException {
		return tthcHoSoThuTucPersistence.remove(tthcHoSoThuTuc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcHoSoThuTuc.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcHoSoThuTucPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcHoSoThuTucPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcHoSoThuTuc fetchTthcHoSoThuTuc(long id)
		throws SystemException {
		return tthcHoSoThuTucPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcHoSoThuTuc getTthcHoSoThuTuc(long id)
		throws PortalException, SystemException {
		return tthcHoSoThuTucPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcHoSoThuTucPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcHoSoThuTuc> getTthcHoSoThuTucs(int start, int end)
		throws SystemException {
		return tthcHoSoThuTucPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcHoSoThuTucsCount() throws SystemException {
		return tthcHoSoThuTucPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcHoSoThuTuc updateTthcHoSoThuTuc(TthcHoSoThuTuc tthcHoSoThuTuc)
		throws SystemException {
		return tthcHoSoThuTucPersistence.update(tthcHoSoThuTuc);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcHoSoThuTuc",
			tthcHoSoThuTucLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcHoSoThuTucPersistence.getDataSource();
	...
	private TthcHoSoThuTucLocalServiceClpInvoker _clpInvoker = new TthcHoSoThuTucLocalServiceClpInvoker();
}