...
import vn.dtt.duongbo.dao.common.service.QlvtPhuongTienCapPhuHieuLocalService;
...
/**
 * Provides the base implementation for the qlvt phuong tien cap phu hieu local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.QlvtPhuongTienCapPhuHieuLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class QlvtPhuongTienCapPhuHieuLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements QlvtPhuongTienCapPhuHieuLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.QlvtPhuongTienCapPhuHieuLocalServiceUtil} to access the qlvt phuong tien cap phu hieu local service.
	 */
	...
	@Override
	public QlvtPhuongTienCapPhuHieu addQlvtPhuongTienCapPhuHieu(
		QlvtPhuongTienCapPhuHieu qlvtPhuongTienCapPhuHieu)
		throws SystemException {
		qlvtPhuongTienCapPhuHieu.setNew(true);

		return qlvtPhuongTienCapPhuHieuPersistence.update(qlvtPhuongTienCapPhuHieu);
	}
	 ...
	 */
	@Override
	public QlvtPhuongTienCapPhuHieu createQlvtPhuongTienCapPhuHieu(long id) {
		return qlvtPhuongTienCapPhuHieuPersistence.create(id);
	}
	...
	@Override
	public QlvtPhuongTienCapPhuHieu deleteQlvtPhuongTienCapPhuHieu(long id)
		throws PortalException, SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QlvtPhuongTienCapPhuHieu deleteQlvtPhuongTienCapPhuHieu(
		QlvtPhuongTienCapPhuHieu qlvtPhuongTienCapPhuHieu)
		throws SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.remove(qlvtPhuongTienCapPhuHieu);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QlvtPhuongTienCapPhuHieu.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QlvtPhuongTienCapPhuHieu fetchQlvtPhuongTienCapPhuHieu(long id)
		throws SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public QlvtPhuongTienCapPhuHieu getQlvtPhuongTienCapPhuHieu(long id)
		throws PortalException, SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QlvtPhuongTienCapPhuHieu> getQlvtPhuongTienCapPhuHieus(
		int start, int end) throws SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQlvtPhuongTienCapPhuHieusCount() throws SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QlvtPhuongTienCapPhuHieu updateQlvtPhuongTienCapPhuHieu(
		QlvtPhuongTienCapPhuHieu qlvtPhuongTienCapPhuHieu)
		throws SystemException {
		return qlvtPhuongTienCapPhuHieuPersistence.update(qlvtPhuongTienCapPhuHieu);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.QlvtPhuongTienCapPhuHieu",
			qlvtPhuongTienCapPhuHieuLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.QlvtPhuongTienCapPhuHieu");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qlvtPhuongTienCapPhuHieuPersistence.getDataSource();
	...
	private QlvtPhuongTienCapPhuHieuLocalServiceClpInvoker _clpInvoker = new QlvtPhuongTienCapPhuHieuLocalServiceClpInvoker();
}