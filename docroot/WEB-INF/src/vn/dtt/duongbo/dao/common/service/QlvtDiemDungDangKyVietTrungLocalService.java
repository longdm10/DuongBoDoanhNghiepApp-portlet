...
/**
 * Provides the local service interface for QlvtDiemDungDangKyVietTrung. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see QlvtDiemDungDangKyVietTrungLocalServiceUtil
...
public interface QlvtDiemDungDangKyVietTrungLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtDiemDungDangKyVietTrungLocalServiceUtil} to access the qlvt diem dung dang ky viet trung local service. Add custom service methods to {@link vn.dtt.duongbo.dao.common.service.impl.QlvtDiemDungDangKyVietTrungLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
