...
import vn.dtt.duongbo.dao.common.service.DmDataGroupLocalService;
...
/**
 * Provides the base implementation for the dm data group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.DmDataGroupLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.DmDataGroupLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.DmDataGroupLocalServiceUtil
 * @generated
 */
public abstract class DmDataGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DmDataGroupLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.DmDataGroupLocalServiceUtil} to access the dm data group local service.
	 */

	/**
	 * Adds the dm data group to the database. Also notifies the appropriate model listeners.
	 *
	 * @param dmDataGroup the dm data group
	 * @return the dm data group that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DmDataGroup addDmDataGroup(DmDataGroup dmDataGroup)
		throws SystemException {
		dmDataGroup.setNew(true);

		return dmDataGroupPersistence.update(dmDataGroup);
	}
	 ...
	 */
	@Override
	public DmDataGroup createDmDataGroup(long id) {
		return dmDataGroupPersistence.create(id);
	}

	/**
	 * Deletes the dm data group with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the dm data group
	 * @return the dm data group that was removed
	 * @throws PortalException if a dm data group with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DmDataGroup deleteDmDataGroup(long id)
		throws PortalException, SystemException {
		return dmDataGroupPersistence.remove(id);
	}

	/**
	 * Deletes the dm data group from the database. Also notifies the appropriate model listeners.
	 *
	 * @param dmDataGroup the dm data group
	 * @return the dm data group that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DmDataGroup deleteDmDataGroup(DmDataGroup dmDataGroup)
		throws SystemException {
		return dmDataGroupPersistence.remove(dmDataGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DmDataGroup.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmDataGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmDataGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmDataGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DmDataGroup fetchDmDataGroup(long id) throws SystemException {
		return dmDataGroupPersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the dm data group with the primary key.
	 *
	 * @param id the primary key of the dm data group
	 ...
	 */
	@Override
	public DmDataGroup getDmDataGroup(long id)
		throws PortalException, SystemException {
		return dmDataGroupPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmDataGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public int getDmDataGroupsCount() throws SystemException {
		return dmDataGroupPersistence.countAll();
	}

	/**
	 * Updates the dm data group in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param dmDataGroup the dm data group
	 * @return the dm data group that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DmDataGroup updateDmDataGroup(DmDataGroup dmDataGroup)
		throws SystemException {
		return dmDataGroupPersistence.update(dmDataGroup);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.DmDataGroup",
			dmDataGroupLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.DmDataGroup");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmDataGroupPersistence.getDataSource();
	...
	private DmDataGroupLocalServiceClpInvoker _clpInvoker = new DmDataGroupLocalServiceClpInvoker();
}