...
import vn.dtt.duongbo.dao.common.service.TthcNoidungHoSoTmpLocalService;
...
/**
 * Provides the base implementation for the tthc noidung ho so tmp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.TthcNoidungHoSoTmpLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.TthcNoidungHoSoTmpLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.TthcNoidungHoSoTmpLocalServiceUtil
 * @generated
 */
public abstract class TthcNoidungHoSoTmpLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcNoidungHoSoTmpLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.TthcNoidungHoSoTmpLocalServiceUtil} to access the tthc noidung ho so tmp local service.
	 */
	...
	@Override
	public TthcNoidungHoSoTmp addTthcNoidungHoSoTmp(
		TthcNoidungHoSoTmp tthcNoidungHoSoTmp) throws SystemException {
		tthcNoidungHoSoTmp.setNew(true);

		return tthcNoidungHoSoTmpPersistence.update(tthcNoidungHoSoTmp);
	}
	 ...
	 */
	@Override
	public TthcNoidungHoSoTmp createTthcNoidungHoSoTmp(long id) {
		return tthcNoidungHoSoTmpPersistence.create(id);
	}
	...
	@Override
	public TthcNoidungHoSoTmp deleteTthcNoidungHoSoTmp(long id)
		throws PortalException, SystemException {
		return tthcNoidungHoSoTmpPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcNoidungHoSoTmp deleteTthcNoidungHoSoTmp(
		TthcNoidungHoSoTmp tthcNoidungHoSoTmp) throws SystemException {
		return tthcNoidungHoSoTmpPersistence.remove(tthcNoidungHoSoTmp);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcNoidungHoSoTmp.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tthcNoidungHoSoTmpPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcNoidungHoSoTmpPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcNoidungHoSoTmp fetchTthcNoidungHoSoTmp(long id)
		throws SystemException {
		return tthcNoidungHoSoTmpPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcNoidungHoSoTmp getTthcNoidungHoSoTmp(long id)
		throws PortalException, SystemException {
		return tthcNoidungHoSoTmpPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcNoidungHoSoTmpPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcNoidungHoSoTmp> getTthcNoidungHoSoTmps(int start, int end)
		throws SystemException {
		return tthcNoidungHoSoTmpPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcNoidungHoSoTmpsCount() throws SystemException {
		return tthcNoidungHoSoTmpPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcNoidungHoSoTmp updateTthcNoidungHoSoTmp(
		TthcNoidungHoSoTmp tthcNoidungHoSoTmp) throws SystemException {
		return tthcNoidungHoSoTmpPersistence.update(tthcNoidungHoSoTmp);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.TthcNoidungHoSoTmp",
			tthcNoidungHoSoTmpLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.TthcNoidungHoSoTmp");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcNoidungHoSoTmpPersistence.getDataSource();
	...
	private TthcNoidungHoSoTmpLocalServiceClpInvoker _clpInvoker = new TthcNoidungHoSoTmpLocalServiceClpInvoker();
}