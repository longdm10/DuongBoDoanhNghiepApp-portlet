...
import vn.dtt.duongbo.dao.common.service.QlvtPhuongTienCapBienHieuLocalService;
...
/**
 * Provides the base implementation for the qlvt phuong tien cap bien hieu local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.common.service.impl.QlvtPhuongTienCapBienHieuLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 * @see vn.dtt.duongbo.dao.common.service.impl.QlvtPhuongTienCapBienHieuLocalServiceImpl
 * @see vn.dtt.duongbo.dao.common.service.QlvtPhuongTienCapBienHieuLocalServiceUtil
 * @generated
 */
public abstract class QlvtPhuongTienCapBienHieuLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements QlvtPhuongTienCapBienHieuLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.common.service.QlvtPhuongTienCapBienHieuLocalServiceUtil} to access the qlvt phuong tien cap bien hieu local service.
	 */
	...
	@Override
	public QlvtPhuongTienCapBienHieu addQlvtPhuongTienCapBienHieu(
		QlvtPhuongTienCapBienHieu qlvtPhuongTienCapBienHieu)
		throws SystemException {
		qlvtPhuongTienCapBienHieu.setNew(true);

		return qlvtPhuongTienCapBienHieuPersistence.update(qlvtPhuongTienCapBienHieu);
	}
	 ...
	 */
	@Override
	public QlvtPhuongTienCapBienHieu createQlvtPhuongTienCapBienHieu(long id) {
		return qlvtPhuongTienCapBienHieuPersistence.create(id);
	}
	...
	@Override
	public QlvtPhuongTienCapBienHieu deleteQlvtPhuongTienCapBienHieu(long id)
		throws PortalException, SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QlvtPhuongTienCapBienHieu deleteQlvtPhuongTienCapBienHieu(
		QlvtPhuongTienCapBienHieu qlvtPhuongTienCapBienHieu)
		throws SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.remove(qlvtPhuongTienCapBienHieu);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(QlvtPhuongTienCapBienHieu.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public QlvtPhuongTienCapBienHieu fetchQlvtPhuongTienCapBienHieu(long id)
		throws SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public QlvtPhuongTienCapBienHieu getQlvtPhuongTienCapBienHieu(long id)
		throws PortalException, SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QlvtPhuongTienCapBienHieu> getQlvtPhuongTienCapBienHieus(
		int start, int end) throws SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getQlvtPhuongTienCapBienHieusCount() throws SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QlvtPhuongTienCapBienHieu updateQlvtPhuongTienCapBienHieu(
		QlvtPhuongTienCapBienHieu qlvtPhuongTienCapBienHieu)
		throws SystemException {
		return qlvtPhuongTienCapBienHieuPersistence.update(qlvtPhuongTienCapBienHieu);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.common.model.QlvtPhuongTienCapBienHieu",
			qlvtPhuongTienCapBienHieuLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.dtt.duongbo.dao.common.model.QlvtPhuongTienCapBienHieu");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = qlvtPhuongTienCapBienHieuPersistence.getDataSource();
	...
	private QlvtPhuongTienCapBienHieuLocalServiceClpInvoker _clpInvoker = new QlvtPhuongTienCapBienHieuLocalServiceClpInvoker();
}