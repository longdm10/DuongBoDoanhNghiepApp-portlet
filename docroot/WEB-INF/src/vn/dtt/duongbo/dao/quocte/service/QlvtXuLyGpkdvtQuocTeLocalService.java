...
/**
 * Provides the local service interface for QlvtXuLyGpkdvtQuocTe. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NoiPham
 * @see QlvtXuLyGpkdvtQuocTeLocalServiceUtil
...
public interface QlvtXuLyGpkdvtQuocTeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtXuLyGpkdvtQuocTeLocalServiceUtil} to access the qlvt xu ly gpkdvt quoc te local service. Add custom service methods to {@link vn.dtt.duongbo.dao.quocte.service.impl.QlvtXuLyGpkdvtQuocTeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
