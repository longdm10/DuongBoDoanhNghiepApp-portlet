 ...
 * @generated
 */
public class QlvtXuLyGpkdvtQuocTeLocalServiceClp
	implements QlvtXuLyGpkdvtQuocTeLocalService {
	public QlvtXuLyGpkdvtQuocTeLocalServiceClp(
	...
	public vn.dtt.duongbo.dao.quocte.model.QlvtXuLyGpkdvtQuocTe addQlvtXuLyGpkdvtQuocTe(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(qlvtXuLyGpkdvtQuocTe)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.quocte.model.QlvtXuLyGpkdvtQuocTe)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.quocte.model.QlvtXuLyGpkdvtQuocTe> getQlvtXuLyGpkdvtQuocTes(
		...
		return (java.util.List<vn.dtt.duongbo.dao.quocte.model.QlvtXuLyGpkdvtQuocTe>)ClpSerializer.translateOutput(returnObj);
	}
