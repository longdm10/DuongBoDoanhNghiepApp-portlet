...
/**
 * Provides the local service interface for QlvtXuLyKTTQuocTeDiemDungNghi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NoiPham
 * @see QlvtXuLyKTTQuocTeDiemDungNghiLocalServiceUtil
...
public interface QlvtXuLyKTTQuocTeDiemDungNghiLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtXuLyKTTQuocTeDiemDungNghiLocalServiceUtil} to access the qlvt xu ly k t t quoc te diem dung nghi local service. Add custom service methods to {@link vn.dtt.duongbo.dao.quocte.service.impl.QlvtXuLyKTTQuocTeDiemDungNghiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
