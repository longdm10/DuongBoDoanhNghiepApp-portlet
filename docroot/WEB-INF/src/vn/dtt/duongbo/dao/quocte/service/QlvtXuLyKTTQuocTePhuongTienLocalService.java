...
/**
 * Provides the local service interface for QlvtXuLyKTTQuocTePhuongTien. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NoiPham
 * @see QlvtXuLyKTTQuocTePhuongTienLocalServiceUtil
...
public interface QlvtXuLyKTTQuocTePhuongTienLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtXuLyKTTQuocTePhuongTienLocalServiceUtil} to access the qlvt xu ly k t t quoc te phuong tien local service. Add custom service methods to {@link vn.dtt.duongbo.dao.quocte.service.impl.QlvtXuLyKTTQuocTePhuongTienLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
