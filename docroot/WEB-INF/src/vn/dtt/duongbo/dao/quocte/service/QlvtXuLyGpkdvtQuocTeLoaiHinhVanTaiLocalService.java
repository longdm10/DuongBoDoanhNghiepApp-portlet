...
/**
 * Provides the local service interface for QlvtXuLyGpkdvtQuocTeLoaiHinhVanTai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NoiPham
 * @see QlvtXuLyGpkdvtQuocTeLoaiHinhVanTaiLocalServiceUtil
...
public interface QlvtXuLyGpkdvtQuocTeLoaiHinhVanTaiLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtXuLyGpkdvtQuocTeLoaiHinhVanTaiLocalServiceUtil} to access the qlvt xu ly gpkdvt quoc te loai hinh van tai local service. Add custom service methods to {@link vn.dtt.duongbo.dao.quocte.service.impl.QlvtXuLyGpkdvtQuocTeLoaiHinhVanTaiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
