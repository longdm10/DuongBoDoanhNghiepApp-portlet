...
/**
 * Provides the local service interface for QlvtXuLyKTTQuocTeBieuDoXe. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NoiPham
 * @see QlvtXuLyKTTQuocTeBieuDoXeLocalServiceUtil
...
public interface QlvtXuLyKTTQuocTeBieuDoXeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtXuLyKTTQuocTeBieuDoXeLocalServiceUtil} to access the qlvt xu ly k t t quoc te bieu do xe local service. Add custom service methods to {@link vn.dtt.duongbo.dao.quocte.service.impl.QlvtXuLyKTTQuocTeBieuDoXeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
