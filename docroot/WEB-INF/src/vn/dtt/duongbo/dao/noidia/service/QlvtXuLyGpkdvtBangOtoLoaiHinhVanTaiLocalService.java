...
/**
 * Provides the local service interface for QlvtXuLyGpkdvtBangOtoLoaiHinhVanTai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NoiPham
 * @see QlvtXuLyGpkdvtBangOtoLoaiHinhVanTaiLocalServiceUtil
...
public interface QlvtXuLyGpkdvtBangOtoLoaiHinhVanTaiLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtXuLyGpkdvtBangOtoLoaiHinhVanTaiLocalServiceUtil} to access the qlvt xu ly gpkdvt bang oto loai hinh van tai local service. Add custom service methods to {@link vn.dtt.duongbo.dao.noidia.service.impl.QlvtXuLyGpkdvtBangOtoLoaiHinhVanTaiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
