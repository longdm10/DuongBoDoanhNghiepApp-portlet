...
import vn.dtt.duongbo.dao.thanhtoan.service.TthcYeuCauThanhToanLocalService;
...
/**
 * Provides the base implementation for the tthc yeu cau thanh toan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.thanhtoan.service.impl.TthcYeuCauThanhToanLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TthcYeuCauThanhToanLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcYeuCauThanhToanLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.thanhtoan.service.TthcYeuCauThanhToanLocalServiceUtil} to access the tthc yeu cau thanh toan local service.
	 */
	...
	@Override
	public TthcYeuCauThanhToan addTthcYeuCauThanhToan(
		TthcYeuCauThanhToan tthcYeuCauThanhToan) throws SystemException {
		tthcYeuCauThanhToan.setNew(true);

		return tthcYeuCauThanhToanPersistence.update(tthcYeuCauThanhToan);
	}
	 ...
	 */
	@Override
	public TthcYeuCauThanhToan createTthcYeuCauThanhToan(long id) {
		return tthcYeuCauThanhToanPersistence.create(id);
	}
	...
	@Override
	public TthcYeuCauThanhToan deleteTthcYeuCauThanhToan(long id)
		throws PortalException, SystemException {
		return tthcYeuCauThanhToanPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcYeuCauThanhToan deleteTthcYeuCauThanhToan(
		TthcYeuCauThanhToan tthcYeuCauThanhToan) throws SystemException {
		return tthcYeuCauThanhToanPersistence.remove(tthcYeuCauThanhToan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcYeuCauThanhToan.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tthcYeuCauThanhToanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcYeuCauThanhToanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcYeuCauThanhToan fetchTthcYeuCauThanhToan(long id)
		throws SystemException {
		return tthcYeuCauThanhToanPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcYeuCauThanhToan getTthcYeuCauThanhToan(long id)
		throws PortalException, SystemException {
		return tthcYeuCauThanhToanPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcYeuCauThanhToanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcYeuCauThanhToan> getTthcYeuCauThanhToans(int start, int end)
		throws SystemException {
		return tthcYeuCauThanhToanPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcYeuCauThanhToansCount() throws SystemException {
		return tthcYeuCauThanhToanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcYeuCauThanhToan updateTthcYeuCauThanhToan(
		TthcYeuCauThanhToan tthcYeuCauThanhToan) throws SystemException {
		return tthcYeuCauThanhToanPersistence.update(tthcYeuCauThanhToan);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.thanhtoan.model.TthcYeuCauThanhToan",
			tthcYeuCauThanhToanLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcYeuCauThanhToanPersistence.getDataSource();
	...
	private TthcYeuCauThanhToanLocalServiceClpInvoker _clpInvoker = new TthcYeuCauThanhToanLocalServiceClpInvoker();
}