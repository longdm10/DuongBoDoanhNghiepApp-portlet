...
import vn.dtt.duongbo.dao.thanhtoan.service.TthcHinhThucNopPhiLocalService;
...
/**
 * Provides the base implementation for the tthc hinh thuc nop phi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.thanhtoan.service.impl.TthcHinhThucNopPhiLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class TthcHinhThucNopPhiLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TthcHinhThucNopPhiLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.thanhtoan.service.TthcHinhThucNopPhiLocalServiceUtil} to access the tthc hinh thuc nop phi local service.
	 */
	...
	@Override
	public TthcHinhThucNopPhi addTthcHinhThucNopPhi(
		TthcHinhThucNopPhi tthcHinhThucNopPhi) throws SystemException {
		tthcHinhThucNopPhi.setNew(true);

		return tthcHinhThucNopPhiPersistence.update(tthcHinhThucNopPhi);
	}
	 ...
	 */
	@Override
	public TthcHinhThucNopPhi createTthcHinhThucNopPhi(long id) {
		return tthcHinhThucNopPhiPersistence.create(id);
	}
	...
	@Override
	public TthcHinhThucNopPhi deleteTthcHinhThucNopPhi(long id)
		throws PortalException, SystemException {
		return tthcHinhThucNopPhiPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TthcHinhThucNopPhi deleteTthcHinhThucNopPhi(
		TthcHinhThucNopPhi tthcHinhThucNopPhi) throws SystemException {
		return tthcHinhThucNopPhiPersistence.remove(tthcHinhThucNopPhi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TthcHinhThucNopPhi.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tthcHinhThucNopPhiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tthcHinhThucNopPhiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TthcHinhThucNopPhi fetchTthcHinhThucNopPhi(long id)
		throws SystemException {
		return tthcHinhThucNopPhiPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TthcHinhThucNopPhi getTthcHinhThucNopPhi(long id)
		throws PortalException, SystemException {
		return tthcHinhThucNopPhiPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tthcHinhThucNopPhiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TthcHinhThucNopPhi> getTthcHinhThucNopPhis(int start, int end)
		throws SystemException {
		return tthcHinhThucNopPhiPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTthcHinhThucNopPhisCount() throws SystemException {
		return tthcHinhThucNopPhiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TthcHinhThucNopPhi updateTthcHinhThucNopPhi(
		TthcHinhThucNopPhi tthcHinhThucNopPhi) throws SystemException {
		return tthcHinhThucNopPhiPersistence.update(tthcHinhThucNopPhi);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.thanhtoan.model.TthcHinhThucNopPhi",
			tthcHinhThucNopPhiLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tthcHinhThucNopPhiPersistence.getDataSource();
	...
	private TthcHinhThucNopPhiLocalServiceClpInvoker _clpInvoker = new TthcHinhThucNopPhiLocalServiceClpInvoker();
}