...
/**
 * Provides the local service utility for TthcXacNhanThanhToanHoSo. This utility wraps
 * {@link vn.dtt.duongbo.dao.thanhtoan.service.impl.TthcXacNhanThanhToanHoSoLocalServiceImpl} and is the
 ...
 * @generated
 */
public class TthcXacNhanThanhToanHoSoLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dtt.duongbo.dao.thanhtoan.service.impl.TthcXacNhanThanhToanHoSoLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo addTthcXacNhanThanhToanHoSo(
		vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo tthcXacNhanThanhToanHoSo)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addTthcXacNhanThanhToanHoSo(tthcXacNhanThanhToanHoSo);
	}
	...
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo createTthcXacNhanThanhToanHoSo(
		long id) {
		return getService().createTthcXacNhanThanhToanHoSo(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo deleteTthcXacNhanThanhToanHoSo(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteTthcXacNhanThanhToanHoSo(id);
	}
	...
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo deleteTthcXacNhanThanhToanHoSo(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .deleteTthcXacNhanThanhToanHoSo(tthcXacNhanThanhToanHoSo);
	}
	...
	*/
	...
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo fetchTthcXacNhanThanhToanHoSo(
		long id) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchTthcXacNhanThanhToanHoSo(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo getTthcXacNhanThanhToanHoSo(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getTthcXacNhanThanhToanHoSo(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo> getTthcXacNhanThanhToanHoSos(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getTthcXacNhanThanhToanHoSos(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getTthcXacNhanThanhToanHoSosCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getTthcXacNhanThanhToanHoSosCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo updateTthcXacNhanThanhToanHoSo(
		vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo tthcXacNhanThanhToanHoSo)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .updateTthcXacNhanThanhToanHoSo(tthcXacNhanThanhToanHoSo);
	}
	...
	*/
	...
	public static java.util.List<vn.dtt.duongbo.dao.thanhtoan.model.TthcXacNhanThanhToanHoSo> findByXacNhanThanhToanId(
		...
		return getService().findByXacNhanThanhToanId(xacNhanThanhToanId);
	}
	...
	public static TthcXacNhanThanhToanHoSoLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					TthcXacNhanThanhToanHoSoLocalService.class.getName());

			if (invokableLocalService instanceof TthcXacNhanThanhToanHoSoLocalService) {
				_service = (TthcXacNhanThanhToanHoSoLocalService)invokableLocalService;
			}
			else {
				_service = new TthcXacNhanThanhToanHoSoLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(TthcXacNhanThanhToanHoSoLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(TthcXacNhanThanhToanHoSoLocalService service) {
	}

	private static TthcXacNhanThanhToanHoSoLocalService _service;
}