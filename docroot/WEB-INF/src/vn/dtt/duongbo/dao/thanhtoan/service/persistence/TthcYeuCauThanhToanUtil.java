...
/**
 * The persistence utility for the tthc yeu cau thanh toan service. This utility wraps {@link TthcYeuCauThanhToanPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see TthcYeuCauThanhToanPersistenceImpl
 * @generated
 */
public class TthcYeuCauThanhToanUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(TthcYeuCauThanhToan tthcYeuCauThanhToan) {
		getPersistence().clearCache(tthcYeuCauThanhToan);
	}
	 ...
	 */
	public static List<TthcYeuCauThanhToan> findWithDynamicQuery(
	 ...
	 */
	public static TthcYeuCauThanhToan update(
		TthcYeuCauThanhToan tthcYeuCauThanhToan) throws SystemException {
		return getPersistence().update(tthcYeuCauThanhToan);
	}
	 ...
	 */
	public static TthcYeuCauThanhToan update(
		TthcYeuCauThanhToan tthcYeuCauThanhToan, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(tthcYeuCauThanhToan, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(tthcYeuCauThanhToan);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<vn.dtt.duongbo.dao.thanhtoan.model.TthcYeuCauThanhToan> tthcYeuCauThanhToans) {
		getPersistence().cacheResult(tthcYeuCauThanhToans);
	}
	...
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcYeuCauThanhToan create(
		long id) {
	...
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcYeuCauThanhToan remove(
		long id)
	...
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcYeuCauThanhToan updateImpl(
		vn.dtt.duongbo.dao.thanhtoan.model.TthcYeuCauThanhToan tthcYeuCauThanhToan)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(tthcYeuCauThanhToan);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcYeuCauThanhToan findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.duongbo.dao.thanhtoan.NoSuchTthcYeuCauThanhToanException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.thanhtoan.model.TthcYeuCauThanhToan fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbo.dao.thanhtoan.model.TthcYeuCauThanhToan> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static TthcYeuCauThanhToanPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (TthcYeuCauThanhToanPersistence)PortletBeanLocatorUtil.locate(vn.dtt.duongbo.dao.thanhtoan.service.ClpSerializer.getServletContextName(),
					TthcYeuCauThanhToanPersistence.class.getName());

			ReferenceRegistry.registerReference(TthcYeuCauThanhToanUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(TthcYeuCauThanhToanPersistence persistence) {
	}

	private static TthcYeuCauThanhToanPersistence _persistence;
}