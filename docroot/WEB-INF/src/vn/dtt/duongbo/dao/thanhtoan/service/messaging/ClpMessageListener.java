...
package vn.dtt.duongbo.dao.thanhtoan.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ThanhToanKeyPayLocalServiceUtil.clearService();

			TthcHinhThucNopPhiLocalServiceUtil.clearService();

			TthcXacNhanThanhToanLocalServiceUtil.clearService();

			TthcXacNhanThanhToanHoSoLocalServiceUtil.clearService();

			TthcYeuCauThanhToanLocalServiceUtil.clearService();
		}
	}
}