 ...
 * @generated
 */
public class TthcHinhThucNopPhiLocalServiceClp
	implements TthcHinhThucNopPhiLocalService {
	public TthcHinhThucNopPhiLocalServiceClp(
	...
	public vn.dtt.duongbo.dao.thanhtoan.model.TthcHinhThucNopPhi addTthcHinhThucNopPhi(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(tthcHinhThucNopPhi)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.thanhtoan.model.TthcHinhThucNopPhi)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.thanhtoan.model.TthcHinhThucNopPhi> getTthcHinhThucNopPhis(
		...
		return (java.util.List<vn.dtt.duongbo.dao.thanhtoan.model.TthcHinhThucNopPhi>)ClpSerializer.translateOutput(returnObj);
	}
