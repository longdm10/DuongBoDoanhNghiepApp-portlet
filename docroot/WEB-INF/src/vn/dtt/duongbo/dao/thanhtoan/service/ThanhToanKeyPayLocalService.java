...
/**
 * Provides the local service interface for ThanhToanKeyPay. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see ThanhToanKeyPayLocalServiceUtil
...
public interface ThanhToanKeyPayLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ThanhToanKeyPayLocalServiceUtil} to access the thanh toan key pay local service. Add custom service methods to {@link vn.dtt.duongbo.dao.thanhtoan.service.impl.ThanhToanKeyPayLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
