...
/**
 * Provides the local service interface for TthcXacNhanThanhToanHoSo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see TthcXacNhanThanhToanHoSoLocalServiceUtil
...
public interface TthcXacNhanThanhToanHoSoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TthcXacNhanThanhToanHoSoLocalServiceUtil} to access the tthc xac nhan thanh toan ho so local service. Add custom service methods to {@link vn.dtt.duongbo.dao.thanhtoan.service.impl.TthcXacNhanThanhToanHoSoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
