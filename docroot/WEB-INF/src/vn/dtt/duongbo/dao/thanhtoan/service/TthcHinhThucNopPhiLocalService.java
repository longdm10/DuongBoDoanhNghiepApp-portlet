...
/**
 * Provides the local service interface for TthcHinhThucNopPhi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see TthcHinhThucNopPhiLocalServiceUtil
...
public interface TthcHinhThucNopPhiLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TthcHinhThucNopPhiLocalServiceUtil} to access the tthc hinh thuc nop phi local service. Add custom service methods to {@link vn.dtt.duongbo.dao.thanhtoan.service.impl.TthcHinhThucNopPhiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
