...
import vn.dtt.duongbo.dao.doanhnghiep.service.DnDoanhNghiepUserLocalService;
...
/**
 * Provides the base implementation for the dn doanh nghiep user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.duongbo.dao.doanhnghiep.service.impl.DnDoanhNghiepUserLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DnDoanhNghiepUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DnDoanhNghiepUserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.duongbo.dao.doanhnghiep.service.DnDoanhNghiepUserLocalServiceUtil} to access the dn doanh nghiep user local service.
	 */
	...
	@Override
	public DnDoanhNghiepUser addDnDoanhNghiepUser(
		DnDoanhNghiepUser dnDoanhNghiepUser) throws SystemException {
		dnDoanhNghiepUser.setNew(true);

		return dnDoanhNghiepUserPersistence.update(dnDoanhNghiepUser);
	}
	 ...
	 */
	@Override
	public DnDoanhNghiepUser createDnDoanhNghiepUser(long id) {
		return dnDoanhNghiepUserPersistence.create(id);
	}
	...
	@Override
	public DnDoanhNghiepUser deleteDnDoanhNghiepUser(long id)
		throws PortalException, SystemException {
		return dnDoanhNghiepUserPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DnDoanhNghiepUser deleteDnDoanhNghiepUser(
		DnDoanhNghiepUser dnDoanhNghiepUser) throws SystemException {
		return dnDoanhNghiepUserPersistence.remove(dnDoanhNghiepUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DnDoanhNghiepUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dnDoanhNghiepUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dnDoanhNghiepUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DnDoanhNghiepUser fetchDnDoanhNghiepUser(long id)
		throws SystemException {
		return dnDoanhNghiepUserPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DnDoanhNghiepUser getDnDoanhNghiepUser(long id)
		throws PortalException, SystemException {
		return dnDoanhNghiepUserPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dnDoanhNghiepUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DnDoanhNghiepUser> getDnDoanhNghiepUsers(int start, int end)
		throws SystemException {
		return dnDoanhNghiepUserPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDnDoanhNghiepUsersCount() throws SystemException {
		return dnDoanhNghiepUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DnDoanhNghiepUser updateDnDoanhNghiepUser(
		DnDoanhNghiepUser dnDoanhNghiepUser) throws SystemException {
		return dnDoanhNghiepUserPersistence.update(dnDoanhNghiepUser);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.duongbo.dao.doanhnghiep.model.DnDoanhNghiepUser",
			dnDoanhNghiepUserLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dnDoanhNghiepUserPersistence.getDataSource();
	...
	private DnDoanhNghiepUserLocalServiceClpInvoker _clpInvoker = new DnDoanhNghiepUserLocalServiceClpInvoker();
}