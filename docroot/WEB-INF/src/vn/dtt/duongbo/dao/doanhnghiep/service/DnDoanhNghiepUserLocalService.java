...
/**
 * Provides the local service interface for DnDoanhNghiepUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author win_64
 * @see DnDoanhNghiepUserLocalServiceUtil
...
public interface DnDoanhNghiepUserLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DnDoanhNghiepUserLocalServiceUtil} to access the dn doanh nghiep user local service. Add custom service methods to {@link vn.dtt.duongbo.dao.doanhnghiep.service.impl.DnDoanhNghiepUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
