...
/**
 * Provides the local service interface for QlvtKiemTraHoSo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanNc
 * @see QlvtKiemTraHoSoLocalServiceUtil
...
public interface QlvtKiemTraHoSoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtKiemTraHoSoLocalServiceUtil} to access the qlvt kiem tra ho so local service. Add custom service methods to {@link vn.dtt.duongbo.dao.nghiepvu.service.impl.QlvtKiemTraHoSoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
