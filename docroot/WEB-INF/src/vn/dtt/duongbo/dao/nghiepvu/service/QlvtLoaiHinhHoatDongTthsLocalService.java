...
/**
 * Provides the local service interface for QlvtLoaiHinhHoatDongTths. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanNc
 * @see QlvtLoaiHinhHoatDongTthsLocalServiceUtil
...
public interface QlvtLoaiHinhHoatDongTthsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtLoaiHinhHoatDongTthsLocalServiceUtil} to access the qlvt loai hinh hoat dong tths local service. Add custom service methods to {@link vn.dtt.duongbo.dao.nghiepvu.service.impl.QlvtLoaiHinhHoatDongTthsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
