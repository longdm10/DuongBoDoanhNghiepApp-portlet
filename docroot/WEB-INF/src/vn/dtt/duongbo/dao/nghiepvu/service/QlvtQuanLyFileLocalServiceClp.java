 ...
 * @generated
 */
public class QlvtQuanLyFileLocalServiceClp implements QlvtQuanLyFileLocalService {
	public QlvtQuanLyFileLocalServiceClp(
		...
		_methodName19 = "updateQuanLyFile";
		...
		_methodName20 = "findByIdFile";

		_methodParameterTypes20 = new String[] { "long" };

		_methodName21 = "findByIdFileAndDoanhNghiepID";

		_methodParameterTypes21 = new String[] { "long", "long" };

		_methodName22 = "findByDoanhNghiepId";

		_methodParameterTypes22 = new String[] { "long" };

		_methodName23 = "searchQuanLyFile";
	...
	public vn.dtt.duongbo.dao.nghiepvu.model.QlvtQuanLyFile addQlvtQuanLyFile(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(qlvtQuanLyFile) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.nghiepvu.model.QlvtQuanLyFile)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.nghiepvu.model.QlvtQuanLyFile> getQlvtQuanLyFiles(
		...
		return (java.util.List<vn.dtt.duongbo.dao.nghiepvu.model.QlvtQuanLyFile>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public vn.dtt.duongbo.dao.nghiepvu.model.QlvtQuanLyFile updateQuanLyFile(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					ClpSerializer.translateInput(tenFile),
						
					loaiFile,
						
					ClpSerializer.translateInput(thongTinFile),
						
					fileId,
						
					trangThai,
						
					ClpSerializer.translateInput(mieuTaFile)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public vn.dtt.duongbo.dao.nghiepvu.model.QlvtQuanLyFile findByIdFile(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					_methodParameterTypes20, new Object[] { idFile });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public vn.dtt.duongbo.dao.nghiepvu.model.QlvtQuanLyFile findByIdFileAndDoanhNghiepID(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					...
					new Object[] { idFile, doanhNghiepId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.duongbo.dao.nghiepvu.model.QlvtQuanLyFile> findByDoanhNghiepId(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName22,
					_methodParameterTypes22, new Object[] { doanhNghiepId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<vn.dtt.duongbo.dao.nghiepvu.model.QlvtQuanLyFile> searchQuanLyFile(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					ClpSerializer.translateInput(tenGiayTo),
						
					ClpSerializer.translateInput(fromNgayCP),
						
					ClpSerializer.translateInput(toNgayCP),
						
					ClpSerializer.translateInput(fromNgayHH),
						
					ClpSerializer.translateInput(toNgayHH),
						
					ClpSerializer.translateInput(fromNgayTai),
						
					ClpSerializer.translateInput(toNgayTai),
