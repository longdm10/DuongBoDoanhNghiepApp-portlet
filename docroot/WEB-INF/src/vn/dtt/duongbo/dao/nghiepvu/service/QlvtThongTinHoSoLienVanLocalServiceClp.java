 ...
 * @generated
 */
public class QlvtThongTinHoSoLienVanLocalServiceClp
	implements QlvtThongTinHoSoLienVanLocalService {
	public QlvtThongTinHoSoLienVanLocalServiceClp(
	...
	public vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoLienVan addQlvtThongTinHoSoLienVan(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(qlvtThongTinHoSoLienVan)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoLienVan)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoLienVan> getQlvtThongTinHoSoLienVans(
		...
		return (java.util.List<vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoLienVan>)ClpSerializer.translateOutput(returnObj);
	}
