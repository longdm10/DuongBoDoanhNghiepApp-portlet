 ...
 * @generated
 */
public class QlvtKiemTraHoSoLocalServiceClp
	implements QlvtKiemTraHoSoLocalService {
	public QlvtKiemTraHoSoLocalServiceClp(
	...
	public vn.dtt.duongbo.dao.nghiepvu.model.QlvtKiemTraHoSo addQlvtKiemTraHoSo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(qlvtKiemTraHoSo) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.nghiepvu.model.QlvtKiemTraHoSo)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.nghiepvu.model.QlvtKiemTraHoSo> getQlvtKiemTraHoSos(
		...
		return (java.util.List<vn.dtt.duongbo.dao.nghiepvu.model.QlvtKiemTraHoSo>)ClpSerializer.translateOutput(returnObj);
	}
