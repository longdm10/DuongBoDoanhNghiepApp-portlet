...
/**
 * The persistence utility for the qlvt thong tin ho so quoc te service. This utility wraps {@link QlvtThongTinHoSoQuocTePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class QlvtThongTinHoSoQuocTeUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(QlvtThongTinHoSoQuocTe qlvtThongTinHoSoQuocTe) {
		getPersistence().clearCache(qlvtThongTinHoSoQuocTe);
	}
	 ...
	 */
	public static List<QlvtThongTinHoSoQuocTe> findWithDynamicQuery(
	 ...
	 */
	public static QlvtThongTinHoSoQuocTe update(
		QlvtThongTinHoSoQuocTe qlvtThongTinHoSoQuocTe)
		throws SystemException {
		return getPersistence().update(qlvtThongTinHoSoQuocTe);
	}
	...
	public static QlvtThongTinHoSoQuocTe update(
		...
		return getPersistence().update(qlvtThongTinHoSoQuocTe, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qlvtThongTinHoSoQuocTe);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qlvtThongTinHoSoQuocTes);
	}
	...
	*/
	public static vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoQuocTe create(
		long id) {
	...
	*/
	public static vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoQuocTe remove(
		long id)
	...
	public static vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoQuocTe updateImpl(
		vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoQuocTe qlvtThongTinHoSoQuocTe)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(qlvtThongTinHoSoQuocTe);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoQuocTe findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.duongbo.dao.nghiepvu.NoSuchQlvtThongTinHoSoQuocTeException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoQuocTe fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbo.dao.nghiepvu.model.QlvtThongTinHoSoQuocTe> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static QlvtThongTinHoSoQuocTePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (QlvtThongTinHoSoQuocTePersistence)PortletBeanLocatorUtil.locate(vn.dtt.duongbo.dao.nghiepvu.service.ClpSerializer.getServletContextName(),
					QlvtThongTinHoSoQuocTePersistence.class.getName());

			ReferenceRegistry.registerReference(QlvtThongTinHoSoQuocTeUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(QlvtThongTinHoSoQuocTePersistence persistence) {
	}

	private static QlvtThongTinHoSoQuocTePersistence _persistence;
}