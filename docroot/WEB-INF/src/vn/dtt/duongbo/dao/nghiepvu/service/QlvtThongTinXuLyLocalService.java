...
/**
 * Provides the local service interface for QlvtThongTinXuLy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanNc
 * @see QlvtThongTinXuLyLocalServiceUtil
...
public interface QlvtThongTinXuLyLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtThongTinXuLyLocalServiceUtil} to access the qlvt thong tin xu ly local service. Add custom service methods to {@link vn.dtt.duongbo.dao.nghiepvu.service.impl.QlvtThongTinXuLyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
