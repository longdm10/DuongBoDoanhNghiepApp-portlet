...
public class QlvtThongTinHoSoFinderImpl extends BasePersistenceImpl<QlvtThongTinHoSo> implements QlvtThongTinHoSoFinder {
	
	private Log log = LogFactoryUtil.getLog(QlvtThongTinHoSoFinderImpl.class);
