...
/**
 * Provides the local service interface for QlvtTTHCKetQuaThamTra. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanNc
 * @see QlvtTTHCKetQuaThamTraLocalServiceUtil
...
public interface QlvtTTHCKetQuaThamTraLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QlvtTTHCKetQuaThamTraLocalServiceUtil} to access the qlvt t t h c ket qua tham tra local service. Add custom service methods to {@link vn.dtt.duongbo.dao.nghiepvu.service.impl.QlvtTTHCKetQuaThamTraLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
