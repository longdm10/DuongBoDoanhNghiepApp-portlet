...
/**
 * Provides the local service interface for QLVTCapPhepPhuHieuTuyen. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhta
 * @see QLVTCapPhepPhuHieuTuyenLocalServiceUtil
...
public interface QLVTCapPhepPhuHieuTuyenLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QLVTCapPhepPhuHieuTuyenLocalServiceUtil} to access the q l v t cap phep phu hieu tuyen local service. Add custom service methods to {@link vn.dtt.duongbo.dao.capbienhieuphuhieu.service.impl.QLVTCapPhepPhuHieuTuyenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
