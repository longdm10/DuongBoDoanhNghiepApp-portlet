 ...
 * @generated
 */
public class QLVTCapPhepPhuHieuLocalServiceClp
	implements QLVTCapPhepPhuHieuLocalService {
	public QLVTCapPhepPhuHieuLocalServiceClp(
	...
	public vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu addQLVTCapPhepPhuHieu(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(qlvtCapPhepPhuHieu)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu> getQLVTCapPhepPhuHieus(
		...
		return (java.util.List<vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu>)ClpSerializer.translateOutput(returnObj);
	}
