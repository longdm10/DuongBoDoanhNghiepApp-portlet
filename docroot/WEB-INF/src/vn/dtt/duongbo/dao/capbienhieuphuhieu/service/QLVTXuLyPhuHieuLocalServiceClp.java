 ...
 * @generated
 */
public class QLVTXuLyPhuHieuLocalServiceClp
	implements QLVTXuLyPhuHieuLocalService {
	public QLVTXuLyPhuHieuLocalServiceClp(
	...
	public vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTXuLyPhuHieu addQLVTXuLyPhuHieu(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(qlvtXuLyPhuHieu) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTXuLyPhuHieu)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTXuLyPhuHieu> getQLVTXuLyPhuHieus(
		...
		return (java.util.List<vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTXuLyPhuHieu>)ClpSerializer.translateOutput(returnObj);
	}
