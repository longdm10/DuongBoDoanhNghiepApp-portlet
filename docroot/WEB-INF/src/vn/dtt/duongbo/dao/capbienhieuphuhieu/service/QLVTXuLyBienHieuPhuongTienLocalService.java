...
/**
 * Provides the local service interface for QLVTXuLyBienHieuPhuongTien. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhta
 * @see QLVTXuLyBienHieuPhuongTienLocalServiceUtil
...
public interface QLVTXuLyBienHieuPhuongTienLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QLVTXuLyBienHieuPhuongTienLocalServiceUtil} to access the q l v t xu ly bien hieu phuong tien local service. Add custom service methods to {@link vn.dtt.duongbo.dao.capbienhieuphuhieu.service.impl.QLVTXuLyBienHieuPhuongTienLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
