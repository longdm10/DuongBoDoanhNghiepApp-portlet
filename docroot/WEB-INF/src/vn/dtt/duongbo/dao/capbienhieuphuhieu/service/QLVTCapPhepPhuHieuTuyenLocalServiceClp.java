 ...
 * @generated
 */
public class QLVTCapPhepPhuHieuTuyenLocalServiceClp
	implements QLVTCapPhepPhuHieuTuyenLocalService {
	public QLVTCapPhepPhuHieuTuyenLocalServiceClp(
	...
	public vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieuTuyen addQLVTCapPhepPhuHieuTuyen(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(qlvtCapPhepPhuHieuTuyen)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieuTuyen)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieuTuyen> getQLVTCapPhepPhuHieuTuyens(
		...
		return (java.util.List<vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieuTuyen>)ClpSerializer.translateOutput(returnObj);
	}
