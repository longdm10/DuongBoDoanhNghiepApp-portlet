...
/**
 * Provides the local service interface for QLVTXuLyPhuHieuPhuongTien. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhta
 * @see QLVTXuLyPhuHieuPhuongTienLocalServiceUtil
...
public interface QLVTXuLyPhuHieuPhuongTienLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QLVTXuLyPhuHieuPhuongTienLocalServiceUtil} to access the q l v t xu ly phu hieu phuong tien local service. Add custom service methods to {@link vn.dtt.duongbo.dao.capbienhieuphuhieu.service.impl.QLVTXuLyPhuHieuPhuongTienLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
