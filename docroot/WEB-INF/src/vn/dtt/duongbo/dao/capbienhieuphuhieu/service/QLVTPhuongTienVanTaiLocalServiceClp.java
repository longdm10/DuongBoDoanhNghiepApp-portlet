 ...
 * @generated
 */
public class QLVTPhuongTienVanTaiLocalServiceClp
	implements QLVTPhuongTienVanTaiLocalService {
	public QLVTPhuongTienVanTaiLocalServiceClp(
	...
	public vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTPhuongTienVanTai addQLVTPhuongTienVanTai(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(qlvtPhuongTienVanTai)
					});
		}
		catch (Throwable t) {
		...
		return (vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTPhuongTienVanTai)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTPhuongTienVanTai> getQLVTPhuongTienVanTais(
		...
		return (java.util.List<vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTPhuongTienVanTai>)ClpSerializer.translateOutput(returnObj);
	}
