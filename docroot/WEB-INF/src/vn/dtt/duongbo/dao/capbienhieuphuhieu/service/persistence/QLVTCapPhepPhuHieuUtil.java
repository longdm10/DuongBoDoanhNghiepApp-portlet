...
/**
 * The persistence utility for the q l v t cap phep phu hieu service. This utility wraps {@link QLVTCapPhepPhuHieuPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class QLVTCapPhepPhuHieuUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(QLVTCapPhepPhuHieu qlvtCapPhepPhuHieu) {
		getPersistence().clearCache(qlvtCapPhepPhuHieu);
	}
	 ...
	 */
	public static List<QLVTCapPhepPhuHieu> findWithDynamicQuery(
	 ...
	 */
	public static QLVTCapPhepPhuHieu update(
		QLVTCapPhepPhuHieu qlvtCapPhepPhuHieu) throws SystemException {
		return getPersistence().update(qlvtCapPhepPhuHieu);
	}
	 ...
	 */
	public static QLVTCapPhepPhuHieu update(
		QLVTCapPhepPhuHieu qlvtCapPhepPhuHieu, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(qlvtCapPhepPhuHieu, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qlvtCapPhepPhuHieu);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(qlvtCapPhepPhuHieus);
	}
	...
	*/
	public static vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu create(
		int id) {
	...
	*/
	public static vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu remove(
		int id)
	...
	public static vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu updateImpl(
		vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu qlvtCapPhepPhuHieu)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(qlvtCapPhepPhuHieu);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu findByPrimaryKey(
		int id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.duongbo.dao.capbienhieuphuhieu.NoSuchQLVTCapPhepPhuHieuException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.duongbo.dao.capbienhieuphuhieu.model.QLVTCapPhepPhuHieu> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static QLVTCapPhepPhuHieuPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (QLVTCapPhepPhuHieuPersistence)PortletBeanLocatorUtil.locate(vn.dtt.duongbo.dao.capbienhieuphuhieu.service.ClpSerializer.getServletContextName(),
					QLVTCapPhepPhuHieuPersistence.class.getName());

			ReferenceRegistry.registerReference(QLVTCapPhepPhuHieuUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(QLVTCapPhepPhuHieuPersistence persistence) {
	}

	private static QLVTCapPhepPhuHieuPersistence _persistence;
}