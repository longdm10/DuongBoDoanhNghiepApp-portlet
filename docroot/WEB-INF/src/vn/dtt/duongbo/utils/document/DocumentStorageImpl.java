...
public class DocumentStorageImpl implements IDocumentStorage {
	...
	public ResultUpload upload(Long userId, byte[] b, String _fileName) {
		...
		Long folderId = DuongBoConfigurationManager.getLongProp(CMON_DOCUMENT_FOLDER_ID, 12503);
//		folderId =11605L; //local-VinhNguyen
	...
	private ResultUpload addFile(long userId,ServiceContext serviceContext,Long repositoryId
		...
		log.info("=======addFile======fileName=====" + fileName + "===bbbbb==" + b);
		...
		log.info("begin addFile with user: " + userId);
