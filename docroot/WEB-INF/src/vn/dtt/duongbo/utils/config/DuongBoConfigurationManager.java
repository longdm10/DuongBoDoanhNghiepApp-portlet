...
package vn.dtt.duongbo.utils.config;
 ...
 * @date: 3 Jul 2009
 */
public class DuongBoConfigurationManager {
	
	public static final String fileNameAll = File.separator + "duongbo.properties";
	private static final DuongBoConfigurationManager instance = new DuongBoConfigurationManager();
	...
	private DuongBoConfigurationManager() {
	}
	
	public static DuongBoConfigurationManager getInstance() {
		return instance;
	}
	...
	private Properties loadProperties(String module1) {
		...
		try {
			InputStream pin = DuongBoConfigurationManager.class.getResourceAsStream(module1);
			props.load(pin);
			return props;
