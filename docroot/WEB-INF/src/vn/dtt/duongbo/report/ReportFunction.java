...
public class ReportFunction {
	...
	private static final String NGAY_UPPERCASE = DuongBoConfigurationManager.getStrProp("vn.dk.label.report.ngay.uppercas", "sdfsdf");
	private static final String GIO = DuongBoConfigurationManager.getStrProp("vn.dk.label.report.gio","00");
	private static final String NGAY = DuongBoConfigurationManager.getStrProp("vn.dk.label.report.ngay","12");
	private static final String THANG = DuongBoConfigurationManager.getStrProp("vn.dk.label.report.thang","12");
	private static final String NAM = DuongBoConfigurationManager.getStrProp("vn.dk.label.report.nam","2015");
	...
	public static String parseDateVN2() {
		Date date = new Date();
		try {
			Calendar calendar = Calendar.getInstance();
			calendar.setTime(date);
	...
	public static String parseDateEL() {
		Date date = new Date();
		try {
			Calendar calendar = Calendar.getInstance();
			calendar.setTime(date);
			...
			//return NGAY + "  " + sDay + "  " + THANG + "  " + sMonth + "  " + NAM + "  " + year;
			return DuongBoConfigurationManager.getStrProp("report.day", "") + "  " + sDay + "  " + DuongBoConfigurationManager.getStrProp("report.month", "") + "  " + sMonth + "  " + DuongBoConfigurationManager.getStrProp("report.year", "") + "  " + year;
		} catch (Exception e) {
			e.printStackTrace();
		}
		return "";
	...
	//ngay thang
	public static String parseDateVN1(Date date) {
		if (Validator.isNotNull(date)) {
			try {
				Calendar calendar = Calendar.getInstance();
				calendar.setTime(date);
				...
				int year = calendar.get(Calendar.YEAR);
				return  "  " + sDay + " " + THANG + " " + sMonth + " " + NAM + " " + year;
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
